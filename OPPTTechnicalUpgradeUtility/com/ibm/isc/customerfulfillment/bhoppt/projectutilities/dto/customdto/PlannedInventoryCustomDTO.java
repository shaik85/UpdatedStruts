...
public class PlannedInventoryCustomDTO extends OPPTCustomDTO 
{
	private ProposalCustomDTO proposalDTO = null;
	private TreeMap selectedQuotes = null;
	 ...
	 * @return TreeMap
	 */
	public TreeMap getSelectedQuotes() {
	 ...
	 * @param map 
	 */
	public void setSelectedQuotes(TreeMap map) {
		selectedQuotes = map;
	}
	...
	public void addSelectedQuote(QuoteCustomDTO quote){
		if(null != quote){
			if(null == selectedQuotes){
				selectedQuotes = new TreeMap();
			}
			selectedQuotes.put(quote.getId(), quote);
		}
	}
}
