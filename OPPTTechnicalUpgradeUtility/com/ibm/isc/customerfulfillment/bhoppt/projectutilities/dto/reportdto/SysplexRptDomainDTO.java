...
public class SysplexRptDomainDTO extends OPPTDomainDTO {
	 ...
	 * @param string 
	 */
	public void setDMSerialNo(String string) {
		dmSerialNo = string;
	}
	 ...
	 * @param date 
	 */
	public void setRptPrintedOn(Date date) {
		rptPrintedOn = date;
	}
