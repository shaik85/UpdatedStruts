...
public class InventoryListRptDomainDTO extends OPPTDomainDTO
{
   ...
   /**
    * constructor
    *    @roseuid 3FB4745A037F
    */
   public InventoryListRptDomainDTO() 
   {
...
public void setSSCustomerDomainDTOList(List list) {
    ...
    public void reset(){
		...
		if(null != customerDomainDTOList){
			for(int i=0; i<customerDomainDTOList.size(); i++){
				InventoryListRptCustomerDomainDTO dto = (InventoryListRptCustomerDomainDTO)customerDomainDTOList.get(i);
				dto.reset();
			}
		...
		if(null != sSCustomerDomainDTOList){
			for(int i=0; i<sSCustomerDomainDTOList.size(); i++){
				InventoryListRptCustomerDomainDTO dto = (InventoryListRptCustomerDomainDTO)sSCustomerDomainDTOList.get(i);
				dto.reset();
			}
