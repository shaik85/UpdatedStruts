...
public class CopyBumpSWOCustomDTO extends OPPTCustomDTO {
	...
	private Date originalPlanEndDate = null;
	 ...
	 * @param date 
	 */
	public void setBumpPlanEndDate(Date date) {
		bumpPlanEndDate = date;
	}
	 ...
	 * @param date 
	 */
	public void setBumpPlanStartDate(Date date) {
		bumpPlanStartDate = date;
	}
	 ...
	 * @return Date
	 */
	public Date getOriginalPlanEndDate() {
	 ...
	 * @param date 
	 */
	public void setOriginalPlanEndDate(Date date) {
		originalPlanEndDate = date;
	}
}
