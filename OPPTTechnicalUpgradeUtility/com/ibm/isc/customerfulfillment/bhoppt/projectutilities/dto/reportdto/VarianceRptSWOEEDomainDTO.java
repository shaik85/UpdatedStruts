...
public class VarianceRptSWOEEDomainDTO extends OPPTDomainDTO {
	private String soldToPartyID = null ;
	private String swoID = null ;
	private String dmID;
	private String swoEEID = null ;
	 ...
	 * @param string 
	 */
	public void setSwoEEID(String string) {
		swoEEID = string;
	}
	 ...
	 */
	public void addPriceDomainDTOList(List swoDomainDTOList) {
		if (null != swoDomainDTOList) {
			if (null == priceDomainDTOList) {
				priceDomainDTOList = new ArrayList();
			}
			priceDomainDTOList.addAll(swoDomainDTOList);
		}
	}
...
/*	protected void finalize() throws Throwable {
		...
		description = null;
		if(null != priceDomainDTOList){
			priceDomainDTOList.clear();
			priceDomainDTOList = null;
		}
	}*/
}