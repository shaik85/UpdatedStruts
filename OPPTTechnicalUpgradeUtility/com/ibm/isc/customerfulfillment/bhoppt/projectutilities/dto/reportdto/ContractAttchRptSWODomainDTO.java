...
public class ContractAttchRptSWODomainDTO extends OPPTDomainDTO {
	...
	/**
	It mapps to item_category in BH.systemswo table
	 */
	...
	private List sSSWOEEDomainDTOList = null ;

	/**
	 * constructor
	 * 	@roseuid 3FB475F50005
	 */
	public ContractAttchRptSWODomainDTO() {
     ...
     * </PRE><br>
     *
     * @param ssSWOEEDomainDTOList 
     */
	public void addSSSWOEEDomainDTOList(List ssSWOEEDomainDTOList) {
		if (null != ssSWOEEDomainDTOList) {
			if (null == sSSWOEEDomainDTOList) {
				sSSWOEEDomainDTOList = new ArrayList();
			}
			sSSWOEEDomainDTOList.addAll(ssSWOEEDomainDTOList);
		}
	}
	/**
	 * get the data
     ...
     * @param price 
     */
	public void setAlternatePrice(double price) {
     ...
     * @param price 
     */
	public void setESWPrice(double price) {
		eSWPrice = price;
	}
...
/*	protected void finalize() throws Throwable {
    ...
    /**
     * return the sSSWOEEDomainDTOList 
     *
     * @return Returns the sSSWOEEDomainDTOList.
     */
    public List getSSSWOEEDomainDTOList() {
        return sSSWOEEDomainDTOList;
    }
    /**
     * sets the sSSWOEEDomainDTOList
     *
     * @param lDomainDTOList The sSSWOEEDomainDTOList to set.
     */
    public void setSSSWOEEDomainDTOList(List lDomainDTOList) {
        sSSWOEEDomainDTOList = lDomainDTOList;
    }
}