...
public class VarianceRptSWODomainDTO extends OPPTDomainDTO {
	 ...
	 */
	public void addSWOEEDomainDTOList(List swoDomainDTOList) {
		if (null != swoDomainDTOList) {
			if (null == sWOEEDomainDTOList) {
				sWOEEDomainDTOList = new ArrayList();
			}
			sWOEEDomainDTOList.add(swoDomainDTOList);
		}
	}
