...
public class ContractAttchRptDMDDomainTO extends OPPTDomainDTO {
	 ...
	 * @param string 
	 */
	public void setDescMcDesc(String string) {
		descMcDesc = string;
	}
	 ...
	 * @param string 
	 */
	public void setUselLevel(String string) {
		uselLevel = string;
	}
