...
public class _ProposalDataManagerHome_Stub extends Stub implements ProposalDataManagerHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ibm.isc.customerfulfillment.bhoppt.service.orgmgr.ProposalDataManagerHome:0000000000000000", 
    ...
    public ProposalDataManager create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (ProposalDataManager) in.read_Object(ProposalDataManager.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.ibm.isc.customerfulfillment.bhoppt.service.orgmgr.ProposalDataManagerHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    ProposalDataManager result = ((com.ibm.isc.customerfulfillment.bhoppt.service.orgmgr.ProposalDataManagerHome)so.servant).create();
                    return (ProposalDataManager)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
