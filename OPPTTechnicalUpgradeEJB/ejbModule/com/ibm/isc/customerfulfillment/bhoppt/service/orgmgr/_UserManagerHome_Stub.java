...
public class _UserManagerHome_Stub extends Stub implements UserManagerHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ibm.isc.customerfulfillment.bhoppt.service.orgmgr.UserManagerHome:0000000000000000", 
            ...
            if (!Util.isLocal(this)) {
                ...
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (UserManager) in.read_Object(UserManager.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.ibm.isc.customerfulfillment.bhoppt.service.orgmgr.UserManagerHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    UserManager result = ((com.ibm.isc.customerfulfillment.bhoppt.service.orgmgr.UserManagerHome)so.servant).create();
                    return (UserManager)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
