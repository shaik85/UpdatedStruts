...
public class _ReportManagerHome_Stub extends Stub implements ReportManagerHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ibm.isc.customerfulfillment.bhoppt.service.reportmgr.ReportManagerHome:0000000000000000", 
    ...
    public ReportManager create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (ReportManager) in.read_Object(ReportManager.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.ibm.isc.customerfulfillment.bhoppt.service.reportmgr.ReportManagerHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    ReportManager result = ((com.ibm.isc.customerfulfillment.bhoppt.service.reportmgr.ReportManagerHome)so.servant).create();
                    return (ReportManager)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
