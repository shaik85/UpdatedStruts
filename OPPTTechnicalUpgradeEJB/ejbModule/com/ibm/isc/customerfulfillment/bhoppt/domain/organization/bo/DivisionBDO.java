 ...
 * @version 5.1A 
 */
public class DivisionBDO {
	
	private String iDivisionCode;
	private String iDivisionDesc;
	 ...
	 * @param string 
	 */
	public void setDivisionDesc(String string) {
		iDivisionDesc = string;
	}
