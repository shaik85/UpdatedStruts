...
public class BLBIndicatorBDO {
	...
	/**
	 * @param blbIndicatorDesc The blbIndicatorDesc to set.
	 */
	public void setBlbIndicatorDesc(String blbIndicatorDesc) {
		this.blbIndicatorDesc = blbIndicatorDesc;
	}
	/**
	...
	/**
	 * @param blbIndicatorType The blbIndicatorType to set.
	 */
	public void setBlbIndicatorType(String blbIndicatorType) {
		this.blbIndicatorType = blbIndicatorType;
	}
}
