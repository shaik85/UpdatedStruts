...
/** 
 * This Domain dto carries currency information across the service layer
 * 
...
public class CurrencyDomainDTO extends OPPTDomainDTO {
	...
	public CurrencyDomainDTO(CurrencyBDO currency){
		currencyCode=currency.getCurrencyCode();
		currencyName=currency.getCurrencyName();
		decimalAllowed=currency.getDecimalAllowed();
	}
	/** 
	 ...
	 * @param i 
	 */
	public void setDecimalAllowed(int i) {
		decimalAllowed = i;
	}
