 ...
 */
public abstract class HistorySWOBean implements javax.ejb.EntityBean {
	 ...
	 * ejbCreate
	 */
	public com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.HistorySWOKey ejbCreate(
		int swoId,
		int dmId,
		int customerId,
