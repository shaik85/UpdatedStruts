...
/**
 * PaymentTermBeanFunctionSet_d86e7748
 */
public class PaymentTermBeanFunctionSet_d86e7748 extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	private java.util.HashMap functionHash;
	private static String CreateQuery_0 = "INSERT INTO BH.PAYMENTTERM (PAYMENT_TERM, PAYMENT_TERM_DESC) VALUES (?, ?)";
	/**
	 * Create
	 */
	...
	private static String RemoveQuery_0 = "DELETE FROM BH.PAYMENTTERM  WHERE PAYMENT_TERM = ?";
	/**
	 * Remove
	 */
	...
	private static String StoreQuery_0 = "UPDATE BH.PAYMENTTERM  SET PAYMENT_TERM_DESC = ? WHERE PAYMENT_TERM = ?";
	/**
	 * Store
	 */
	...
	private static String StoreOCCQuery_0 = "UPDATE BH.PAYMENTTERM  SET PAYMENT_TERM_DESC = ? WHERE PAYMENT_TERM = ?";
	/**
	 * StoreUsingOCC
	 */
	...
	private static String FindByPrimaryKeyQuery_0 = " SELECT T1.PAYMENT_TERM, T1.PAYMENT_TERM_DESC FROM BH.PAYMENTTERM  T1 WHERE T1.PAYMENT_TERM = ?";
	/**
	 * FindByPrimaryKey
	 */
	...
	private static String FindByPrimaryKeyForUpdateQuery_0 = " SELECT T1.PAYMENT_TERM, T1.PAYMENT_TERM_DESC FROM BH.PAYMENTTERM  T1 WHERE T1.PAYMENT_TERM = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRRQuery_0 = " SELECT T1.PAYMENT_TERM, T1.PAYMENT_TERM_DESC FROM BH.PAYMENTTERM  T1 WHERE T1.PAYMENT_TERM = ? FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRSQuery_0 = " SELECT T1.PAYMENT_TERM, T1.PAYMENT_TERM_DESC FROM BH.PAYMENTTERM  T1 WHERE T1.PAYMENT_TERM = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String findAllPaymentTermQuery_0 = " select  q1.\"PAYMENT_TERM\",  q1.\"PAYMENT_TERM_DESC\" from BH.PAYMENTTERM q1";
	/**
	 * FindAllPaymentTerm
	 */
	public javax.resource.cci.Record FindAllPaymentTerm(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from PaymentTerm o */
			pstmt = prepareStatement(connection, findAllPaymentTermQuery_0);

			result = executeQuery(connection, pstmt, findAllPaymentTermQuery_0);
	...
	private static String findAllPaymentTermForUpdateQuery_0 = " select  q1.\"PAYMENT_TERM\",  q1.\"PAYMENT_TERM_DESC\" from BH.PAYMENTTERM q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllPaymentTerm444Update
	 */
	public javax.resource.cci.Record FindAllPaymentTerm444Update(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from PaymentTerm o */
			pstmt = prepareStatement(connection, findAllPaymentTermForUpdateQuery_0);

			result = executeQuery(connection, pstmt, findAllPaymentTermForUpdateQuery_0);
	...
	private static String findAllPaymentTermForUpdateWithRRQuery_0 = " select  q1.\"PAYMENT_TERM\",  q1.\"PAYMENT_TERM_DESC\" from BH.PAYMENTTERM q1 FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllPaymentTermForUpdateWithRR
	 */
	public javax.resource.cci.Record FindAllPaymentTermForUpdateWithRR(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from PaymentTerm o */
			pstmt = prepareStatement(connection, findAllPaymentTermForUpdateWithRRQuery_0);

			result = executeQuery(connection, pstmt, findAllPaymentTermForUpdateWithRRQuery_0);
	...
	private static String findAllPaymentTermForUpdateWithRSQuery_0 = " select  q1.\"PAYMENT_TERM\",  q1.\"PAYMENT_TERM_DESC\" from BH.PAYMENTTERM q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllPaymentTermForUpdateWithRS
	 */
	public javax.resource.cci.Record FindAllPaymentTermForUpdateWithRS(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from PaymentTerm o */
			pstmt = prepareStatement(connection, findAllPaymentTermForUpdateWithRSQuery_0);

			result = executeQuery(connection, pstmt, findAllPaymentTermForUpdateWithRSQuery_0);
	 ...
	 * PaymentTermBeanFunctionSet_d86e7748
	 */
	public PaymentTermBeanFunctionSet_d86e7748() {
		...
		functionHash.put("FindAllPaymentTerm",new Integer(8));
		functionHash.put("FindAllPaymentTerm444Update",new Integer(9));
		functionHash.put("FindAllPaymentTermForUpdateWithRR",new Integer(10));
		functionHash.put("FindAllPaymentTermForUpdateWithRS",new Integer(11));
	...
	public Record execute(WSInteractionSpec interactionSpec, IndexedRecord inputRecord, Object connection) throws javax.resource.ResourceException {
		...
		case 7:
			...
			break;
		case 8:
			outputRecord=FindAllPaymentTerm(inputRecord,connection,interactionSpec);
			break;
		case 9:
			outputRecord=FindAllPaymentTerm444Update(inputRecord,connection,interactionSpec);
			break;
		case 10:
			outputRecord=FindAllPaymentTermForUpdateWithRR(inputRecord,connection,interactionSpec);
			break;
		case 11:
			outputRecord=FindAllPaymentTermForUpdateWithRS(inputRecord,connection,interactionSpec);
			break;
		case 12:
	...
	private static String ReadReadQuery_0 = " SELECT 1 FROM BH.PAYMENTTERM  T1 WHERE T1.PAYMENT_TERM = ?";
	/**
	 * ReadReadChecking
	 */
	...
	private static String ReadReadForUpdateQuery_0 = " SELECT 1 FROM BH.PAYMENTTERM  T1 WHERE T1.PAYMENT_TERM = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private void initializeUpdateTemplates() throws javax.resource.ResourceException {
		updateTemplateList = PaymentTermBeanPartialUpdateQueryHelper.getUpdateTemplates();
	}
