...
/**
 * ActionDescriptionBeanFunctionSet_aec2e580
 */
public class ActionDescriptionBeanFunctionSet_aec2e580 extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	private java.util.HashMap functionHash;
	private static String CreateQuery_0 = "INSERT INTO BH.ACTIONDESCRIPTION (OPERATIONPERFORMED, DESCRIPTION) VALUES (?, ?)";
	/**
	 * Create
	 */
	...
	private static String RemoveQuery_0 = "DELETE FROM BH.ACTIONDESCRIPTION  WHERE OPERATIONPERFORMED = ?";
	/**
	 * Remove
	 */
	...
	private static String StoreQuery_0 = "UPDATE BH.ACTIONDESCRIPTION  SET DESCRIPTION = ? WHERE OPERATIONPERFORMED = ?";
	/**
	 * Store
	 */
	...
	private static String StoreOCCQuery_0 = "UPDATE BH.ACTIONDESCRIPTION  SET DESCRIPTION = ? WHERE OPERATIONPERFORMED = ?";
	/**
	 * StoreUsingOCC
	 */
	...
	private static String findAllActionsQuery_0 = " select  q1.\"DESCRIPTION\",  q1.\"OPERATIONPERFORMED\" from BH.ACTIONDESCRIPTION q1";
	/**
	 * FindAllActions
	 */
	public javax.resource.cci.Record FindAllActions(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from ActionDescription o */
			pstmt = prepareStatement(connection, findAllActionsQuery_0);

			result = executeQuery(connection, pstmt, findAllActionsQuery_0);
	...
	private static String findAllActionsForUpdateQuery_0 = " select  q1.\"DESCRIPTION\",  q1.\"OPERATIONPERFORMED\" from BH.ACTIONDESCRIPTION q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllActions444Update
	 */
	public javax.resource.cci.Record FindAllActions444Update(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from ActionDescription o */
			pstmt = prepareStatement(connection, findAllActionsForUpdateQuery_0);

			result = executeQuery(connection, pstmt, findAllActionsForUpdateQuery_0);
	...
	private static String findAllActionsForUpdateWithRRQuery_0 = " select  q1.\"DESCRIPTION\",  q1.\"OPERATIONPERFORMED\" from BH.ACTIONDESCRIPTION q1 FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllActionsForUpdateWithRR
	 */
	public javax.resource.cci.Record FindAllActionsForUpdateWithRR(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from ActionDescription o */
			pstmt = prepareStatement(connection, findAllActionsForUpdateWithRRQuery_0);

			result = executeQuery(connection, pstmt, findAllActionsForUpdateWithRRQuery_0);
	...
	private static String findAllActionsForUpdateWithRSQuery_0 = " select  q1.\"DESCRIPTION\",  q1.\"OPERATIONPERFORMED\" from BH.ACTIONDESCRIPTION q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllActionsForUpdateWithRS
	 */
	public javax.resource.cci.Record FindAllActionsForUpdateWithRS(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from ActionDescription o */
			pstmt = prepareStatement(connection, findAllActionsForUpdateWithRSQuery_0);

			result = executeQuery(connection, pstmt, findAllActionsForUpdateWithRSQuery_0);
	...
	private static String FindByPrimaryKeyQuery_0 = " SELECT T1.DESCRIPTION, T1.OPERATIONPERFORMED FROM BH.ACTIONDESCRIPTION  T1 WHERE T1.OPERATIONPERFORMED = ?";
	/**
	 * FindByPrimaryKey
	 */
	...
	private static String FindByPrimaryKeyForUpdateQuery_0 = " SELECT T1.DESCRIPTION, T1.OPERATIONPERFORMED FROM BH.ACTIONDESCRIPTION  T1 WHERE T1.OPERATIONPERFORMED = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRRQuery_0 = " SELECT T1.DESCRIPTION, T1.OPERATIONPERFORMED FROM BH.ACTIONDESCRIPTION  T1 WHERE T1.OPERATIONPERFORMED = ? FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRSQuery_0 = " SELECT T1.DESCRIPTION, T1.OPERATIONPERFORMED FROM BH.ACTIONDESCRIPTION  T1 WHERE T1.OPERATIONPERFORMED = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 ...
	 * ActionDescriptionBeanFunctionSet_aec2e580
	 */
	public ActionDescriptionBeanFunctionSet_aec2e580() {
		...
		functionHash.put("FindAllActions",new Integer(4));
		functionHash.put("FindAllActions444Update",new Integer(5));
		functionHash.put("FindAllActionsForUpdateWithRR",new Integer(6));
		functionHash.put("FindAllActionsForUpdateWithRS",new Integer(7));
	...
	public Record execute(WSInteractionSpec interactionSpec, IndexedRecord inputRecord, Object connection) throws javax.resource.ResourceException {
		...
		case 3:
			...
			break;
		case 4:
			outputRecord=FindAllActions(inputRecord,connection,interactionSpec);
			break;
		case 5:
			outputRecord=FindAllActions444Update(inputRecord,connection,interactionSpec);
			break;
		case 6:
			outputRecord=FindAllActionsForUpdateWithRR(inputRecord,connection,interactionSpec);
			break;
		case 7:
			outputRecord=FindAllActionsForUpdateWithRS(inputRecord,connection,interactionSpec);
			break;
		case 8:
	...
	private static String ReadReadQuery_0 = " SELECT 1 FROM BH.ACTIONDESCRIPTION  T1 WHERE T1.OPERATIONPERFORMED = ?";
	/**
	 * ReadReadChecking
	 */
	...
	private static String ReadReadForUpdateQuery_0 = " SELECT 1 FROM BH.ACTIONDESCRIPTION  T1 WHERE T1.OPERATIONPERFORMED = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private void initializeUpdateTemplates() throws javax.resource.ResourceException {
		updateTemplateList = ActionDescriptionBeanPartialUpdateQueryHelper.getUpdateTemplates();
	}
