...
/**
 * MCTypeBeanAdaptorBinding_b8a50e19
 */
public class MCTypeBeanAdaptorBinding_b8a50e19 implements com.ibm.ws.ejbpersistence.beanextensions.EJBAdapterBinding {
	/**
	 * getExtractor
	 */
	public com.ibm.ws.ejbpersistence.dataaccess.EJBExtractor getExtractor() {
		// extractor for com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.MCTypeBeanExtractor_b8a50e19
		com.ibm.ws.ejbpersistence.dataaccess.AbstractEJBExtractor extractor =  new com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.MCTypeBeanExtractor_b8a50e19();
	...
	public com.ibm.ws.ejbpersistence.beanextensions.EJBInjector getInjector() {
		return new com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.MCTypeBeanInjectorImpl_b8a50e19();
	}
	/**
	 * getAdapter
	 */
	...
	public Object[] getMetadata() {
		...
		//-------------------------------------Alias-------------------------------------
		cat[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogRDBAlias("MCType", "MCType1_Alias", "DB2NT", "BH.MCTYPE", "MCType_MCType1_Table", 9, 5, 1);


		//-----------------------------------Table Type-----------------------------------
		fields = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef[2];

		fields[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("MC_TYPE", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 2, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, true, 0, -1, 0, false);
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("MC_DESC", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 40, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		primarykey = new String[1];
		primarykey[0] = "MC_TYPE";
		cat[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogType("MCType", "MCType1_Table", null, fields, primarykey);


		//-----------------------------------Bean Type-----------------------------------
		fields = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef[2];

		fields[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("mcType", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("mcDesc", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		primarykey = new String[1];
		primarykey[0] = "mcType";
		cat[2] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogType("MCType", "MCType_BO", "com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.MCTypeBean", fields, primarykey);
		...
		subhomes = null;
		cat[3] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogView("MCType", "MCType_MCType_BO", "MCType_MCType1_Alias", composedObjs, composedObjImpls, 
		"select t1.MC_TYPE,t1.MC_DESC from _this t1", 
		null, subhomes, 
		0, null);
	...
	public java.util.Collection createDataAccessSpecs() throws javax.resource.ResourceException {
		...
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.MCTypeBeanFunctionSet_b8a50e19");
		...
		daSpec.setQueryScope(new String[]{"MCType"});
		result.add(daSpec);
		...
		iSpec=new com.ibm.ws.rsadapter.cci.WSInteractionSpecImpl();
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.MCTypeBeanFunctionSet_b8a50e19");
		iSpec.setFunctionName("FindAllMCType");
		daSpec.setInteractionSpec(iSpec);
		daSpec.setSpecName("FindAllMCType");
		daSpec.setInputRecordName("FindAllMCType");
		daSpec.setOptimistic(false);
		...
		iSpec=new com.ibm.ws.rsadapter.cci.WSInteractionSpecImpl();
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.MCTypeBeanFunctionSet_b8a50e19");
		iSpec.setFunctionName("FindAllMCType444Update");
		daSpec.setInteractionSpec(iSpec);
		daSpec.setSpecName("FindAllMCType");
		daSpec.setInputRecordName("FindAllMCType");
		daSpec.setOptimistic(false);
		...
		iSpec=new com.ibm.ws.rsadapter.cci.WSInteractionSpecImpl();
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.MCTypeBeanFunctionSet_b8a50e19");
		iSpec.setFunctionName("FindAllMCTypeForUpdateWithRR");
		daSpec.setInteractionSpec(iSpec);
		daSpec.setSpecName("FindAllMCType");
		daSpec.setInputRecordName("FindAllMCType");
		daSpec.setOptimistic(false);
		...
		iSpec=new com.ibm.ws.rsadapter.cci.WSInteractionSpecImpl();
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.MCTypeBeanFunctionSet_b8a50e19");
		iSpec.setFunctionName("FindAllMCTypeForUpdateWithRS");
		daSpec.setInteractionSpec(iSpec);
		daSpec.setSpecName("FindAllMCType");
		daSpec.setInputRecordName("FindAllMCType");
		daSpec.setOptimistic(false);
	 ...
	 * MCTypeBeanAdaptorBinding_b8a50e19
	 */
	public MCTypeBeanAdaptorBinding_b8a50e19() {
