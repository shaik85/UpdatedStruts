...
public abstract class CustomerBean implements javax.ejb.EntityBean {
	 ...
	 * @param planStartDate
	 */
	public com.ibm.isc.customerfulfillment.bhoppt.persistence.customer.CustomerKey ejbCreate(
		int proposalId,
		int customerId,
		...
		setSapCustomerNo(sapCustomerNo);
		/* start change CR6153 */
	 ...
	 */
	/* start change CR6153 */
	public void ejbPostCreate(int proposalId, int customerId,String sapCustomerNo,Date planStartDate, Date planEndDate)
		throws javax.ejb.CreateException {
	}
	/* end change CR6153 */
	/**
	 ...
	 */
	public abstract void setCountryCode(java.lang.String newCountryCode);
}
