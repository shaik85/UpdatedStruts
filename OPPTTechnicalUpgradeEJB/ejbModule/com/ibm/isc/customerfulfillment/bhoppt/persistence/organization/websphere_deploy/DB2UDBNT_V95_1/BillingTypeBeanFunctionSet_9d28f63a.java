...
/**
 * BillingTypeBeanFunctionSet_9d28f63a
 */
public class BillingTypeBeanFunctionSet_9d28f63a extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	private java.util.HashMap functionHash;
	private static String CreateQuery_0 = "INSERT INTO BH.BILLINGTYPE (BILLING_TYPE, BILLING_DESC) VALUES (?, ?)";
	/**
	 * Create
	 */
	...
	private static String RemoveQuery_0 = "DELETE FROM BH.BILLINGTYPE  WHERE BILLING_TYPE = ?";
	/**
	 * Remove
	 */
	...
	private static String StoreQuery_0 = "UPDATE BH.BILLINGTYPE  SET BILLING_DESC = ? WHERE BILLING_TYPE = ?";
	/**
	 * Store
	 */
	...
	private static String StoreOCCQuery_0 = "UPDATE BH.BILLINGTYPE  SET BILLING_DESC = ? WHERE BILLING_TYPE = ?";
	/**
	 * StoreUsingOCC
	 */
	...
	private static String FindByPrimaryKeyQuery_0 = " SELECT T1.BILLING_TYPE, T1.BILLING_DESC FROM BH.BILLINGTYPE  T1 WHERE T1.BILLING_TYPE = ?";
	/**
	 * FindByPrimaryKey
	 */
	...
	private static String FindByPrimaryKeyForUpdateQuery_0 = " SELECT T1.BILLING_TYPE, T1.BILLING_DESC FROM BH.BILLINGTYPE  T1 WHERE T1.BILLING_TYPE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRRQuery_0 = " SELECT T1.BILLING_TYPE, T1.BILLING_DESC FROM BH.BILLINGTYPE  T1 WHERE T1.BILLING_TYPE = ? FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRSQuery_0 = " SELECT T1.BILLING_TYPE, T1.BILLING_DESC FROM BH.BILLINGTYPE  T1 WHERE T1.BILLING_TYPE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String findAllBillingTypeQuery_0 = " select  q1.\"BILLING_TYPE\",  q1.\"BILLING_DESC\" from BH.BILLINGTYPE q1";
	/**
	 * FindAllBillingType
	 */
	public javax.resource.cci.Record FindAllBillingType(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from BillingType o */
			pstmt = prepareStatement(connection, findAllBillingTypeQuery_0);

			result = executeQuery(connection, pstmt, findAllBillingTypeQuery_0);
	...
	private static String findAllBillingTypeForUpdateQuery_0 = " select  q1.\"BILLING_TYPE\",  q1.\"BILLING_DESC\" from BH.BILLINGTYPE q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllBillingType444Update
	 */
	public javax.resource.cci.Record FindAllBillingType444Update(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from BillingType o */
			pstmt = prepareStatement(connection, findAllBillingTypeForUpdateQuery_0);

			result = executeQuery(connection, pstmt, findAllBillingTypeForUpdateQuery_0);
	...
	private static String findAllBillingTypeForUpdateWithRRQuery_0 = " select  q1.\"BILLING_TYPE\",  q1.\"BILLING_DESC\" from BH.BILLINGTYPE q1 FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllBillingTypeForUpdateWithRR
	 */
	public javax.resource.cci.Record FindAllBillingTypeForUpdateWithRR(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from BillingType o */
			pstmt = prepareStatement(connection, findAllBillingTypeForUpdateWithRRQuery_0);

			result = executeQuery(connection, pstmt, findAllBillingTypeForUpdateWithRRQuery_0);
	...
	private static String findAllBillingTypeForUpdateWithRSQuery_0 = " select  q1.\"BILLING_TYPE\",  q1.\"BILLING_DESC\" from BH.BILLINGTYPE q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllBillingTypeForUpdateWithRS
	 */
	public javax.resource.cci.Record FindAllBillingTypeForUpdateWithRS(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from BillingType o */
			pstmt = prepareStatement(connection, findAllBillingTypeForUpdateWithRSQuery_0);

			result = executeQuery(connection, pstmt, findAllBillingTypeForUpdateWithRSQuery_0);
	 ...
	 * BillingTypeBeanFunctionSet_9d28f63a
	 */
	public BillingTypeBeanFunctionSet_9d28f63a() {
		...
		functionHash.put("FindAllBillingType",new Integer(8));
		functionHash.put("FindAllBillingType444Update",new Integer(9));
		functionHash.put("FindAllBillingTypeForUpdateWithRR",new Integer(10));
		functionHash.put("FindAllBillingTypeForUpdateWithRS",new Integer(11));
	...
	public Record execute(WSInteractionSpec interactionSpec, IndexedRecord inputRecord, Object connection) throws javax.resource.ResourceException {
		...
		case 7:
			...
			break;
		case 8:
			outputRecord=FindAllBillingType(inputRecord,connection,interactionSpec);
			break;
		case 9:
			outputRecord=FindAllBillingType444Update(inputRecord,connection,interactionSpec);
			break;
		case 10:
			outputRecord=FindAllBillingTypeForUpdateWithRR(inputRecord,connection,interactionSpec);
			break;
		case 11:
			outputRecord=FindAllBillingTypeForUpdateWithRS(inputRecord,connection,interactionSpec);
			break;
		case 12:
	...
	private static String ReadReadQuery_0 = " SELECT 1 FROM BH.BILLINGTYPE  T1 WHERE T1.BILLING_TYPE = ?";
	/**
	 * ReadReadChecking
	 */
	...
	private static String ReadReadForUpdateQuery_0 = " SELECT 1 FROM BH.BILLINGTYPE  T1 WHERE T1.BILLING_TYPE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private void initializeUpdateTemplates() throws javax.resource.ResourceException {
		updateTemplateList = BillingTypeBeanPartialUpdateQueryHelper.getUpdateTemplates();
	}
