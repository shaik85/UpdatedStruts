...
/**
 * BaseAgreementCoverageTypeBeanFunctionSet_cb26944c
 */
public class BaseAgreementCoverageTypeBeanFunctionSet_cb26944c extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	private java.util.HashMap functionHash;
	private static String CreateQuery_0 = "INSERT INTO BH.COVERAGETYPE (COVERAGE_TYPE, COVERAGE_TYPE_DESC) VALUES (?, ?)";
	/**
	 * Create
	 */
	...
	private static String RemoveQuery_0 = "DELETE FROM BH.COVERAGETYPE  WHERE COVERAGE_TYPE = ?";
	/**
	 * Remove
	 */
	...
	private static String StoreQuery_0 = "UPDATE BH.COVERAGETYPE  SET COVERAGE_TYPE_DESC = ? WHERE COVERAGE_TYPE = ?";
	/**
	 * Store
	 */
	...
	private static String StoreOCCQuery_0 = "UPDATE BH.COVERAGETYPE  SET COVERAGE_TYPE_DESC = ? WHERE COVERAGE_TYPE = ?";
	/**
	 * StoreUsingOCC
	 */
	...
	private static String FindByPrimaryKeyQuery_0 = " SELECT T1.COVERAGE_TYPE, T1.COVERAGE_TYPE_DESC FROM BH.COVERAGETYPE  T1 WHERE T1.COVERAGE_TYPE = ?";
	/**
	 * FindByPrimaryKey
	 */
	...
	private static String FindByPrimaryKeyForUpdateQuery_0 = " SELECT T1.COVERAGE_TYPE, T1.COVERAGE_TYPE_DESC FROM BH.COVERAGETYPE  T1 WHERE T1.COVERAGE_TYPE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRRQuery_0 = " SELECT T1.COVERAGE_TYPE, T1.COVERAGE_TYPE_DESC FROM BH.COVERAGETYPE  T1 WHERE T1.COVERAGE_TYPE = ? FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRSQuery_0 = " SELECT T1.COVERAGE_TYPE, T1.COVERAGE_TYPE_DESC FROM BH.COVERAGETYPE  T1 WHERE T1.COVERAGE_TYPE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 ...
	 * BaseAgreementCoverageTypeBeanFunctionSet_cb26944c
	 */
	public BaseAgreementCoverageTypeBeanFunctionSet_cb26944c() {
	...
	private static String ReadReadQuery_0 = " SELECT 1 FROM BH.COVERAGETYPE  T1 WHERE T1.COVERAGE_TYPE = ?";
	/**
	 * ReadReadChecking
	 */
	...
	private static String ReadReadForUpdateQuery_0 = " SELECT 1 FROM BH.COVERAGETYPE  T1 WHERE T1.COVERAGE_TYPE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private void initializeUpdateTemplates() throws javax.resource.ResourceException {
		updateTemplateList = BaseAgreementCoverageTypeBeanPartialUpdateQueryHelper.getUpdateTemplates();
	}
