...
/**
 * GroupBeanFunctionSet_e8523fb7
 */
public class GroupBeanFunctionSet_e8523fb7 extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	private java.util.HashMap functionHash;
	private static String CreateQuery_0 = "INSERT INTO BH.GROUP (GROUP_NAME, SALES_ORG) VALUES (?, ?)";
	/**
	 * Create
	 */
	...
	private static String RemoveQuery_0 = "DELETE FROM BH.GROUP  WHERE GROUP_NAME = ?";
	/**
	 * Remove
	 */
	...
	private static String StoreQuery_0 = "UPDATE BH.GROUP  SET SALES_ORG = ? WHERE GROUP_NAME = ?";
	/**
	 * Store
	 */
	...
	private static String StoreOCCQuery_0 = "UPDATE BH.GROUP  SET SALES_ORG = ? WHERE GROUP_NAME = ?";
	/**
	 * StoreUsingOCC
	 */
	...
	private static String findBySalesOrgQuery_0 = " select  q1.\"GROUP_NAME\",  q1.\"SALES_ORG\" from BH.GROUP q1 where  ( q1.\"SALES_ORG\" = ?) ";
	/**
	 * FindBySalesOrg
	 */
	public javax.resource.cci.Record FindBySalesOrg(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		...
		try {
			/* select object(o) from Group1 o where o.salesOrg=?1 */
	...
	private static String findBySalesOrgForUpdateQuery_0 = " select  q1.\"GROUP_NAME\",  q1.\"SALES_ORG\" from BH.GROUP q1 where  ( q1.\"SALES_ORG\" = ?)  FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String findBySalesOrgForUpdateWithRRQuery_0 = " select  q1.\"GROUP_NAME\",  q1.\"SALES_ORG\" from BH.GROUP q1 where  ( q1.\"SALES_ORG\" = ?)  FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String findBySalesOrgForUpdateWithRSQuery_0 = " select  q1.\"GROUP_NAME\",  q1.\"SALES_ORG\" from BH.GROUP q1 where  ( q1.\"SALES_ORG\" = ?)  FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String findByGroupNameQuery_0 = " select  q1.\"GROUP_NAME\",  q1.\"SALES_ORG\" from BH.GROUP q1 where  ( q1.\"GROUP_NAME\" = ?) ";
	/**
	 * FindByGroupName
	 */
	public javax.resource.cci.Record FindByGroupName(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		...
		ResultSet result=null;
		try {
			/* select object(o) from Group1 o where  o.groupName = ?1 */
	...
	private static String findByGroupNameForUpdateQuery_0 = " select  q1.\"GROUP_NAME\",  q1.\"SALES_ORG\" from BH.GROUP q1 where  ( q1.\"GROUP_NAME\" = ?)  FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String findByGroupNameForUpdateWithRRQuery_0 = " select  q1.\"GROUP_NAME\",  q1.\"SALES_ORG\" from BH.GROUP q1 where  ( q1.\"GROUP_NAME\" = ?)  FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String findByGroupNameForUpdateWithRSQuery_0 = " select  q1.\"GROUP_NAME\",  q1.\"SALES_ORG\" from BH.GROUP q1 where  ( q1.\"GROUP_NAME\" = ?)  FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String findAllGroupQuery_0 = " select  q1.\"GROUP_NAME\",  q1.\"SALES_ORG\" from BH.GROUP q1";
	/**
	 * FindAllGroup
	 */
	public javax.resource.cci.Record FindAllGroup(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from Group1 o */
			pstmt = prepareStatement(connection, findAllGroupQuery_0);

			result = executeQuery(connection, pstmt, findAllGroupQuery_0);
	...
	private static String findAllGroupForUpdateQuery_0 = " select  q1.\"GROUP_NAME\",  q1.\"SALES_ORG\" from BH.GROUP q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllGroup444Update
	 */
	public javax.resource.cci.Record FindAllGroup444Update(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from Group1 o */
			pstmt = prepareStatement(connection, findAllGroupForUpdateQuery_0);

			result = executeQuery(connection, pstmt, findAllGroupForUpdateQuery_0);
	...
	private static String findAllGroupForUpdateWithRRQuery_0 = " select  q1.\"GROUP_NAME\",  q1.\"SALES_ORG\" from BH.GROUP q1 FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllGroupForUpdateWithRR
	 */
	public javax.resource.cci.Record FindAllGroupForUpdateWithRR(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from Group1 o */
			pstmt = prepareStatement(connection, findAllGroupForUpdateWithRRQuery_0);

			result = executeQuery(connection, pstmt, findAllGroupForUpdateWithRRQuery_0);
	...
	private static String findAllGroupForUpdateWithRSQuery_0 = " select  q1.\"GROUP_NAME\",  q1.\"SALES_ORG\" from BH.GROUP q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllGroupForUpdateWithRS
	 */
	public javax.resource.cci.Record FindAllGroupForUpdateWithRS(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from Group1 o */
			pstmt = prepareStatement(connection, findAllGroupForUpdateWithRSQuery_0);

			result = executeQuery(connection, pstmt, findAllGroupForUpdateWithRSQuery_0);
	...
	private static String FindByPrimaryKeyQuery_0 = " SELECT T1.GROUP_NAME, T1.SALES_ORG FROM BH.GROUP  T1 WHERE T1.GROUP_NAME = ?";
	/**
	 * FindByPrimaryKey
	 */
	...
	private static String FindByPrimaryKeyForUpdateQuery_0 = " SELECT T1.GROUP_NAME, T1.SALES_ORG FROM BH.GROUP  T1 WHERE T1.GROUP_NAME = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRRQuery_0 = " SELECT T1.GROUP_NAME, T1.SALES_ORG FROM BH.GROUP  T1 WHERE T1.GROUP_NAME = ? FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRSQuery_0 = " SELECT T1.GROUP_NAME, T1.SALES_ORG FROM BH.GROUP  T1 WHERE T1.GROUP_NAME = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 ...
	 * GroupBeanFunctionSet_e8523fb7
	 */
	public GroupBeanFunctionSet_e8523fb7() {
		...
		functionHash.put("FindByGroupName",new Integer(8));
		functionHash.put("FindByGroupName444Update",new Integer(9));
		functionHash.put("FindByGroupNameForUpdateWithRR",new Integer(10));
		functionHash.put("FindByGroupNameForUpdateWithRS",new Integer(11));
		functionHash.put("FindAllGroup",new Integer(12));
		functionHash.put("FindAllGroup444Update",new Integer(13));
		functionHash.put("FindAllGroupForUpdateWithRR",new Integer(14));
		functionHash.put("FindAllGroupForUpdateWithRS",new Integer(15));
	...
	public Record execute(WSInteractionSpec interactionSpec, IndexedRecord inputRecord, Object connection) throws javax.resource.ResourceException {
		...
		case 11:
			...
			break;
		case 12:
			outputRecord=FindAllGroup(inputRecord,connection,interactionSpec);
			break;
		case 13:
			outputRecord=FindAllGroup444Update(inputRecord,connection,interactionSpec);
			break;
		case 14:
			outputRecord=FindAllGroupForUpdateWithRR(inputRecord,connection,interactionSpec);
			break;
		case 15:
			outputRecord=FindAllGroupForUpdateWithRS(inputRecord,connection,interactionSpec);
			break;
		case 16:
	...
	private static String ReadReadQuery_0 = " SELECT 1 FROM BH.GROUP  T1 WHERE T1.GROUP_NAME = ?";
	/**
	 * ReadReadChecking
	 */
	...
	private static String ReadReadForUpdateQuery_0 = " SELECT 1 FROM BH.GROUP  T1 WHERE T1.GROUP_NAME = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private void initializeUpdateTemplates() throws javax.resource.ResourceException {
		updateTemplateList = GroupBeanPartialUpdateQueryHelper.getUpdateTemplates();
	}
