...
/**
 * CustomerListBeanFunctionSet_93c2f859
 */
public class CustomerListBeanFunctionSet_93c2f859 extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	private java.util.HashMap functionHash;
	private static String CreateQuery_0 = "INSERT INTO BH.CUSTOMERLIST (PROPOSAL_ID, CUSTOMER_LIST_NO, CUSTOMER_LIST_NAME, LAST_UPDATE_DATE) VALUES (?, ?, ?, ?)";
	/**
	 * Create
	 */
	...
	private static String RemoveQuery_0 = "DELETE FROM BH.CUSTOMERLIST  WHERE PROPOSAL_ID = ? AND CUSTOMER_LIST_NO = ?";
	/**
	 * Remove
	 */
	...
	private static String StoreQuery_0 = "UPDATE BH.CUSTOMERLIST  SET CUSTOMER_LIST_NAME = ?, LAST_UPDATE_DATE = ? WHERE PROPOSAL_ID = ? AND CUSTOMER_LIST_NO = ?";
	/**
	 * Store
	 */
	...
	private static String StoreOCCQuery_0 = "UPDATE BH.CUSTOMERLIST  SET CUSTOMER_LIST_NAME = ?, LAST_UPDATE_DATE = ? WHERE PROPOSAL_ID = ? AND CUSTOMER_LIST_NO = ?";
	/**
	 * StoreUsingOCC
	 */
	...
	private static String FindByPrimaryKeyQuery_0 = " SELECT T1.PROPOSAL_ID, T1.CUSTOMER_LIST_NO, T1.CUSTOMER_LIST_NAME, T1.LAST_UPDATE_DATE FROM BH.CUSTOMERLIST  T1 WHERE T1.PROPOSAL_ID = ? AND T1.CUSTOMER_LIST_NO = ?";
	/**
	 * FindByPrimaryKey
	 */
	...
	private static String FindByPrimaryKeyForUpdateQuery_0 = " SELECT T1.PROPOSAL_ID, T1.CUSTOMER_LIST_NO, T1.CUSTOMER_LIST_NAME, T1.LAST_UPDATE_DATE FROM BH.CUSTOMERLIST  T1 WHERE T1.PROPOSAL_ID = ? AND T1.CUSTOMER_LIST_NO = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRRQuery_0 = " SELECT T1.PROPOSAL_ID, T1.CUSTOMER_LIST_NO, T1.CUSTOMER_LIST_NAME, T1.LAST_UPDATE_DATE FROM BH.CUSTOMERLIST  T1 WHERE T1.PROPOSAL_ID = ? AND T1.CUSTOMER_LIST_NO = ? FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRSQuery_0 = " SELECT T1.PROPOSAL_ID, T1.CUSTOMER_LIST_NO, T1.CUSTOMER_LIST_NAME, T1.LAST_UPDATE_DATE FROM BH.CUSTOMERLIST  T1 WHERE T1.PROPOSAL_ID = ? AND T1.CUSTOMER_LIST_NO = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String findByProposalIdQuery_0 = " select  q1.\"PROPOSAL_ID\",  q1.\"CUSTOMER_LIST_NO\",  q1.\"CUSTOMER_LIST_NAME\",  q1.\"LAST_UPDATE_DATE\" from BH.CUSTOMERLIST q1 where  ( q1.\"PROPOSAL_ID\" = ?) ";
	/**
	 * FindByProposalId
	 */
	public javax.resource.cci.Record FindByProposalId(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		...
		ResultSet result=null;
		try {
			/* select object(o) from CustomerList o where o.proposalId = ?1 */
	...
	private static String findByProposalIdForUpdateQuery_0 = " select  q1.\"PROPOSAL_ID\",  q1.\"CUSTOMER_LIST_NO\",  q1.\"CUSTOMER_LIST_NAME\",  q1.\"LAST_UPDATE_DATE\" from BH.CUSTOMERLIST q1 where  ( q1.\"PROPOSAL_ID\" = ?)  FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String findByProposalIdForUpdateWithRRQuery_0 = " select  q1.\"PROPOSAL_ID\",  q1.\"CUSTOMER_LIST_NO\",  q1.\"CUSTOMER_LIST_NAME\",  q1.\"LAST_UPDATE_DATE\" from BH.CUSTOMERLIST q1 where  ( q1.\"PROPOSAL_ID\" = ?)  FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String findByProposalIdForUpdateWithRSQuery_0 = " select  q1.\"PROPOSAL_ID\",  q1.\"CUSTOMER_LIST_NO\",  q1.\"CUSTOMER_LIST_NAME\",  q1.\"LAST_UPDATE_DATE\" from BH.CUSTOMERLIST q1 where  ( q1.\"PROPOSAL_ID\" = ?)  FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 ...
	 * CustomerListBeanFunctionSet_93c2f859
	 */
	public CustomerListBeanFunctionSet_93c2f859() {
		...
		functionHash.put("FindByProposalId",new Integer(8));
		functionHash.put("FindByProposalId444Update",new Integer(9));
		functionHash.put("FindByProposalIdForUpdateWithRR",new Integer(10));
		functionHash.put("FindByProposalIdForUpdateWithRS",new Integer(11));
	...
	private static String ReadReadQuery_0 = " SELECT 1 FROM BH.CUSTOMERLIST  T1 WHERE T1.PROPOSAL_ID = ? AND T1.CUSTOMER_LIST_NO = ?";
	/**
	 * ReadReadChecking
	 */
	...
	private static String ReadReadForUpdateQuery_0 = " SELECT 1 FROM BH.CUSTOMERLIST  T1 WHERE T1.PROPOSAL_ID = ? AND T1.CUSTOMER_LIST_NO = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private void initializeUpdateTemplates() throws javax.resource.ResourceException {
		updateTemplateList = CustomerListBeanPartialUpdateQueryHelper.getUpdateTemplates();
	}
