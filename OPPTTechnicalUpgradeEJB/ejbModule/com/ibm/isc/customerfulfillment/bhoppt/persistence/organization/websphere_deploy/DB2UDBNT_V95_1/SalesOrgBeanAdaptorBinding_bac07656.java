...
/**
 * SalesOrgBeanAdaptorBinding_bac07656
 */
public class SalesOrgBeanAdaptorBinding_bac07656 implements com.ibm.ws.ejbpersistence.beanextensions.EJBAdapterBinding {
	/**
	 * getExtractor
	 */
	public com.ibm.ws.ejbpersistence.dataaccess.EJBExtractor getExtractor() {
		// extractor for com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.SalesOrgBeanExtractor_bac07656
		com.ibm.ws.ejbpersistence.dataaccess.AbstractEJBExtractor extractor =  new com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.SalesOrgBeanExtractor_bac07656();
	...
	public com.ibm.ws.ejbpersistence.beanextensions.EJBInjector getInjector() {
		return new com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.SalesOrgBeanInjectorImpl_bac07656();
	}
	/**
	 * getAdapter
	 */
	...
	public Object[] getMetadata() {
		...
		//-------------------------------------Alias-------------------------------------
		cat[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogRDBAlias("SalesOrg", "SalesOrg1_Alias", "DB2NT", "BH.SALES_ORG", "SalesOrg_SalesOrg1_Table", 9, 5, 1);
		...
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("SALES_ORG_DESC", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 20, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		fields[2] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("DEFAULT_CURRENCY", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 5, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		primarykey = new String[1];
		primarykey[0] = "SALES_ORG";
		cat[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogType("SalesOrg", "SalesOrg1_Table", null, fields, primarykey);
		...
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("salesOrgDesc", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		fields[2] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("defaultCurrency", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		primarykey = new String[1];
		primarykey[0] = "salesOrg";
		cat[2] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogType("SalesOrg", "SalesOrg_BO", "com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.SalesOrgBean", fields, primarykey);
		...
		subhomes = null;
		cat[3] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogView("SalesOrg", "SalesOrg_SalesOrg_BO", "SalesOrg_SalesOrg1_Alias", composedObjs, composedObjImpls, 
		"select t1.SALES_ORG,t1.SALES_ORG_DESC,t1.DEFAULT_CURRENCY from _this t1", 
		null, subhomes, 
		0, null);
	...
	public java.util.Collection createDataAccessSpecs() throws javax.resource.ResourceException {
		...
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.SalesOrgBeanFunctionSet_bac07656");
		...
		daSpec.setQueryScope(new String[]{"SalesOrg"});
		result.add(daSpec);
		...
		iSpec=new com.ibm.ws.rsadapter.cci.WSInteractionSpecImpl();
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.SalesOrgBeanFunctionSet_bac07656");
		iSpec.setFunctionName("FindAllSalesOrg");
		daSpec.setInteractionSpec(iSpec);
		daSpec.setSpecName("FindAllSalesOrg");
		daSpec.setInputRecordName("FindAllSalesOrg");
		daSpec.setOptimistic(false);
		...
		iSpec=new com.ibm.ws.rsadapter.cci.WSInteractionSpecImpl();
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.SalesOrgBeanFunctionSet_bac07656");
		iSpec.setFunctionName("FindAllSalesOrg444Update");
		daSpec.setInteractionSpec(iSpec);
		daSpec.setSpecName("FindAllSalesOrg");
		daSpec.setInputRecordName("FindAllSalesOrg");
		daSpec.setOptimistic(false);
		...
		iSpec=new com.ibm.ws.rsadapter.cci.WSInteractionSpecImpl();
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.SalesOrgBeanFunctionSet_bac07656");
		iSpec.setFunctionName("FindAllSalesOrgForUpdateWithRR");
		daSpec.setInteractionSpec(iSpec);
		daSpec.setSpecName("FindAllSalesOrg");
		daSpec.setInputRecordName("FindAllSalesOrg");
		daSpec.setOptimistic(false);
		...
		iSpec=new com.ibm.ws.rsadapter.cci.WSInteractionSpecImpl();
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.SalesOrgBeanFunctionSet_bac07656");
		iSpec.setFunctionName("FindAllSalesOrgForUpdateWithRS");
		daSpec.setInteractionSpec(iSpec);
		daSpec.setSpecName("FindAllSalesOrg");
		daSpec.setInputRecordName("FindAllSalesOrg");
		daSpec.setOptimistic(false);
	 ...
	 * SalesOrgBeanAdaptorBinding_bac07656
	 */
	public SalesOrgBeanAdaptorBinding_bac07656() {
