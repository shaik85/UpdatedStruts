...
/**
 * EEBeanCacheEntryImpl_53787648
 */
public class EEBeanCacheEntryImpl_53787648 extends com.ibm.ws.ejbpersistence.cache.DataCacheEntry implements com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.websphere_deploy.EEBeanCacheEntry_53787648 {
	...
	public java.lang.String getChargeOption() {
		return CHARGE_OPTION_Data;
	}
	/**
	 * setChargeOption
	 */
	public void setChargeOption(String data) {
		this.CHARGE_OPTION_Data=data;
	}
	/**
	 * setDataForCHARGE_OPTION
	 */
	public void setDataForCHARGE_OPTION(String data) {
		this.CHARGE_OPTION_Data=data;
	}
	private String CHARGE_OPTION_Data;
	/**
	 * getChargeOptionDesc
	 */
	 ...
	 * setListPrice
	 */
	public void setListPrice(double data) {
		this.LIST_PRICE_Data=data;
	}
	/**
	 * setDataForLIST_PRICE
	 */
	public void setDataForLIST_PRICE(double data) {
		this.LIST_PRICE_Data=data;
	}
	private double LIST_PRICE_Data;
	/**
	 * getPletNo
	 */
	 ...
	 * setPletNo
	 */
	public void setPletNo(String data) {
		this.PLET_NO_Data=data;
	}
	/**
	 * setDataForPLET_NO
	 */
	public void setDataForPLET_NO(String data) {
		this.PLET_NO_Data=data;
	}
	private String PLET_NO_Data;
	/**
