...
/**
 * UserGroupBeanAdaptorBinding_c9153aeb
 */
public class UserGroupBeanAdaptorBinding_c9153aeb implements com.ibm.ws.ejbpersistence.beanextensions.EJBAdapterBinding {
	/**
	 * getExtractor
	 */
	public com.ibm.ws.ejbpersistence.dataaccess.EJBExtractor getExtractor() {
		// extractor for com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.UserGroupBeanExtractor_c9153aeb
		com.ibm.ws.ejbpersistence.dataaccess.AbstractEJBExtractor extractor =  new com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.UserGroupBeanExtractor_c9153aeb();
	...
	public com.ibm.ws.ejbpersistence.beanextensions.EJBInjector getInjector() {
		return new com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.UserGroupBeanInjectorImpl_c9153aeb();
	}
	/**
	 * getAdapter
	 */
	...
	public Object[] getMetadata() {
		...
		//-------------------------------------Alias-------------------------------------
		cat[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogRDBAlias("UserGroup", "UserGroup1_Alias", "DB2NT", "BH.USERGROUP", "UserGroup_UserGroup1_Table", 9, 5, 1);
		...
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("GROUP_NAME", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 20, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, true, 0, -1, 0, false);
		primarykey = new String[2];
		primarykey[0] = "USER_ID";
		primarykey[1] = "GROUP_NAME";
		cat[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogType("UserGroup", "UserGroup1_Table", null, fields, primarykey);
		...
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("groupName", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		primarykey = new String[2];
		primarykey[0] = "userId";
		primarykey[1] = "groupName";
		cat[2] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogType("UserGroup", "UserGroup_BO", "com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.UserGroupBean", fields, primarykey);
		...
		subhomes = null;
		cat[3] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogView("UserGroup", "UserGroup_UserGroup_BO", "UserGroup_UserGroup1_Alias", composedObjs, composedObjImpls, 
		"select t1.USER_ID,t1.GROUP_NAME from _this t1", 
		null, subhomes, 
		0, null);
	...
	public java.util.Collection createDataAccessSpecs() throws javax.resource.ResourceException {
		...
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.UserGroupBeanFunctionSet_c9153aeb");
		...
		daSpec.setQueryScope(new String[]{"UserGroup"});
		result.add(daSpec);
		...
		iSpec=new com.ibm.ws.rsadapter.cci.WSInteractionSpecImpl();
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.UserGroupBeanFunctionSet_c9153aeb");
		iSpec.setFunctionName("FindByGroup");
		daSpec.setInteractionSpec(iSpec);
		daSpec.setSpecName("FindByGroup");
		daSpec.setInputRecordName("FindByGroup");
		daSpec.setOptimistic(false);
		daSpec.setType(com.ibm.ws.ejbpersistence.beanextensions.EJBDataAccessSpec.FIND_BEAN);
		daSpec.setQueryScope(new String[]{"UserGroup"});
		daSpec.setReadAccess(true);
		...
		iSpec=new com.ibm.ws.rsadapter.cci.WSInteractionSpecImpl();
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.UserGroupBeanFunctionSet_c9153aeb");
		iSpec.setFunctionName("FindByGroup444Update");
		daSpec.setInteractionSpec(iSpec);
		daSpec.setSpecName("FindByGroup");
		daSpec.setInputRecordName("FindByGroup");
		daSpec.setOptimistic(false);
		...
		iSpec=new com.ibm.ws.rsadapter.cci.WSInteractionSpecImpl();
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.UserGroupBeanFunctionSet_c9153aeb");
		iSpec.setFunctionName("FindByGroupForUpdateWithRR");
		daSpec.setInteractionSpec(iSpec);
		daSpec.setSpecName("FindByGroup");
		daSpec.setInputRecordName("FindByGroup");
		daSpec.setOptimistic(false);
		...
		iSpec=new com.ibm.ws.rsadapter.cci.WSInteractionSpecImpl();
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.UserGroupBeanFunctionSet_c9153aeb");
		iSpec.setFunctionName("FindByGroupForUpdateWithRS");
		daSpec.setInteractionSpec(iSpec);
		daSpec.setSpecName("FindByGroup");
		daSpec.setInputRecordName("FindByGroup");
		daSpec.setOptimistic(false);
	 ...
	 * UserGroupBeanAdaptorBinding_c9153aeb
	 */
	public UserGroupBeanAdaptorBinding_c9153aeb() {
