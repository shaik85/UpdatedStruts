...
/**
 * BaseAgreementFormBeanFunctionSet_5d3cd1d7
 */
public class BaseAgreementFormBeanFunctionSet_5d3cd1d7 extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	private java.util.HashMap functionHash;
	private static String CreateQuery_0 = "INSERT INTO BH.FORMNUMBERS (FORM_NUMBER, SALES_ORG, FORM_SHORT_DESCRIPTION, FORM_LONG_DESCRIPTION) VALUES (?, ?, ?, ?)";
	/**
	 * Create
	 */
	public void Create(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		...
		try {
			...
			// For column FORM_SHORT_DESCRIPTION
			{
				String tempString;
			...
			// For column FORM_LONG_DESCRIPTION
			{
				String tempString;
	...
	private static String RemoveQuery_0 = "DELETE FROM BH.FORMNUMBERS  WHERE FORM_NUMBER = ? AND SALES_ORG = ?";
	/**
	 * Remove
	 */
	...
	private static String StoreQuery_0 = "UPDATE BH.FORMNUMBERS  SET FORM_SHORT_DESCRIPTION = ?, FORM_LONG_DESCRIPTION = ? WHERE FORM_NUMBER = ? AND SALES_ORG = ?";
	/**
	 * Store
	 */
	...
	private static String StoreOCCQuery_0 = "UPDATE BH.FORMNUMBERS  SET FORM_SHORT_DESCRIPTION = ?, FORM_LONG_DESCRIPTION = ? WHERE FORM_NUMBER = ? AND SALES_ORG = ?";
	/**
	 * StoreUsingOCC
	 */
	...
	private static String FindByPrimaryKeyQuery_0 = " SELECT T1.FORM_NUMBER, T1.FORM_SHORT_DESCRIPTION, T1.FORM_LONG_DESCRIPTION, T1.SALES_ORG FROM BH.FORMNUMBERS  T1 WHERE T1.FORM_NUMBER = ? AND T1.SALES_ORG = ?";
	/**
	 * FindByPrimaryKey
	 */
	...
	private static String FindByPrimaryKeyForUpdateQuery_0 = " SELECT T1.FORM_NUMBER, T1.FORM_SHORT_DESCRIPTION, T1.FORM_LONG_DESCRIPTION, T1.SALES_ORG FROM BH.FORMNUMBERS  T1 WHERE T1.FORM_NUMBER = ? AND T1.SALES_ORG = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRRQuery_0 = " SELECT T1.FORM_NUMBER, T1.FORM_SHORT_DESCRIPTION, T1.FORM_LONG_DESCRIPTION, T1.SALES_ORG FROM BH.FORMNUMBERS  T1 WHERE T1.FORM_NUMBER = ? AND T1.SALES_ORG = ? FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRSQuery_0 = " SELECT T1.FORM_NUMBER, T1.FORM_SHORT_DESCRIPTION, T1.FORM_LONG_DESCRIPTION, T1.SALES_ORG FROM BH.FORMNUMBERS  T1 WHERE T1.FORM_NUMBER = ? AND T1.SALES_ORG = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String findAllFormQuery_0 = " select  q1.\"FORM_NUMBER\",  q1.\"FORM_SHORT_DESCRIPTION\",  q1.\"FORM_LONG_DESCRIPTION\",  q1.\"SALES_ORG\" from BH.FORMNUMBERS q1 where  ( q1.\"SALES_ORG\" = ?) ";
	/**
	 * FindAllForm
	 */
	public javax.resource.cci.Record FindAllForm(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from BaseAgreementForm o where  o.salesOrganization= ?1 */
			pstmt = prepareStatement(connection, findAllFormQuery_0);
			...
			result = executeQuery(connection, pstmt, findAllFormQuery_0);
	...
	private static String findAllFormForUpdateQuery_0 = " select  q1.\"FORM_NUMBER\",  q1.\"FORM_SHORT_DESCRIPTION\",  q1.\"FORM_LONG_DESCRIPTION\",  q1.\"SALES_ORG\" from BH.FORMNUMBERS q1 where  ( q1.\"SALES_ORG\" = ?)  FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllForm444Update
	 */
	public javax.resource.cci.Record FindAllForm444Update(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from BaseAgreementForm o where  o.salesOrganization= ?1 */
			pstmt = prepareStatement(connection, findAllFormForUpdateQuery_0);
			...
			result = executeQuery(connection, pstmt, findAllFormForUpdateQuery_0);
	...
	private static String findAllFormForUpdateWithRRQuery_0 = " select  q1.\"FORM_NUMBER\",  q1.\"FORM_SHORT_DESCRIPTION\",  q1.\"FORM_LONG_DESCRIPTION\",  q1.\"SALES_ORG\" from BH.FORMNUMBERS q1 where  ( q1.\"SALES_ORG\" = ?)  FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllFormForUpdateWithRR
	 */
	public javax.resource.cci.Record FindAllFormForUpdateWithRR(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from BaseAgreementForm o where  o.salesOrganization= ?1 */
			pstmt = prepareStatement(connection, findAllFormForUpdateWithRRQuery_0);
			...
			result = executeQuery(connection, pstmt, findAllFormForUpdateWithRRQuery_0);
	...
	private static String findAllFormForUpdateWithRSQuery_0 = " select  q1.\"FORM_NUMBER\",  q1.\"FORM_SHORT_DESCRIPTION\",  q1.\"FORM_LONG_DESCRIPTION\",  q1.\"SALES_ORG\" from BH.FORMNUMBERS q1 where  ( q1.\"SALES_ORG\" = ?)  FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllFormForUpdateWithRS
	 */
	public javax.resource.cci.Record FindAllFormForUpdateWithRS(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from BaseAgreementForm o where  o.salesOrganization= ?1 */
			pstmt = prepareStatement(connection, findAllFormForUpdateWithRSQuery_0);
			...
			result = executeQuery(connection, pstmt, findAllFormForUpdateWithRSQuery_0);
	 ...
	 * BaseAgreementFormBeanFunctionSet_5d3cd1d7
	 */
	public BaseAgreementFormBeanFunctionSet_5d3cd1d7() {
		...
		functionHash.put("FindAllForm",new Integer(8));
		functionHash.put("FindAllForm444Update",new Integer(9));
		functionHash.put("FindAllFormForUpdateWithRR",new Integer(10));
		functionHash.put("FindAllFormForUpdateWithRS",new Integer(11));
	...
	public Record execute(WSInteractionSpec interactionSpec, IndexedRecord inputRecord, Object connection) throws javax.resource.ResourceException {
		...
		case 7:
			...
			break;
		case 8:
			outputRecord=FindAllForm(inputRecord,connection,interactionSpec);
			break;
		case 9:
			outputRecord=FindAllForm444Update(inputRecord,connection,interactionSpec);
			break;
		case 10:
			outputRecord=FindAllFormForUpdateWithRR(inputRecord,connection,interactionSpec);
			break;
		case 11:
			outputRecord=FindAllFormForUpdateWithRS(inputRecord,connection,interactionSpec);
			break;
		case 12:
	...
	private static String ReadReadQuery_0 = " SELECT 1 FROM BH.FORMNUMBERS  T1 WHERE T1.FORM_NUMBER = ? AND T1.SALES_ORG = ?";
	/**
	 * ReadReadChecking
	 */
	...
	private static String ReadReadForUpdateQuery_0 = " SELECT 1 FROM BH.FORMNUMBERS  T1 WHERE T1.FORM_NUMBER = ? AND T1.SALES_ORG = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private void initializeUpdateTemplates() throws javax.resource.ResourceException {
		updateTemplateList = BaseAgreementFormBeanPartialUpdateQueryHelper.getUpdateTemplates();
	}
