...
/**
 * Key class for Entity Bean: HistoryEE
 */
public class HistoryEEKey implements java.io.Serializable {
	...
	/**
	 * Creates an empty key for Entity Bean: HistoryEE
	 */
	public HistoryEEKey() {
	}
	/**
	 * Creates a key for Entity Bean: HistoryEE
	 */
	public HistoryEEKey(
		int eeId,
		int swoId,
	...
	public boolean equals(java.lang.Object otherKey) {
		if (otherKey
			instanceof com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.HistoryEEKey) {
			com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.HistoryEEKey o =
				(com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.HistoryEEKey) otherKey;
			return (
				(this.eeId == o.eeId)
					&& (this.swoId == o.swoId)
					&& (this.dmId == o.dmId)
