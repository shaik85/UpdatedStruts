...
/**
 * PaymentMethodBeanFunctionSet_11426d9d
 */
public class PaymentMethodBeanFunctionSet_11426d9d extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	private java.util.HashMap functionHash;
	private static String CreateQuery_0 = "INSERT INTO BH.PAYMENTMETHOD (ID, DESCRIPTION, STATUS) VALUES (?, ?, ?)";
	/**
	 * Create
	 */
	...
	private static String RemoveQuery_0 = "DELETE FROM BH.PAYMENTMETHOD  WHERE ID = ?";
	/**
	 * Remove
	 */
	...
	private static String StoreQuery_0 = "UPDATE BH.PAYMENTMETHOD  SET DESCRIPTION = ?, STATUS = ? WHERE ID = ?";
	/**
	 * Store
	 */
	...
	private static String StoreOCCQuery_0 = "UPDATE BH.PAYMENTMETHOD  SET DESCRIPTION = ?, STATUS = ? WHERE ID = ?";
	/**
	 * StoreUsingOCC
	 */
	...
	private static String findAllPaymentMethodQuery_0 = " select  q1.\"ID\",  q1.\"DESCRIPTION\",  q1.\"STATUS\" from BH.PAYMENTMETHOD q1";
	/**
	 * FindAllPaymentMethod
	 */
	public javax.resource.cci.Record FindAllPaymentMethod(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from PaymentMethod o */
			pstmt = prepareStatement(connection, findAllPaymentMethodQuery_0);

			result = executeQuery(connection, pstmt, findAllPaymentMethodQuery_0);
	...
	private static String findAllPaymentMethodForUpdateQuery_0 = " select  q1.\"ID\",  q1.\"DESCRIPTION\",  q1.\"STATUS\" from BH.PAYMENTMETHOD q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllPaymentMethod444Update
	 */
	public javax.resource.cci.Record FindAllPaymentMethod444Update(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from PaymentMethod o */
			pstmt = prepareStatement(connection, findAllPaymentMethodForUpdateQuery_0);

			result = executeQuery(connection, pstmt, findAllPaymentMethodForUpdateQuery_0);
	...
	private static String findAllPaymentMethodForUpdateWithRRQuery_0 = " select  q1.\"ID\",  q1.\"DESCRIPTION\",  q1.\"STATUS\" from BH.PAYMENTMETHOD q1 FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllPaymentMethodForUpdateWithRR
	 */
	public javax.resource.cci.Record FindAllPaymentMethodForUpdateWithRR(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from PaymentMethod o */
			pstmt = prepareStatement(connection, findAllPaymentMethodForUpdateWithRRQuery_0);

			result = executeQuery(connection, pstmt, findAllPaymentMethodForUpdateWithRRQuery_0);
	...
	private static String findAllPaymentMethodForUpdateWithRSQuery_0 = " select  q1.\"ID\",  q1.\"DESCRIPTION\",  q1.\"STATUS\" from BH.PAYMENTMETHOD q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllPaymentMethodForUpdateWithRS
	 */
	public javax.resource.cci.Record FindAllPaymentMethodForUpdateWithRS(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from PaymentMethod o */
			pstmt = prepareStatement(connection, findAllPaymentMethodForUpdateWithRSQuery_0);

			result = executeQuery(connection, pstmt, findAllPaymentMethodForUpdateWithRSQuery_0);
	...
	private static String FindByPrimaryKeyQuery_0 = " SELECT T1.ID, T1.DESCRIPTION, T1.STATUS FROM BH.PAYMENTMETHOD  T1 WHERE T1.ID = ?";
	/**
	 * FindByPrimaryKey
	 */
	...
	private static String FindByPrimaryKeyForUpdateQuery_0 = " SELECT T1.ID, T1.DESCRIPTION, T1.STATUS FROM BH.PAYMENTMETHOD  T1 WHERE T1.ID = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRRQuery_0 = " SELECT T1.ID, T1.DESCRIPTION, T1.STATUS FROM BH.PAYMENTMETHOD  T1 WHERE T1.ID = ? FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRSQuery_0 = " SELECT T1.ID, T1.DESCRIPTION, T1.STATUS FROM BH.PAYMENTMETHOD  T1 WHERE T1.ID = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 ...
	 * PaymentMethodBeanFunctionSet_11426d9d
	 */
	public PaymentMethodBeanFunctionSet_11426d9d() {
		...
		functionHash.put("FindAllPaymentMethod",new Integer(4));
		functionHash.put("FindAllPaymentMethod444Update",new Integer(5));
		functionHash.put("FindAllPaymentMethodForUpdateWithRR",new Integer(6));
		functionHash.put("FindAllPaymentMethodForUpdateWithRS",new Integer(7));
	...
	public Record execute(WSInteractionSpec interactionSpec, IndexedRecord inputRecord, Object connection) throws javax.resource.ResourceException {
		...
		case 3:
			...
			break;
		case 4:
			outputRecord=FindAllPaymentMethod(inputRecord,connection,interactionSpec);
			break;
		case 5:
			outputRecord=FindAllPaymentMethod444Update(inputRecord,connection,interactionSpec);
			break;
		case 6:
			outputRecord=FindAllPaymentMethodForUpdateWithRR(inputRecord,connection,interactionSpec);
			break;
		case 7:
			outputRecord=FindAllPaymentMethodForUpdateWithRS(inputRecord,connection,interactionSpec);
			break;
		case 8:
	...
	private static String ReadReadQuery_0 = " SELECT 1 FROM BH.PAYMENTMETHOD  T1 WHERE T1.ID = ?";
	/**
	 * ReadReadChecking
	 */
	...
	private static String ReadReadForUpdateQuery_0 = " SELECT 1 FROM BH.PAYMENTMETHOD  T1 WHERE T1.ID = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private void initializeUpdateTemplates() throws javax.resource.ResourceException {
		updateTemplateList = PaymentMethodBeanPartialUpdateQueryHelper.getUpdateTemplates();
	}
