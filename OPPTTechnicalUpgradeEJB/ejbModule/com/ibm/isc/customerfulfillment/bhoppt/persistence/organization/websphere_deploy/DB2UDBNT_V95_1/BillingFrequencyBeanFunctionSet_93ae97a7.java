...
/**
 * BillingFrequencyBeanFunctionSet_93ae97a7
 */
public class BillingFrequencyBeanFunctionSet_93ae97a7 extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	private java.util.HashMap functionHash;
	private static String CreateQuery_0 = "INSERT INTO BH.BILLINGFREQUENCY (BILLING_FREQ_CODE, BILLING_FREQ_DESC) VALUES (?, ?)";
	/**
	 * Create
	 */
	...
	private static String RemoveQuery_0 = "DELETE FROM BH.BILLINGFREQUENCY  WHERE BILLING_FREQ_CODE = ?";
	/**
	 * Remove
	 */
	...
	private static String StoreQuery_0 = "UPDATE BH.BILLINGFREQUENCY  SET BILLING_FREQ_DESC = ? WHERE BILLING_FREQ_CODE = ?";
	/**
	 * Store
	 */
	...
	private static String StoreOCCQuery_0 = "UPDATE BH.BILLINGFREQUENCY  SET BILLING_FREQ_DESC = ? WHERE BILLING_FREQ_CODE = ?";
	/**
	 * StoreUsingOCC
	 */
	...
	private static String FindByPrimaryKeyQuery_0 = " SELECT T1.BILLING_FREQ_CODE, T1.BILLING_FREQ_DESC FROM BH.BILLINGFREQUENCY  T1 WHERE T1.BILLING_FREQ_CODE = ?";
	/**
	 * FindByPrimaryKey
	 */
	...
	private static String FindByPrimaryKeyForUpdateQuery_0 = " SELECT T1.BILLING_FREQ_CODE, T1.BILLING_FREQ_DESC FROM BH.BILLINGFREQUENCY  T1 WHERE T1.BILLING_FREQ_CODE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRRQuery_0 = " SELECT T1.BILLING_FREQ_CODE, T1.BILLING_FREQ_DESC FROM BH.BILLINGFREQUENCY  T1 WHERE T1.BILLING_FREQ_CODE = ? FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRSQuery_0 = " SELECT T1.BILLING_FREQ_CODE, T1.BILLING_FREQ_DESC FROM BH.BILLINGFREQUENCY  T1 WHERE T1.BILLING_FREQ_CODE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String findAllBillingFreqQuery_0 = " select  q1.\"BILLING_FREQ_CODE\",  q1.\"BILLING_FREQ_DESC\" from BH.BILLINGFREQUENCY q1";
	/**
	 * FindAllBillingFreq
	 */
	public javax.resource.cci.Record FindAllBillingFreq(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from BillingFrequency o */
			pstmt = prepareStatement(connection, findAllBillingFreqQuery_0);

			result = executeQuery(connection, pstmt, findAllBillingFreqQuery_0);
	...
	private static String findAllBillingFreqForUpdateQuery_0 = " select  q1.\"BILLING_FREQ_CODE\",  q1.\"BILLING_FREQ_DESC\" from BH.BILLINGFREQUENCY q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllBillingFreq444Update
	 */
	public javax.resource.cci.Record FindAllBillingFreq444Update(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from BillingFrequency o */
			pstmt = prepareStatement(connection, findAllBillingFreqForUpdateQuery_0);

			result = executeQuery(connection, pstmt, findAllBillingFreqForUpdateQuery_0);
	...
	private static String findAllBillingFreqForUpdateWithRRQuery_0 = " select  q1.\"BILLING_FREQ_CODE\",  q1.\"BILLING_FREQ_DESC\" from BH.BILLINGFREQUENCY q1 FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllBillingFreqForUpdateWithRR
	 */
	public javax.resource.cci.Record FindAllBillingFreqForUpdateWithRR(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from BillingFrequency o */
			pstmt = prepareStatement(connection, findAllBillingFreqForUpdateWithRRQuery_0);

			result = executeQuery(connection, pstmt, findAllBillingFreqForUpdateWithRRQuery_0);
	...
	private static String findAllBillingFreqForUpdateWithRSQuery_0 = " select  q1.\"BILLING_FREQ_CODE\",  q1.\"BILLING_FREQ_DESC\" from BH.BILLINGFREQUENCY q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllBillingFreqForUpdateWithRS
	 */
	public javax.resource.cci.Record FindAllBillingFreqForUpdateWithRS(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from BillingFrequency o */
			pstmt = prepareStatement(connection, findAllBillingFreqForUpdateWithRSQuery_0);

			result = executeQuery(connection, pstmt, findAllBillingFreqForUpdateWithRSQuery_0);
	 ...
	 * BillingFrequencyBeanFunctionSet_93ae97a7
	 */
	public BillingFrequencyBeanFunctionSet_93ae97a7() {
		...
		functionHash.put("FindAllBillingFreq",new Integer(8));
		functionHash.put("FindAllBillingFreq444Update",new Integer(9));
		functionHash.put("FindAllBillingFreqForUpdateWithRR",new Integer(10));
		functionHash.put("FindAllBillingFreqForUpdateWithRS",new Integer(11));
	...
	public Record execute(WSInteractionSpec interactionSpec, IndexedRecord inputRecord, Object connection) throws javax.resource.ResourceException {
		...
		case 7:
			...
			break;
		case 8:
			outputRecord=FindAllBillingFreq(inputRecord,connection,interactionSpec);
			break;
		case 9:
			outputRecord=FindAllBillingFreq444Update(inputRecord,connection,interactionSpec);
			break;
		case 10:
			outputRecord=FindAllBillingFreqForUpdateWithRR(inputRecord,connection,interactionSpec);
			break;
		case 11:
			outputRecord=FindAllBillingFreqForUpdateWithRS(inputRecord,connection,interactionSpec);
			break;
		case 12:
	...
	private static String ReadReadQuery_0 = " SELECT 1 FROM BH.BILLINGFREQUENCY  T1 WHERE T1.BILLING_FREQ_CODE = ?";
	/**
	 * ReadReadChecking
	 */
	...
	private static String ReadReadForUpdateQuery_0 = " SELECT 1 FROM BH.BILLINGFREQUENCY  T1 WHERE T1.BILLING_FREQ_CODE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private void initializeUpdateTemplates() throws javax.resource.ResourceException {
		updateTemplateList = BillingFrequencyBeanPartialUpdateQueryHelper.getUpdateTemplates();
	}
