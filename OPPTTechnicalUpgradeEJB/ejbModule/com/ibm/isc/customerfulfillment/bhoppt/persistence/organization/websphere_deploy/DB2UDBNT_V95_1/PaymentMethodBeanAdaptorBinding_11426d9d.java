...
/**
 * PaymentMethodBeanAdaptorBinding_11426d9d
 */
public class PaymentMethodBeanAdaptorBinding_11426d9d implements com.ibm.ws.ejbpersistence.beanextensions.EJBAdapterBinding {
	/**
	 * getExtractor
	 */
	public com.ibm.ws.ejbpersistence.dataaccess.EJBExtractor getExtractor() {
		// extractor for com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.PaymentMethodBeanExtractor_11426d9d
		com.ibm.ws.ejbpersistence.dataaccess.AbstractEJBExtractor extractor =  new com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.PaymentMethodBeanExtractor_11426d9d();
	...
	public com.ibm.ws.ejbpersistence.beanextensions.EJBInjector getInjector() {
		return new com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.PaymentMethodBeanInjectorImpl_11426d9d();
	}
	/**
	 * getAdapter
	 */
	...
	public Object[] getMetadata() {
		...
		//-------------------------------------Alias-------------------------------------
		cat[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogRDBAlias("PaymentMethod", "PaymentMethod1_Alias", "DB2NT", "BH.PAYMENTMETHOD", "PaymentMethod_PaymentMethod1_Table", 9, 5, 1);


		//-----------------------------------Table Type-----------------------------------
		fields = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef[3];

		fields[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("ID", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 1, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, true, 0, -1, 0, false);
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("DESCRIPTION", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 100, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, true, 0, -1, 0, false);
		...
		primarykey[0] = "ID";
		cat[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogType("PaymentMethod", "PaymentMethod1_Table", null, fields, primarykey);


		//-----------------------------------Bean Type-----------------------------------
		fields = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef[3];

		fields[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("id", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("description", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		...
		primarykey = new String[1];
		primarykey[0] = "id";
		cat[2] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogType("PaymentMethod", "PaymentMethod_BO", "com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.PaymentMethodBean", fields, primarykey);
		...
		subhomes = null;
		cat[3] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogView("PaymentMethod", "PaymentMethod_PaymentMethod_BO", "PaymentMethod_PaymentMethod1_Alias", composedObjs, composedObjImpls, 
		"select t1.ID,t1.DESCRIPTION,t1.STATUS from _this t1", 
		null, subhomes, 
		0, null);
	...
	public java.util.Collection createDataAccessSpecs() throws javax.resource.ResourceException {
		...
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.PaymentMethodBeanFunctionSet_11426d9d");
		...
		daSpec.setQueryScope(new String[]{"PaymentMethod"});
		result.add(daSpec);
		...
		iSpec=new com.ibm.ws.rsadapter.cci.WSInteractionSpecImpl();
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.PaymentMethodBeanFunctionSet_11426d9d");
		iSpec.setFunctionName("FindAllPaymentMethod");
		daSpec.setInteractionSpec(iSpec);
		daSpec.setSpecName("FindAllPaymentMethod");
		daSpec.setInputRecordName("FindAllPaymentMethod");
		daSpec.setOptimistic(false);
		...
		iSpec=new com.ibm.ws.rsadapter.cci.WSInteractionSpecImpl();
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.PaymentMethodBeanFunctionSet_11426d9d");
		iSpec.setFunctionName("FindAllPaymentMethod444Update");
		daSpec.setInteractionSpec(iSpec);
		daSpec.setSpecName("FindAllPaymentMethod");
		daSpec.setInputRecordName("FindAllPaymentMethod");
		daSpec.setOptimistic(false);
		...
		iSpec=new com.ibm.ws.rsadapter.cci.WSInteractionSpecImpl();
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.PaymentMethodBeanFunctionSet_11426d9d");
		iSpec.setFunctionName("FindAllPaymentMethodForUpdateWithRR");
		daSpec.setInteractionSpec(iSpec);
		daSpec.setSpecName("FindAllPaymentMethod");
		daSpec.setInputRecordName("FindAllPaymentMethod");
		daSpec.setOptimistic(false);
		...
		iSpec=new com.ibm.ws.rsadapter.cci.WSInteractionSpecImpl();
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.PaymentMethodBeanFunctionSet_11426d9d");
		iSpec.setFunctionName("FindAllPaymentMethodForUpdateWithRS");
		daSpec.setInteractionSpec(iSpec);
		daSpec.setSpecName("FindAllPaymentMethod");
		daSpec.setInputRecordName("FindAllPaymentMethod");
		daSpec.setOptimistic(false);
	 ...
	 * PaymentMethodBeanAdaptorBinding_11426d9d
	 */
	public PaymentMethodBeanAdaptorBinding_11426d9d() {
