...
/**
 * CCTypeBeanFunctionSet_d1953ee3
 */
public class CCTypeBeanFunctionSet_d1953ee3 extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	private java.util.HashMap functionHash;
	private static String CreateQuery_0 = "INSERT INTO BH.CCTYPE (CC_TYPE, CC_DESC) VALUES (?, ?)";
	/**
	 * Create
	 */
	...
	private static String RemoveQuery_0 = "DELETE FROM BH.CCTYPE  WHERE CC_TYPE = ?";
	/**
	 * Remove
	 */
	...
	private static String StoreQuery_0 = "UPDATE BH.CCTYPE  SET CC_DESC = ? WHERE CC_TYPE = ?";
	/**
	 * Store
	 */
	...
	private static String StoreOCCQuery_0 = "UPDATE BH.CCTYPE  SET CC_DESC = ? WHERE CC_TYPE = ?";
	/**
	 * StoreUsingOCC
	 */
	...
	private static String FindByPrimaryKeyQuery_0 = " SELECT T1.CC_DESC, T1.CC_TYPE FROM BH.CCTYPE  T1 WHERE T1.CC_TYPE = ?";
	/**
	 * FindByPrimaryKey
	 */
	...
	private static String FindByPrimaryKeyForUpdateQuery_0 = " SELECT T1.CC_DESC, T1.CC_TYPE FROM BH.CCTYPE  T1 WHERE T1.CC_TYPE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRRQuery_0 = " SELECT T1.CC_DESC, T1.CC_TYPE FROM BH.CCTYPE  T1 WHERE T1.CC_TYPE = ? FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRSQuery_0 = " SELECT T1.CC_DESC, T1.CC_TYPE FROM BH.CCTYPE  T1 WHERE T1.CC_TYPE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String findAllCCTypeQuery_0 = " select  q1.\"CC_DESC\",  q1.\"CC_TYPE\" from BH.CCTYPE q1";
	/**
	 * FindAllCCType
	 */
	public javax.resource.cci.Record FindAllCCType(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from CCType o */
			pstmt = prepareStatement(connection, findAllCCTypeQuery_0);

			result = executeQuery(connection, pstmt, findAllCCTypeQuery_0);
	...
	private static String findAllCCTypeForUpdateQuery_0 = " select  q1.\"CC_DESC\",  q1.\"CC_TYPE\" from BH.CCTYPE q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllCCType444Update
	 */
	public javax.resource.cci.Record FindAllCCType444Update(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from CCType o */
			pstmt = prepareStatement(connection, findAllCCTypeForUpdateQuery_0);

			result = executeQuery(connection, pstmt, findAllCCTypeForUpdateQuery_0);
	...
	private static String findAllCCTypeForUpdateWithRRQuery_0 = " select  q1.\"CC_DESC\",  q1.\"CC_TYPE\" from BH.CCTYPE q1 FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllCCTypeForUpdateWithRR
	 */
	public javax.resource.cci.Record FindAllCCTypeForUpdateWithRR(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from CCType o */
			pstmt = prepareStatement(connection, findAllCCTypeForUpdateWithRRQuery_0);

			result = executeQuery(connection, pstmt, findAllCCTypeForUpdateWithRRQuery_0);
	...
	private static String findAllCCTypeForUpdateWithRSQuery_0 = " select  q1.\"CC_DESC\",  q1.\"CC_TYPE\" from BH.CCTYPE q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllCCTypeForUpdateWithRS
	 */
	public javax.resource.cci.Record FindAllCCTypeForUpdateWithRS(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from CCType o */
			pstmt = prepareStatement(connection, findAllCCTypeForUpdateWithRSQuery_0);

			result = executeQuery(connection, pstmt, findAllCCTypeForUpdateWithRSQuery_0);
	 ...
	 * CCTypeBeanFunctionSet_d1953ee3
	 */
	public CCTypeBeanFunctionSet_d1953ee3() {
		...
		functionHash.put("FindAllCCType",new Integer(8));
		functionHash.put("FindAllCCType444Update",new Integer(9));
		functionHash.put("FindAllCCTypeForUpdateWithRR",new Integer(10));
		functionHash.put("FindAllCCTypeForUpdateWithRS",new Integer(11));
	...
	public Record execute(WSInteractionSpec interactionSpec, IndexedRecord inputRecord, Object connection) throws javax.resource.ResourceException {
		...
		case 7:
			...
			break;
		case 8:
			outputRecord=FindAllCCType(inputRecord,connection,interactionSpec);
			break;
		case 9:
			outputRecord=FindAllCCType444Update(inputRecord,connection,interactionSpec);
			break;
		case 10:
			outputRecord=FindAllCCTypeForUpdateWithRR(inputRecord,connection,interactionSpec);
			break;
		case 11:
			outputRecord=FindAllCCTypeForUpdateWithRS(inputRecord,connection,interactionSpec);
			break;
		case 12:
	...
	private static String ReadReadQuery_0 = " SELECT 1 FROM BH.CCTYPE  T1 WHERE T1.CC_TYPE = ?";
	/**
	 * ReadReadChecking
	 */
	...
	private static String ReadReadForUpdateQuery_0 = " SELECT 1 FROM BH.CCTYPE  T1 WHERE T1.CC_TYPE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private void initializeUpdateTemplates() throws javax.resource.ResourceException {
		updateTemplateList = CCTypeBeanPartialUpdateQueryHelper.getUpdateTemplates();
	}
