...
/**
 * Key class for Entity Bean: VarianceSWO
 */
public class VarianceSWOKey implements java.io.Serializable {
	...
	/**
	 * Creates an empty key for Entity Bean: VarianceSWO
	 */
	public VarianceSWOKey() {
	}
	/**
	 * Creates a key for Entity Bean: VarianceSWO
	 */
	public VarianceSWOKey(
		int swoId,
		int dmId,
	...
	public boolean equals(java.lang.Object otherKey) {
		if (otherKey
			instanceof com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.VarianceSWOKey) {
			com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.VarianceSWOKey o =
				(com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.VarianceSWOKey) otherKey;
			return (
				(this.swoId == o.swoId)
					&& (this.dmId == o.dmId)
