...
import com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.websphere_deploy.PriceBeanCacheEntry_dffc00c5;

/**
 * Bean implementation class for Enterprise Bean: Price
 */
public class ConcretePrice_dffc00c5 extends com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.PriceBean implements javax.ejb.EntityBean, ConcreteBean {
	...
	private PriceBeanCacheEntry_dffc00c5 dataCacheEntry;
	/**
	...
	/**
	 * ConcretePrice_dffc00c5
	 */
	public ConcretePrice_dffc00c5() {
		super();
	 ...
	 * getInjector
	 */
	private com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.websphere_deploy.PriceBeanInjector_dffc00c5 getInjector() {
		return (com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.websphere_deploy.PriceBeanInjector_dffc00c5)instanceExtension.getInjector();
	}
	/**
	 * hydrate
	 */
	public void hydrate(Object inRecord) {
		dataCacheEntry = (com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.websphere_deploy.PriceBeanCacheEntry_dffc00c5) inRecord;
		super.ejbLoad();
	}
	/**
	 * resetCMP
	 ...
	 * ejbFindByPrimaryKey
	 */
	public com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.PriceKey ejbFindByPrimaryKey(com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.PriceKey primaryKey) throws javax.ejb.FinderException {
		return (com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.PriceKey)instanceExtension.ejbFindByPrimaryKey(primaryKey);
	}
	/**
	 * ejbFindByEE_Local
	 */
	public java.util.Collection ejbFindByEE_Local(int eeId, int swoId, int dmId, int customerId, int proposalId) throws javax.ejb.FinderException {
		javax.resource.cci.IndexedRecord record = instanceExtension.getInputRecord("FindByEE");
		getInjector().ejbFindByEE(eeId, swoId, dmId, customerId, proposalId, record);
		return (java.util.Collection) instanceExtension.executeFind("FindByEE", record);
	}
	/**
	 * ejbFindMaxPriceId_Local
	 */
	public java.util.Collection ejbFindMaxPriceId_Local() throws javax.ejb.FinderException {
		return (java.util.Collection) instanceExtension.executeFind("FindMaxPriceId", null);
	}
	/**
	 * ejbFindByPrimaryKey
	 */
	public Object ejbFindByPrimaryKey(java.lang.Object pk) throws javax.ejb.FinderException {
		return ejbFindByPrimaryKey((com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.PriceKey)pk);
	}
	/**
	 * ejbFindByPrimaryKeyForCMR_Local
	 */
	public com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.PriceKey ejbFindByPrimaryKeyForCMR_Local(com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.PriceKey pk) throws javax.ejb.FinderException {
		return (com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.PriceKey)instanceExtension.ejbFindByPrimaryKey(pk);
	}
	/**
	 * ejbCreate
	 */
	public com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.PriceKey ejbCreate(int priceId, int eeId, int swoId, int dmId, int customerId, int proposalId) throws javax.ejb.CreateException {
		dataCacheEntry = (PriceBeanCacheEntry_dffc00c5) instanceExtension.createDataCacheEntry();
		 super.ejbCreate(priceId, eeId, swoId, dmId, customerId, proposalId);
		return (com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.PriceKey)instanceExtension.ejbCreate();
	}
	/**
	 * ejbPostCreate
	 */
	...
	public Object createPrimaryKey() {
		com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.PriceKey pk = new com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.PriceKey();
	...
	public void setPriceId(int newPriceId) {
		if (instanceExtension.needValuesOnMarkDirty())
			instanceExtension.markDirty(0,getPriceId(),newPriceId);
		else
	...
	public void setEeId(int newEeId) {
		if (instanceExtension.needValuesOnMarkDirty())
			instanceExtension.markDirty(1,getEeId(),newEeId);
		else
	...
	public void setSwoId(int newSwoId) {
		if (instanceExtension.needValuesOnMarkDirty())
			instanceExtension.markDirty(2,getSwoId(),newSwoId);
		else
	...
	public void setDmId(int newDmId) {
		if (instanceExtension.needValuesOnMarkDirty())
			instanceExtension.markDirty(3,getDmId(),newDmId);
		else
	...
	public void setCustomerId(int newCustomerId) {
		if (instanceExtension.needValuesOnMarkDirty())
			instanceExtension.markDirty(4,getCustomerId(),newCustomerId);
		else
	...
	public void setProposalId(int newProposalId) {
		if (instanceExtension.needValuesOnMarkDirty())
			instanceExtension.markDirty(5,getProposalId(),newProposalId);
		else
	...
	public void setExclusionId(java.lang.String newExclusionId) {
		if (instanceExtension.needValuesOnMarkDirty())
			instanceExtension.markDirty(12,getExclusionId(),newExclusionId);
		else
	...
	public java.lang.String getBillingStatus() {
		return dataCacheEntry.getBillingStatus();
	}
	/**
	...
	public void setBillingStatus(java.lang.String newBillingStatus) {
		if (instanceExtension.needValuesOnMarkDirty())
			instanceExtension.markDirty(13,getBillingStatus(),newBillingStatus);
		else
			instanceExtension.markDirty(13);
		dataCacheEntry.setBillingStatus(newBillingStatus);
	}
	/**
	 * Get accessor for persistent attribute: monthId
	 */
	public java.lang.String getMonthId() {
		return dataCacheEntry.getMonthId();
	}
	/**
	...
	public void setMonthId(java.lang.String newMonthId) {
		if (instanceExtension.needValuesOnMarkDirty())
			instanceExtension.markDirty(14,getMonthId(),newMonthId);
		else
			instanceExtension.markDirty(14);
		dataCacheEntry.setMonthId(newMonthId);
	}
}
