...
/**
 * StatusBeanAdaptorBinding_7d6e2679
 */
public class StatusBeanAdaptorBinding_7d6e2679 implements com.ibm.ws.ejbpersistence.beanextensions.EJBAdapterBinding {
	/**
	 * getExtractor
	 */
	public com.ibm.ws.ejbpersistence.dataaccess.EJBExtractor getExtractor() {
		// extractor for com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.StatusBeanExtractor_7d6e2679
		com.ibm.ws.ejbpersistence.dataaccess.AbstractEJBExtractor extractor =  new com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.StatusBeanExtractor_7d6e2679();
	...
	public com.ibm.ws.ejbpersistence.beanextensions.EJBInjector getInjector() {
		return new com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.StatusBeanInjectorImpl_7d6e2679();
	}
	/**
	 * getAdapter
	 */
	...
	public Object[] getMetadata() {
		...
		//-------------------------------------Alias-------------------------------------
		cat[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogRDBAlias("Status", "Status1_Alias", "DB2NT", "BH.STATUS", "Status_Status1_Table", 9, 5, 1);


		//-----------------------------------Table Type-----------------------------------
		fields = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef[2];

		fields[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("STATUS_CODE", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 2, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, true, 0, -1, 0, false);
		...
		cat[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogType("Status", "Status1_Table", null, fields, primarykey);
		...
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("statusDesc", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		primarykey = new String[1];
		primarykey[0] = "statusCode";
		cat[2] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogType("Status", "Status_BO", "com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.StatusBean", fields, primarykey);
		...
		subhomes = null;
		cat[3] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogView("Status", "Status_Status_BO", "Status_Status1_Alias", composedObjs, composedObjImpls, 
	...
	public java.util.Collection createDataAccessSpecs() throws javax.resource.ResourceException {
		...
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.StatusBeanFunctionSet_7d6e2679");
		...
		daSpec.setQueryScope(new String[]{"Status"});
		result.add(daSpec);
	 ...
	 * StatusBeanAdaptorBinding_7d6e2679
	 */
	public StatusBeanAdaptorBinding_7d6e2679() {
