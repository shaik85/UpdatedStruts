...
/**
 * UserGroupBeanFunctionSet_c9153aeb
 */
public class UserGroupBeanFunctionSet_c9153aeb extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	private java.util.HashMap functionHash;
	private static String CreateQuery_0 = "INSERT INTO BH.USERGROUP (USER_ID, GROUP_NAME) VALUES (?, ?)";
	/**
	 * Create
	 */
	...
	private static String RemoveQuery_0 = "DELETE FROM BH.USERGROUP  WHERE USER_ID = ? AND GROUP_NAME = ?";
	/**
	 * Remove
	 */
	...
	private static String FindByPrimaryKeyQuery_0 = " SELECT T1.USER_ID, T1.GROUP_NAME FROM BH.USERGROUP  T1 WHERE T1.USER_ID = ? AND T1.GROUP_NAME = ?";
	/**
	 * FindByPrimaryKey
	 */
	...
	private static String FindByPrimaryKeyForUpdateQuery_0 = " SELECT T1.USER_ID, T1.GROUP_NAME FROM BH.USERGROUP  T1 WHERE T1.USER_ID = ? AND T1.GROUP_NAME = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRRQuery_0 = " SELECT T1.USER_ID, T1.GROUP_NAME FROM BH.USERGROUP  T1 WHERE T1.USER_ID = ? AND T1.GROUP_NAME = ? FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRSQuery_0 = " SELECT T1.USER_ID, T1.GROUP_NAME FROM BH.USERGROUP  T1 WHERE T1.USER_ID = ? AND T1.GROUP_NAME = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String findByUserQuery_0 = " select  q1.\"USER_ID\",  q1.\"GROUP_NAME\" from BH.USERGROUP q1 where  ( q1.\"USER_ID\" = ?) ";
	/**
	 * FindByUser
	 */
	public javax.resource.cci.Record FindByUser(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		...
		ResultSet result=null;
		try {
			/* select object(o) from UserGroup o where  o.userId = ?1 */
	...
	private static String findByUserForUpdateQuery_0 = " select  q1.\"USER_ID\",  q1.\"GROUP_NAME\" from BH.USERGROUP q1 where  ( q1.\"USER_ID\" = ?)  FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindByUser444Update
	 */
	...
	private static String findByUserForUpdateWithRRQuery_0 = " select  q1.\"USER_ID\",  q1.\"GROUP_NAME\" from BH.USERGROUP q1 where  ( q1.\"USER_ID\" = ?)  FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String findByUserForUpdateWithRSQuery_0 = " select  q1.\"USER_ID\",  q1.\"GROUP_NAME\" from BH.USERGROUP q1 where  ( q1.\"USER_ID\" = ?)  FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String findByGroupQuery_0 = " select  q1.\"USER_ID\",  q1.\"GROUP_NAME\" from BH.USERGROUP q1 where  ( q1.\"GROUP_NAME\" = ?) ";
	/**
	 * FindByGroup
	 */
	public javax.resource.cci.Record FindByGroup(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from UserGroup o where o.groupName = ?1 */
			pstmt = prepareStatement(connection, findByGroupQuery_0);
			...
			result = executeQuery(connection, pstmt, findByGroupQuery_0);
	...
	private static String findByGroupForUpdateQuery_0 = " select  q1.\"USER_ID\",  q1.\"GROUP_NAME\" from BH.USERGROUP q1 where  ( q1.\"GROUP_NAME\" = ?)  FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindByGroup444Update
	 */
	public javax.resource.cci.Record FindByGroup444Update(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from UserGroup o where o.groupName = ?1 */
			pstmt = prepareStatement(connection, findByGroupForUpdateQuery_0);
			...
			result = executeQuery(connection, pstmt, findByGroupForUpdateQuery_0);
	...
	private static String findByGroupForUpdateWithRRQuery_0 = " select  q1.\"USER_ID\",  q1.\"GROUP_NAME\" from BH.USERGROUP q1 where  ( q1.\"GROUP_NAME\" = ?)  FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	 * FindByGroupForUpdateWithRR
	 */
	public javax.resource.cci.Record FindByGroupForUpdateWithRR(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from UserGroup o where o.groupName = ?1 */
			pstmt = prepareStatement(connection, findByGroupForUpdateWithRRQuery_0);
			...
			result = executeQuery(connection, pstmt, findByGroupForUpdateWithRRQuery_0);
	...
	private static String findByGroupForUpdateWithRSQuery_0 = " select  q1.\"USER_ID\",  q1.\"GROUP_NAME\" from BH.USERGROUP q1 where  ( q1.\"GROUP_NAME\" = ?)  FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindByGroupForUpdateWithRS
	 */
	public javax.resource.cci.Record FindByGroupForUpdateWithRS(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from UserGroup o where o.groupName = ?1 */
			pstmt = prepareStatement(connection, findByGroupForUpdateWithRSQuery_0);
			...
			result = executeQuery(connection, pstmt, findByGroupForUpdateWithRSQuery_0);
	 ...
	 * UserGroupBeanFunctionSet_c9153aeb
	 */
	public UserGroupBeanFunctionSet_c9153aeb() {
		...
		functionHash.put("FindByGroup",new Integer(12));
		functionHash.put("FindByGroup444Update",new Integer(13));
		functionHash.put("FindByGroupForUpdateWithRR",new Integer(14));
		functionHash.put("FindByGroupForUpdateWithRS",new Integer(15));
	...
	public Record execute(WSInteractionSpec interactionSpec, IndexedRecord inputRecord, Object connection) throws javax.resource.ResourceException {
		...
		case 11:
			...
			break;
		case 12:
			outputRecord=FindByGroup(inputRecord,connection,interactionSpec);
			break;
		case 13:
			outputRecord=FindByGroup444Update(inputRecord,connection,interactionSpec);
			break;
		case 14:
			outputRecord=FindByGroupForUpdateWithRR(inputRecord,connection,interactionSpec);
			break;
		case 15:
			outputRecord=FindByGroupForUpdateWithRS(inputRecord,connection,interactionSpec);
			break;
		case 16:
	...
	private static String ReadReadQuery_0 = " SELECT 1 FROM BH.USERGROUP  T1 WHERE T1.USER_ID = ? AND T1.GROUP_NAME = ?";
	/**
	 * ReadReadChecking
	 */
	...
	private static String ReadReadForUpdateQuery_0 = " SELECT 1 FROM BH.USERGROUP  T1 WHERE T1.USER_ID = ? AND T1.GROUP_NAME = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private void initializeUpdateTemplates() throws javax.resource.ResourceException {
		updateTemplateList = UserGroupBeanPartialUpdateQueryHelper.getUpdateTemplates();
	}
