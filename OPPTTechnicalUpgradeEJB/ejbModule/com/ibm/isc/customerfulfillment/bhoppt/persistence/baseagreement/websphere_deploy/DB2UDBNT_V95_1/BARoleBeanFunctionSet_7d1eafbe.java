...
/**
 * BARoleBeanFunctionSet_7d1eafbe
 */
public class BARoleBeanFunctionSet_7d1eafbe extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	private java.util.HashMap functionHash;
	private static String CreateQuery_0 = "INSERT INTO BH.BAROLE (BA_ROLE, BA_ROLE_DESC) VALUES (?, ?)";
	/**
	 * Create
	 */
	...
	private static String RemoveQuery_0 = "DELETE FROM BH.BAROLE  WHERE BA_ROLE = ?";
	/**
	 * Remove
	 */
	...
	private static String StoreQuery_0 = "UPDATE BH.BAROLE  SET BA_ROLE_DESC = ? WHERE BA_ROLE = ?";
	/**
	 * Store
	 */
	...
	private static String StoreOCCQuery_0 = "UPDATE BH.BAROLE  SET BA_ROLE_DESC = ? WHERE BA_ROLE = ?";
	/**
	 * StoreUsingOCC
	 */
	...
	private static String findAllBARolesQuery_0 = " select  q1.\"BA_ROLE\",  q1.\"BA_ROLE_DESC\" from BH.BAROLE q1";
	/**
	 * FindAllBARoles
	 */
	public javax.resource.cci.Record FindAllBARoles(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from BARole o */
			pstmt = prepareStatement(connection, findAllBARolesQuery_0);

			result = executeQuery(connection, pstmt, findAllBARolesQuery_0);
	...
	private static String findAllBARolesForUpdateQuery_0 = " select  q1.\"BA_ROLE\",  q1.\"BA_ROLE_DESC\" from BH.BAROLE q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllBARoles444Update
	 */
	public javax.resource.cci.Record FindAllBARoles444Update(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from BARole o */
			pstmt = prepareStatement(connection, findAllBARolesForUpdateQuery_0);

			result = executeQuery(connection, pstmt, findAllBARolesForUpdateQuery_0);
	...
	private static String findAllBARolesForUpdateWithRRQuery_0 = " select  q1.\"BA_ROLE\",  q1.\"BA_ROLE_DESC\" from BH.BAROLE q1 FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllBARolesForUpdateWithRR
	 */
	public javax.resource.cci.Record FindAllBARolesForUpdateWithRR(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from BARole o */
			pstmt = prepareStatement(connection, findAllBARolesForUpdateWithRRQuery_0);

			result = executeQuery(connection, pstmt, findAllBARolesForUpdateWithRRQuery_0);
	...
	private static String findAllBARolesForUpdateWithRSQuery_0 = " select  q1.\"BA_ROLE\",  q1.\"BA_ROLE_DESC\" from BH.BAROLE q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllBARolesForUpdateWithRS
	 */
	public javax.resource.cci.Record FindAllBARolesForUpdateWithRS(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from BARole o */
			pstmt = prepareStatement(connection, findAllBARolesForUpdateWithRSQuery_0);

			result = executeQuery(connection, pstmt, findAllBARolesForUpdateWithRSQuery_0);
	...
	private static String FindByPrimaryKeyQuery_0 = " SELECT T1.BA_ROLE, T1.BA_ROLE_DESC FROM BH.BAROLE  T1 WHERE T1.BA_ROLE = ?";
	/**
	 * FindByPrimaryKey
	 */
	...
	private static String FindByPrimaryKeyForUpdateQuery_0 = " SELECT T1.BA_ROLE, T1.BA_ROLE_DESC FROM BH.BAROLE  T1 WHERE T1.BA_ROLE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRRQuery_0 = " SELECT T1.BA_ROLE, T1.BA_ROLE_DESC FROM BH.BAROLE  T1 WHERE T1.BA_ROLE = ? FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRSQuery_0 = " SELECT T1.BA_ROLE, T1.BA_ROLE_DESC FROM BH.BAROLE  T1 WHERE T1.BA_ROLE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 ...
	 * BARoleBeanFunctionSet_7d1eafbe
	 */
	public BARoleBeanFunctionSet_7d1eafbe() {
		...
		functionHash.put("FindAllBARoles",new Integer(4));
		functionHash.put("FindAllBARoles444Update",new Integer(5));
		functionHash.put("FindAllBARolesForUpdateWithRR",new Integer(6));
		functionHash.put("FindAllBARolesForUpdateWithRS",new Integer(7));
	...
	public Record execute(WSInteractionSpec interactionSpec, IndexedRecord inputRecord, Object connection) throws javax.resource.ResourceException {
		...
		case 3:
			...
			break;
		case 4:
			outputRecord=FindAllBARoles(inputRecord,connection,interactionSpec);
			break;
		case 5:
			outputRecord=FindAllBARoles444Update(inputRecord,connection,interactionSpec);
			break;
		case 6:
			outputRecord=FindAllBARolesForUpdateWithRR(inputRecord,connection,interactionSpec);
			break;
		case 7:
			outputRecord=FindAllBARolesForUpdateWithRS(inputRecord,connection,interactionSpec);
			break;
		case 8:
	...
	private static String ReadReadQuery_0 = " SELECT 1 FROM BH.BAROLE  T1 WHERE T1.BA_ROLE = ?";
	/**
	 * ReadReadChecking
	 */
	...
	private static String ReadReadForUpdateQuery_0 = " SELECT 1 FROM BH.BAROLE  T1 WHERE T1.BA_ROLE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private void initializeUpdateTemplates() throws javax.resource.ResourceException {
		updateTemplateList = BARoleBeanPartialUpdateQueryHelper.getUpdateTemplates();
	}
