...
/**
 * SalesAreaBeanFunctionSet_ac159cf0
 */
public class SalesAreaBeanFunctionSet_ac159cf0 extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	private java.util.HashMap functionHash;
	private static String CreateQuery_0 = "INSERT INTO BH.SALESAREA (SALES_ORG, DIVISION_CODE, DSTR_CHANNEL) VALUES (?, ?, ?)";
	/**
	 * Create
	 */
	...
	private static String RemoveQuery_0 = "DELETE FROM BH.SALESAREA  WHERE SALES_ORG = ? AND DIVISION_CODE = ? AND DSTR_CHANNEL = ?";
	/**
	 * Remove
	 */
	...
	private static String FindByPrimaryKeyQuery_0 = " SELECT T1.SALES_ORG, T1.DIVISION_CODE, T1.DSTR_CHANNEL FROM BH.SALESAREA  T1 WHERE T1.SALES_ORG = ? AND T1.DIVISION_CODE = ? AND T1.DSTR_CHANNEL = ?";
	/**
	 * FindByPrimaryKey
	 */
	...
	private static String FindByPrimaryKeyForUpdateQuery_0 = " SELECT T1.SALES_ORG, T1.DIVISION_CODE, T1.DSTR_CHANNEL FROM BH.SALESAREA  T1 WHERE T1.SALES_ORG = ? AND T1.DIVISION_CODE = ? AND T1.DSTR_CHANNEL = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRRQuery_0 = " SELECT T1.SALES_ORG, T1.DIVISION_CODE, T1.DSTR_CHANNEL FROM BH.SALESAREA  T1 WHERE T1.SALES_ORG = ? AND T1.DIVISION_CODE = ? AND T1.DSTR_CHANNEL = ? FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRSQuery_0 = " SELECT T1.SALES_ORG, T1.DIVISION_CODE, T1.DSTR_CHANNEL FROM BH.SALESAREA  T1 WHERE T1.SALES_ORG = ? AND T1.DIVISION_CODE = ? AND T1.DSTR_CHANNEL = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 ...
	 * SalesAreaBeanFunctionSet_ac159cf0
	 */
	public SalesAreaBeanFunctionSet_ac159cf0() {
	...
	private static String ReadReadQuery_0 = " SELECT 1 FROM BH.SALESAREA  T1 WHERE T1.SALES_ORG = ? AND T1.DIVISION_CODE = ? AND T1.DSTR_CHANNEL = ?";
	/**
	 * ReadReadChecking
	 */
	...
	private static String ReadReadForUpdateQuery_0 = " SELECT 1 FROM BH.SALESAREA  T1 WHERE T1.SALES_ORG = ? AND T1.DIVISION_CODE = ? AND T1.DSTR_CHANNEL = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private void initializeUpdateTemplates() throws javax.resource.ResourceException {
		updateTemplateList = SalesAreaBeanPartialUpdateQueryHelper.getUpdateTemplates();
	}
