...
/**
 * BaseAgreementStatusBeanFunctionSet_5d1cddf1
 */
public class BaseAgreementStatusBeanFunctionSet_5d1cddf1 extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	private java.util.HashMap functionHash;
	private static String CreateQuery_0 = "INSERT INTO BH.BASTATUS (STATUS_CODE, STATUS_DESC) VALUES (?, ?)";
	/**
	 * Create
	 */
	...
	private static String RemoveQuery_0 = "DELETE FROM BH.BASTATUS  WHERE STATUS_CODE = ?";
	/**
	 * Remove
	 */
	...
	private static String StoreQuery_0 = "UPDATE BH.BASTATUS  SET STATUS_DESC = ? WHERE STATUS_CODE = ?";
	/**
	 * Store
	 */
	...
	private static String StoreOCCQuery_0 = "UPDATE BH.BASTATUS  SET STATUS_DESC = ? WHERE STATUS_CODE = ?";
	/**
	 * StoreUsingOCC
	 */
	...
	private static String FindByPrimaryKeyQuery_0 = " SELECT T1.STATUS_CODE, T1.STATUS_DESC FROM BH.BASTATUS  T1 WHERE T1.STATUS_CODE = ?";
	/**
	 * FindByPrimaryKey
	 */
	...
	private static String FindByPrimaryKeyForUpdateQuery_0 = " SELECT T1.STATUS_CODE, T1.STATUS_DESC FROM BH.BASTATUS  T1 WHERE T1.STATUS_CODE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRRQuery_0 = " SELECT T1.STATUS_CODE, T1.STATUS_DESC FROM BH.BASTATUS  T1 WHERE T1.STATUS_CODE = ? FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRSQuery_0 = " SELECT T1.STATUS_CODE, T1.STATUS_DESC FROM BH.BASTATUS  T1 WHERE T1.STATUS_CODE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 ...
	 * BaseAgreementStatusBeanFunctionSet_5d1cddf1
	 */
	public BaseAgreementStatusBeanFunctionSet_5d1cddf1() {
	...
	private static String ReadReadQuery_0 = " SELECT 1 FROM BH.BASTATUS  T1 WHERE T1.STATUS_CODE = ?";
	/**
	 * ReadReadChecking
	 */
	...
	private static String ReadReadForUpdateQuery_0 = " SELECT 1 FROM BH.BASTATUS  T1 WHERE T1.STATUS_CODE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private void initializeUpdateTemplates() throws javax.resource.ResourceException {
		updateTemplateList = BaseAgreementStatusBeanPartialUpdateQueryHelper.getUpdateTemplates();
	}
