...
/**
 * DivisionBeanFunctionSet_31212604
 */
public class DivisionBeanFunctionSet_31212604 extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	private java.util.HashMap functionHash;
	private static String CreateQuery_0 = "INSERT INTO BH.DIVISION (DIVISION_CODE, DIVISION_DESC) VALUES (?, ?)";
	/**
	 * Create
	 */
	...
	private static String RemoveQuery_0 = "DELETE FROM BH.DIVISION  WHERE DIVISION_CODE = ?";
	/**
	 * Remove
	 */
	...
	private static String StoreQuery_0 = "UPDATE BH.DIVISION  SET DIVISION_DESC = ? WHERE DIVISION_CODE = ?";
	/**
	 * Store
	 */
	...
	private static String StoreOCCQuery_0 = "UPDATE BH.DIVISION  SET DIVISION_DESC = ? WHERE DIVISION_CODE = ?";
	/**
	 * StoreUsingOCC
	 */
	...
	private static String findAllDivisionQuery_0 = " select  q1.\"DIVISION_CODE\",  q1.\"DIVISION_DESC\" from BH.DIVISION q1";
	/**
	 * FindAllDivision
	 */
	public javax.resource.cci.Record FindAllDivision(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from Division o */
			pstmt = prepareStatement(connection, findAllDivisionQuery_0);

			result = executeQuery(connection, pstmt, findAllDivisionQuery_0);
	...
	private static String findAllDivisionForUpdateQuery_0 = " select  q1.\"DIVISION_CODE\",  q1.\"DIVISION_DESC\" from BH.DIVISION q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllDivision444Update
	 */
	public javax.resource.cci.Record FindAllDivision444Update(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from Division o */
			pstmt = prepareStatement(connection, findAllDivisionForUpdateQuery_0);

			result = executeQuery(connection, pstmt, findAllDivisionForUpdateQuery_0);
	...
	private static String findAllDivisionForUpdateWithRRQuery_0 = " select  q1.\"DIVISION_CODE\",  q1.\"DIVISION_DESC\" from BH.DIVISION q1 FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllDivisionForUpdateWithRR
	 */
	public javax.resource.cci.Record FindAllDivisionForUpdateWithRR(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from Division o */
			pstmt = prepareStatement(connection, findAllDivisionForUpdateWithRRQuery_0);

			result = executeQuery(connection, pstmt, findAllDivisionForUpdateWithRRQuery_0);
	...
	private static String findAllDivisionForUpdateWithRSQuery_0 = " select  q1.\"DIVISION_CODE\",  q1.\"DIVISION_DESC\" from BH.DIVISION q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllDivisionForUpdateWithRS
	 */
	public javax.resource.cci.Record FindAllDivisionForUpdateWithRS(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from Division o */
			pstmt = prepareStatement(connection, findAllDivisionForUpdateWithRSQuery_0);

			result = executeQuery(connection, pstmt, findAllDivisionForUpdateWithRSQuery_0);
	...
	private static String FindByPrimaryKeyQuery_0 = " SELECT T1.DIVISION_CODE, T1.DIVISION_DESC FROM BH.DIVISION  T1 WHERE T1.DIVISION_CODE = ?";
	/**
	 * FindByPrimaryKey
	 */
	...
	private static String FindByPrimaryKeyForUpdateQuery_0 = " SELECT T1.DIVISION_CODE, T1.DIVISION_DESC FROM BH.DIVISION  T1 WHERE T1.DIVISION_CODE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRRQuery_0 = " SELECT T1.DIVISION_CODE, T1.DIVISION_DESC FROM BH.DIVISION  T1 WHERE T1.DIVISION_CODE = ? FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRSQuery_0 = " SELECT T1.DIVISION_CODE, T1.DIVISION_DESC FROM BH.DIVISION  T1 WHERE T1.DIVISION_CODE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 ...
	 * DivisionBeanFunctionSet_31212604
	 */
	public DivisionBeanFunctionSet_31212604() {
		...
		functionHash.put("FindAllDivision",new Integer(4));
		functionHash.put("FindAllDivision444Update",new Integer(5));
		functionHash.put("FindAllDivisionForUpdateWithRR",new Integer(6));
		functionHash.put("FindAllDivisionForUpdateWithRS",new Integer(7));
	...
	public Record execute(WSInteractionSpec interactionSpec, IndexedRecord inputRecord, Object connection) throws javax.resource.ResourceException {
		...
		case 3:
			...
			break;
		case 4:
			outputRecord=FindAllDivision(inputRecord,connection,interactionSpec);
			break;
		case 5:
			outputRecord=FindAllDivision444Update(inputRecord,connection,interactionSpec);
			break;
		case 6:
			outputRecord=FindAllDivisionForUpdateWithRR(inputRecord,connection,interactionSpec);
			break;
		case 7:
			outputRecord=FindAllDivisionForUpdateWithRS(inputRecord,connection,interactionSpec);
			break;
		case 8:
	...
	private static String ReadReadQuery_0 = " SELECT 1 FROM BH.DIVISION  T1 WHERE T1.DIVISION_CODE = ?";
	/**
	 * ReadReadChecking
	 */
	...
	private static String ReadReadForUpdateQuery_0 = " SELECT 1 FROM BH.DIVISION  T1 WHERE T1.DIVISION_CODE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private void initializeUpdateTemplates() throws javax.resource.ResourceException {
		updateTemplateList = DivisionBeanPartialUpdateQueryHelper.getUpdateTemplates();
	}
