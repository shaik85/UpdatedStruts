...
/**
 * MCTypeBeanFunctionSet_b8a50e19
 */
public class MCTypeBeanFunctionSet_b8a50e19 extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	private java.util.HashMap functionHash;
	private static String CreateQuery_0 = "INSERT INTO BH.MCTYPE (MC_TYPE, MC_DESC) VALUES (?, ?)";
	/**
	 * Create
	 */
	...
	private static String RemoveQuery_0 = "DELETE FROM BH.MCTYPE  WHERE MC_TYPE = ?";
	/**
	 * Remove
	 */
	...
	private static String StoreQuery_0 = "UPDATE BH.MCTYPE  SET MC_DESC = ? WHERE MC_TYPE = ?";
	/**
	 * Store
	 */
	...
	private static String StoreOCCQuery_0 = "UPDATE BH.MCTYPE  SET MC_DESC = ? WHERE MC_TYPE = ?";
	/**
	 * StoreUsingOCC
	 */
	...
	private static String FindByPrimaryKeyQuery_0 = " SELECT T1.MC_TYPE, T1.MC_DESC FROM BH.MCTYPE  T1 WHERE T1.MC_TYPE = ?";
	/**
	 * FindByPrimaryKey
	 */
	...
	private static String FindByPrimaryKeyForUpdateQuery_0 = " SELECT T1.MC_TYPE, T1.MC_DESC FROM BH.MCTYPE  T1 WHERE T1.MC_TYPE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRRQuery_0 = " SELECT T1.MC_TYPE, T1.MC_DESC FROM BH.MCTYPE  T1 WHERE T1.MC_TYPE = ? FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRSQuery_0 = " SELECT T1.MC_TYPE, T1.MC_DESC FROM BH.MCTYPE  T1 WHERE T1.MC_TYPE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String findAllMCTypeQuery_0 = " select  q1.\"MC_TYPE\",  q1.\"MC_DESC\" from BH.MCTYPE q1";
	/**
	 * FindAllMCType
	 */
	public javax.resource.cci.Record FindAllMCType(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from MCType o */
			pstmt = prepareStatement(connection, findAllMCTypeQuery_0);

			result = executeQuery(connection, pstmt, findAllMCTypeQuery_0);
	...
	private static String findAllMCTypeForUpdateQuery_0 = " select  q1.\"MC_TYPE\",  q1.\"MC_DESC\" from BH.MCTYPE q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllMCType444Update
	 */
	public javax.resource.cci.Record FindAllMCType444Update(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from MCType o */
			pstmt = prepareStatement(connection, findAllMCTypeForUpdateQuery_0);

			result = executeQuery(connection, pstmt, findAllMCTypeForUpdateQuery_0);
	...
	private static String findAllMCTypeForUpdateWithRRQuery_0 = " select  q1.\"MC_TYPE\",  q1.\"MC_DESC\" from BH.MCTYPE q1 FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllMCTypeForUpdateWithRR
	 */
	public javax.resource.cci.Record FindAllMCTypeForUpdateWithRR(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from MCType o */
			pstmt = prepareStatement(connection, findAllMCTypeForUpdateWithRRQuery_0);

			result = executeQuery(connection, pstmt, findAllMCTypeForUpdateWithRRQuery_0);
	...
	private static String findAllMCTypeForUpdateWithRSQuery_0 = " select  q1.\"MC_TYPE\",  q1.\"MC_DESC\" from BH.MCTYPE q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllMCTypeForUpdateWithRS
	 */
	public javax.resource.cci.Record FindAllMCTypeForUpdateWithRS(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from MCType o */
			pstmt = prepareStatement(connection, findAllMCTypeForUpdateWithRSQuery_0);

			result = executeQuery(connection, pstmt, findAllMCTypeForUpdateWithRSQuery_0);
	 ...
	 * MCTypeBeanFunctionSet_b8a50e19
	 */
	public MCTypeBeanFunctionSet_b8a50e19() {
		...
		functionHash.put("FindAllMCType",new Integer(8));
		functionHash.put("FindAllMCType444Update",new Integer(9));
		functionHash.put("FindAllMCTypeForUpdateWithRR",new Integer(10));
		functionHash.put("FindAllMCTypeForUpdateWithRS",new Integer(11));
	...
	public Record execute(WSInteractionSpec interactionSpec, IndexedRecord inputRecord, Object connection) throws javax.resource.ResourceException {
		...
		case 7:
			...
			break;
		case 8:
			outputRecord=FindAllMCType(inputRecord,connection,interactionSpec);
			break;
		case 9:
			outputRecord=FindAllMCType444Update(inputRecord,connection,interactionSpec);
			break;
		case 10:
			outputRecord=FindAllMCTypeForUpdateWithRR(inputRecord,connection,interactionSpec);
			break;
		case 11:
			outputRecord=FindAllMCTypeForUpdateWithRS(inputRecord,connection,interactionSpec);
			break;
		case 12:
	...
	private static String ReadReadQuery_0 = " SELECT 1 FROM BH.MCTYPE  T1 WHERE T1.MC_TYPE = ?";
	/**
	 * ReadReadChecking
	 */
	...
	private static String ReadReadForUpdateQuery_0 = " SELECT 1 FROM BH.MCTYPE  T1 WHERE T1.MC_TYPE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private void initializeUpdateTemplates() throws javax.resource.ResourceException {
		updateTemplateList = MCTypeBeanPartialUpdateQueryHelper.getUpdateTemplates();
	}
