 ...
 */
public abstract class VarianceSWOBean implements javax.ejb.EntityBean {
	 ...
	 * ejbCreate
	 */
	public com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.VarianceSWOKey ejbCreate(
		int swoId,
		int dmId,
		int customerId,
