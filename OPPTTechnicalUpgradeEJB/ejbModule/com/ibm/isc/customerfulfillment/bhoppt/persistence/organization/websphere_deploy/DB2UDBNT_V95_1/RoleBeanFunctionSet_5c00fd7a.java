...
/**
 * RoleBeanFunctionSet_5c00fd7a
 */
public class RoleBeanFunctionSet_5c00fd7a extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	private java.util.HashMap functionHash;
	private static String CreateQuery_0 = "INSERT INTO BH.ROLE (ROLE, ROLE_DESC, ACTIVE) VALUES (?, ?, ?)";
	/**
	 * Create
	 */
	...
	private static String RemoveQuery_0 = "DELETE FROM BH.ROLE  WHERE ROLE = ?";
	/**
	 * Remove
	 */
	...
	private static String StoreQuery_0 = "UPDATE BH.ROLE  SET ROLE_DESC = ?, ACTIVE = ? WHERE ROLE = ?";
	/**
	 * Store
	 */
	...
	private static String StoreOCCQuery_0 = "UPDATE BH.ROLE  SET ROLE_DESC = ?, ACTIVE = ? WHERE ROLE = ?";
	/**
	 * StoreUsingOCC
	 */
	...
	private static String findAllRolesQuery_0 = " select  q1.\"ROLE\",  q1.\"ROLE_DESC\",  q1.\"ACTIVE\" from BH.ROLE q1";
	/**
	 * FindAllRoles
	 */
	public javax.resource.cci.Record FindAllRoles(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from Role o */
			pstmt = prepareStatement(connection, findAllRolesQuery_0);

			result = executeQuery(connection, pstmt, findAllRolesQuery_0);
	...
	private static String findAllRolesForUpdateQuery_0 = " select  q1.\"ROLE\",  q1.\"ROLE_DESC\",  q1.\"ACTIVE\" from BH.ROLE q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllRoles444Update
	 */
	public javax.resource.cci.Record FindAllRoles444Update(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from Role o */
			pstmt = prepareStatement(connection, findAllRolesForUpdateQuery_0);

			result = executeQuery(connection, pstmt, findAllRolesForUpdateQuery_0);
	...
	private static String findAllRolesForUpdateWithRRQuery_0 = " select  q1.\"ROLE\",  q1.\"ROLE_DESC\",  q1.\"ACTIVE\" from BH.ROLE q1 FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllRolesForUpdateWithRR
	 */
	public javax.resource.cci.Record FindAllRolesForUpdateWithRR(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from Role o */
			pstmt = prepareStatement(connection, findAllRolesForUpdateWithRRQuery_0);

			result = executeQuery(connection, pstmt, findAllRolesForUpdateWithRRQuery_0);
	...
	private static String findAllRolesForUpdateWithRSQuery_0 = " select  q1.\"ROLE\",  q1.\"ROLE_DESC\",  q1.\"ACTIVE\" from BH.ROLE q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllRolesForUpdateWithRS
	 */
	public javax.resource.cci.Record FindAllRolesForUpdateWithRS(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from Role o */
			pstmt = prepareStatement(connection, findAllRolesForUpdateWithRSQuery_0);

			result = executeQuery(connection, pstmt, findAllRolesForUpdateWithRSQuery_0);
	...
	private static String FindByPrimaryKeyQuery_0 = " SELECT T1.ROLE, T1.ROLE_DESC, T1.ACTIVE FROM BH.ROLE  T1 WHERE T1.ROLE = ?";
	/**
	 * FindByPrimaryKey
	 */
	...
	private static String FindByPrimaryKeyForUpdateQuery_0 = " SELECT T1.ROLE, T1.ROLE_DESC, T1.ACTIVE FROM BH.ROLE  T1 WHERE T1.ROLE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRRQuery_0 = " SELECT T1.ROLE, T1.ROLE_DESC, T1.ACTIVE FROM BH.ROLE  T1 WHERE T1.ROLE = ? FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRSQuery_0 = " SELECT T1.ROLE, T1.ROLE_DESC, T1.ACTIVE FROM BH.ROLE  T1 WHERE T1.ROLE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 ...
	 * RoleBeanFunctionSet_5c00fd7a
	 */
	public RoleBeanFunctionSet_5c00fd7a() {
		...
		functionHash.put("FindAllRoles",new Integer(4));
		functionHash.put("FindAllRoles444Update",new Integer(5));
		functionHash.put("FindAllRolesForUpdateWithRR",new Integer(6));
		functionHash.put("FindAllRolesForUpdateWithRS",new Integer(7));
	...
	public Record execute(WSInteractionSpec interactionSpec, IndexedRecord inputRecord, Object connection) throws javax.resource.ResourceException {
		...
		case 3:
			...
			break;
		case 4:
			outputRecord=FindAllRoles(inputRecord,connection,interactionSpec);
			break;
		case 5:
			outputRecord=FindAllRoles444Update(inputRecord,connection,interactionSpec);
			break;
		case 6:
			outputRecord=FindAllRolesForUpdateWithRR(inputRecord,connection,interactionSpec);
			break;
		case 7:
			outputRecord=FindAllRolesForUpdateWithRS(inputRecord,connection,interactionSpec);
			break;
		case 8:
	...
	private static String ReadReadQuery_0 = " SELECT 1 FROM BH.ROLE  T1 WHERE T1.ROLE = ?";
	/**
	 * ReadReadChecking
	 */
	...
	private static String ReadReadForUpdateQuery_0 = " SELECT 1 FROM BH.ROLE  T1 WHERE T1.ROLE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private void initializeUpdateTemplates() throws javax.resource.ResourceException {
		updateTemplateList = RoleBeanPartialUpdateQueryHelper.getUpdateTemplates();
	}
