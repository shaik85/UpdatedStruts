...
/**
 * Key class for Entity Bean: VarianceEE
 */
public class VarianceEEKey implements java.io.Serializable {
	...
	/**
	 * Creates an empty key for Entity Bean: VarianceEE
	 */
	public VarianceEEKey() {
	}
	/**
	 * Creates a key for Entity Bean: VarianceEE
	 */
	public VarianceEEKey(
		int eeId,
		int swoId,
	...
	public boolean equals(java.lang.Object otherKey) {
		if (otherKey
			instanceof com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.VarianceEEKey) {
			com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.VarianceEEKey o =
				(com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.VarianceEEKey) otherKey;
			return (
				(this.eeId == o.eeId)
					&& (this.swoId == o.swoId)
					&& (this.dmId == o.dmId)
