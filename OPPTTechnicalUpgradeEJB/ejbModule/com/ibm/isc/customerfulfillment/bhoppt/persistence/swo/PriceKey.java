...
/**
 * Key class for Entity Bean: Price
 */
public class PriceKey implements java.io.Serializable {
	...
	/**
	 * Creates an empty key for Entity Bean: Price
	 */
	public PriceKey() {
	}
	/**
	 * Creates a key for Entity Bean: Price
	 */
	public PriceKey(
		int priceId,
		int eeId,
	...
	public boolean equals(java.lang.Object otherKey) {
		if (otherKey
			instanceof com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.PriceKey) {
			com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.PriceKey o =
				(com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.PriceKey) otherKey;
			return (
