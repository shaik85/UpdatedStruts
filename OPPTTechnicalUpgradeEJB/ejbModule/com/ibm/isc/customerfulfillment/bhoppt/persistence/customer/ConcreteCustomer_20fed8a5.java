...
import com.ibm.isc.customerfulfillment.bhoppt.persistence.customer.websphere_deploy.CustomerBeanCacheEntry_20fed8a5;

/**
 * Bean implementation class for Enterprise Bean: Customer
 */
public class ConcreteCustomer_20fed8a5 extends com.ibm.isc.customerfulfillment.bhoppt.persistence.customer.CustomerBean implements javax.ejb.EntityBean, ConcreteBean {
	...
	private CustomerBeanCacheEntry_20fed8a5 dataCacheEntry;
	/**
	...
	/**
	 * ConcreteCustomer_20fed8a5
	 */
	public ConcreteCustomer_20fed8a5() {
		super();
	 ...
	 * getInjector
	 */
	private com.ibm.isc.customerfulfillment.bhoppt.persistence.customer.websphere_deploy.CustomerBeanInjector_20fed8a5 getInjector() {
		return (com.ibm.isc.customerfulfillment.bhoppt.persistence.customer.websphere_deploy.CustomerBeanInjector_20fed8a5)instanceExtension.getInjector();
	}
	/**
	 * hydrate
	 */
	public void hydrate(Object inRecord) {
		dataCacheEntry = (com.ibm.isc.customerfulfillment.bhoppt.persistence.customer.websphere_deploy.CustomerBeanCacheEntry_20fed8a5) inRecord;
		super.ejbLoad();
	}
	/**
	 * resetCMP
	 ...
	 * ejbFindByPrimaryKey
	 */
	public com.ibm.isc.customerfulfillment.bhoppt.persistence.customer.CustomerKey ejbFindByPrimaryKey(com.ibm.isc.customerfulfillment.bhoppt.persistence.customer.CustomerKey primaryKey) throws javax.ejb.FinderException {
		return (com.ibm.isc.customerfulfillment.bhoppt.persistence.customer.CustomerKey)instanceExtension.ejbFindByPrimaryKey(primaryKey);
	}
	/**
	 * ejbFindBySapCustNo_Local
	 */
	public com.ibm.isc.customerfulfillment.bhoppt.persistence.customer.CustomerKey ejbFindBySapCustNo_Local(int proposalId, java.lang.String sapCustomerNo) throws javax.ejb.FinderException {
		javax.resource.cci.IndexedRecord record = instanceExtension.getInputRecord("FindBySapCustNo");
		getInjector().ejbFindBySapCustNo(proposalId, sapCustomerNo, record);
		return (com.ibm.isc.customerfulfillment.bhoppt.persistence.customer.CustomerKey) instanceExtension.executeFind("FindBySapCustNo", record);
	}
	/**
	 * ejbFindBySapCustNoAndPlanStartEndDate_Local
	 */
	public com.ibm.isc.customerfulfillment.bhoppt.persistence.customer.CustomerKey ejbFindBySapCustNoAndPlanStartEndDate_Local(int proposalId, java.lang.String sapCustomerNo, java.sql.Date planStartDate, java.sql.Date planEndDate) throws javax.ejb.FinderException {
		javax.resource.cci.IndexedRecord record = instanceExtension.getInputRecord("FindBySapCustNoAndPlanStartEndDate");
		getInjector().ejbFindBySapCustNoAndPlanStartEndDate(proposalId, sapCustomerNo, planStartDate, planEndDate, record);
		return (com.ibm.isc.customerfulfillment.bhoppt.persistence.customer.CustomerKey) instanceExtension.executeFind("FindBySapCustNoAndPlanStartEndDate", record);
	}
	/**
	...
	/**
	 * ejbFindByProposalAndCustomerList_Local
	 */
	public java.util.Collection ejbFindByProposalAndCustomerList_Local(int proposalId, java.lang.String customerListNo) throws javax.ejb.FinderException {
		javax.resource.cci.IndexedRecord record = instanceExtension.getInputRecord("FindByProposalAndCustomerList");
		getInjector().ejbFindByProposalAndCustomerList(proposalId, customerListNo, record);
		return (java.util.Collection) instanceExtension.executeFind("FindByProposalAndCustomerList", record);
	}
	/**
	 * ejbFindByProposalStartEndDate_Local
	 */
	public java.util.Collection ejbFindByProposalStartEndDate_Local(int proposalId, java.sql.Date planStartDate, java.sql.Date planEndDate) throws javax.ejb.FinderException {
		javax.resource.cci.IndexedRecord record = instanceExtension.getInputRecord("FindByProposalStartEndDate");
		getInjector().ejbFindByProposalStartEndDate(proposalId, planStartDate, planEndDate, record);
		return (java.util.Collection) instanceExtension.executeFind("FindByProposalStartEndDate", record);
	}
	/**
	...
	public Object ejbFindByPrimaryKey(java.lang.Object pk) throws javax.ejb.FinderException {
		return ejbFindByPrimaryKey((com.ibm.isc.customerfulfillment.bhoppt.persistence.customer.CustomerKey)pk);
	}
	/**
	 * ejbFindByPrimaryKeyForCMR_Local
	 */
	public com.ibm.isc.customerfulfillment.bhoppt.persistence.customer.CustomerKey ejbFindByPrimaryKeyForCMR_Local(com.ibm.isc.customerfulfillment.bhoppt.persistence.customer.CustomerKey pk) throws javax.ejb.FinderException {
		return (com.ibm.isc.customerfulfillment.bhoppt.persistence.customer.CustomerKey)instanceExtension.ejbFindByPrimaryKey(pk);
	}
	/**
	 * ejbCreate
	 */
	public com.ibm.isc.customerfulfillment.bhoppt.persistence.customer.CustomerKey ejbCreate(int proposalId, int customerId, java.lang.String sapCustomerNo, java.sql.Date planStartDate, java.sql.Date planEndDate) throws javax.ejb.CreateException {
		dataCacheEntry = (CustomerBeanCacheEntry_20fed8a5) instanceExtension.createDataCacheEntry();
		 super.ejbCreate(proposalId, customerId, sapCustomerNo, planStartDate, planEndDate);
		return (com.ibm.isc.customerfulfillment.bhoppt.persistence.customer.CustomerKey)instanceExtension.ejbCreate();
	}
	/**
	 * ejbPostCreate
	 */
	public void ejbPostCreate(int proposalId, int customerId, java.lang.String sapCustomerNo, java.sql.Date planStartDate, java.sql.Date planEndDate) throws javax.ejb.CreateException {
		super.ejbPostCreate(proposalId, customerId, sapCustomerNo, planStartDate, planEndDate);
	...
	public Object createPrimaryKey() {
		com.ibm.isc.customerfulfillment.bhoppt.persistence.customer.CustomerKey pk = new com.ibm.isc.customerfulfillment.bhoppt.persistence.customer.CustomerKey();
	...
	public void setBillToPartyNo(java.lang.String newBillToPartyNo) {
		if (instanceExtension.needValuesOnMarkDirty())
			instanceExtension.markDirty(5,getBillToPartyNo(),newBillToPartyNo);
		else
	...
	public void setBillToPartyName(java.lang.String newBillToPartyName) {
		if (instanceExtension.needValuesOnMarkDirty())
			instanceExtension.markDirty(6,getBillToPartyName(),newBillToPartyName);
		else
	...
	public void setPayerNo(java.lang.String newPayerNo) {
		if (instanceExtension.needValuesOnMarkDirty())
			instanceExtension.markDirty(7,getPayerNo(),newPayerNo);
		else
	...
	public void setPayerName(java.lang.String newPayerName) {
		if (instanceExtension.needValuesOnMarkDirty())
			instanceExtension.markDirty(8,getPayerName(),newPayerName);
		else
	...
	public void setShipToPartyName(java.lang.String newShipToPartyName) {
		if (instanceExtension.needValuesOnMarkDirty())
			instanceExtension.markDirty(9,getShipToPartyName(),newShipToPartyName);
		else
	...
	public void setPlanStartDate(java.sql.Date newPlanStartDate) {
		if (instanceExtension.needValuesOnMarkDirty())
			instanceExtension.markDirty(11,getPlanStartDate(),newPlanStartDate);
		else
	...
	public void setPlanEndDate(java.sql.Date newPlanEndDate) {
		if (instanceExtension.needValuesOnMarkDirty())
			instanceExtension.markDirty(12,getPlanEndDate(),newPlanEndDate);
		else
	...
	public void setLastUpdatedDate(java.sql.Date newLastUpdatedDate) {
		if (instanceExtension.needValuesOnMarkDirty())
			instanceExtension.markDirty(13,getLastUpdatedDate(),newLastUpdatedDate);
		else
	...
	public void setPayerLNo(java.lang.String newPayerLNo) {
		if (instanceExtension.needValuesOnMarkDirty())
			instanceExtension.markDirty(14,getPayerLNo(),newPayerLNo);
		else
	...
	public void setBillToPartyLNo(java.lang.String newBillToPartyLNo) {
		if (instanceExtension.needValuesOnMarkDirty())
			instanceExtension.markDirty(15,getBillToPartyLNo(),newBillToPartyLNo);
		else
	...
	public void setShipToPartyLNo(java.lang.String newShipToPartyLNo) {
		if (instanceExtension.needValuesOnMarkDirty())
			instanceExtension.markDirty(16,getShipToPartyLNo(),newShipToPartyLNo);
		else
	...
	public void setCustomerASNo(java.lang.String newCustomerASNo) {
		if (instanceExtension.needValuesOnMarkDirty())
			instanceExtension.markDirty(17,getCustomerASNo(),newCustomerASNo);
		else
	...
	public void setBillToPartyASNo(java.lang.String newBillToPartyASNo) {
		if (instanceExtension.needValuesOnMarkDirty())
			instanceExtension.markDirty(18,getBillToPartyASNo(),newBillToPartyASNo);
		else
	...
	public void setShipToPartyASNo(java.lang.String newShipToPartyASNo) {
		if (instanceExtension.needValuesOnMarkDirty())
			instanceExtension.markDirty(19,getShipToPartyASNo(),newShipToPartyASNo);
		else
	...
	public void setPayerASNo(java.lang.String newPayerASNo) {
		if (instanceExtension.needValuesOnMarkDirty())
			instanceExtension.markDirty(20,getPayerASNo(),newPayerASNo);
		else
	...
	public void setSapCustomerName(java.lang.String newSapCustomerName) {
		if (instanceExtension.needValuesOnMarkDirty())
			instanceExtension.markDirty(21,getSapCustomerName(),newSapCustomerName);
		else
	...
	public java.lang.String getCountryCode() {
		return dataCacheEntry.getCountryCode();
	}
	/**
	...
	public void setCountryCode(java.lang.String newCountryCode) {
		if (instanceExtension.needValuesOnMarkDirty())
			instanceExtension.markDirty(22,getCountryCode(),newCountryCode);
		else
			instanceExtension.markDirty(22);
		dataCacheEntry.setCountryCode(newCountryCode);
	}
}
