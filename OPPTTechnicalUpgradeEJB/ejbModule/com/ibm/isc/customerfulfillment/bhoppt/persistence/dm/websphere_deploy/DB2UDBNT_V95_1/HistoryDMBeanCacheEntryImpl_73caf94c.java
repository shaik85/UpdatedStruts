...
/**
 * HistoryDMBeanCacheEntryImpl_73caf94c
 */
public class HistoryDMBeanCacheEntryImpl_73caf94c extends com.ibm.ws.ejbpersistence.cache.DataCacheEntry implements com.ibm.isc.customerfulfillment.bhoppt.persistence.dm.websphere_deploy.HistoryDMBeanCacheEntry_73caf94c {
	...
	public java.lang.String getDmNo() {
		return DESG_MACHINE_NO_Data;
	}
	/**
	 * setDmNo
	 */
	public void setDmNo(String data) {
		this.DESG_MACHINE_NO_Data=data;
	}
	/**
	 * setDataForDESG_MACHINE_NO
	 */
	public void setDataForDESG_MACHINE_NO(String data) {
		this.DESG_MACHINE_NO_Data=data;
	}
	private String DESG_MACHINE_NO_Data;
	/**
	 * getDmId
	 */
	public int getDmId() {
	...
	public java.lang.String getDmDesc() {
		return DESG_MACHINE_DESC_Data;
	}
	/**
	 * setDmDesc
	 */
	public void setDmDesc(String data) {
		this.DESG_MACHINE_DESC_Data=data;
	}
	/**
	 * setDataForDESG_MACHINE_DESC
	 */
	public void setDataForDESG_MACHINE_DESC(String data) {
		this.DESG_MACHINE_DESC_Data=data;
	}
	private String DESG_MACHINE_DESC_Data;
	/**
	 * getPlanStartDate
	 */
	...
	public java.sql.Date getDmAddedDate() {
		return DM_ADDED_DATE_Data;
	}
	/**
	 * setDmAddedDate
	 */
	public void setDmAddedDate(java.sql.Date data) {
		if (data == null)
			this.DM_ADDED_DATE_Data= null;
		else {
			this.DM_ADDED_DATE_Data=data; }
	}
	/**
	 * setDataForDM_ADDED_DATE
	 */
	public void setDataForDM_ADDED_DATE(java.sql.Date data) {
		this.DM_ADDED_DATE_Data=data;
	}
	private java.sql.Date DM_ADDED_DATE_Data;
	/**
	 * getExclusionId
	 */
