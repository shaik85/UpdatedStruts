...
/**
 * BPCustListBeanFunctionSet_0f59666b
 */
public class BPCustListBeanFunctionSet_0f59666b extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	private java.util.HashMap functionHash;
	private static String CreateQuery_0 = "INSERT INTO BH.BPCUSTLIST (USER_ID, CUST_LIST_NUMBER, CUST_LIST_NAME) VALUES (?, ?, ?)";
	/**
	 * Create
	 */
	...
	private static String RemoveQuery_0 = "DELETE FROM BH.BPCUSTLIST  WHERE USER_ID = ? AND CUST_LIST_NUMBER = ?";
	/**
	 * Remove
	 */
	...
	private static String StoreQuery_0 = "UPDATE BH.BPCUSTLIST  SET CUST_LIST_NAME = ? WHERE USER_ID = ? AND CUST_LIST_NUMBER = ?";
	/**
	 * Store
	 */
	...
	private static String StoreOCCQuery_0 = "UPDATE BH.BPCUSTLIST  SET CUST_LIST_NAME = ? WHERE USER_ID = ? AND CUST_LIST_NUMBER = ?";
	/**
	 * StoreUsingOCC
	 */
	...
	private static String findByUserQuery_0 = " select  q1.\"USER_ID\",  q1.\"CUST_LIST_NUMBER\",  q1.\"CUST_LIST_NAME\" from BH.BPCUSTLIST q1 where  ( q1.\"USER_ID\" = ?) ";
	/**
	 * FindByUser
	 */
	public javax.resource.cci.Record FindByUser(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		...
		try {
			/* select object(o) from BPCustList o where  o.userId = ?1 */
	...
	private static String findByUserForUpdateQuery_0 = " select  q1.\"USER_ID\",  q1.\"CUST_LIST_NUMBER\",  q1.\"CUST_LIST_NAME\" from BH.BPCUSTLIST q1 where  ( q1.\"USER_ID\" = ?)  FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindByUser444Update
	 */
	...
	private static String findByUserForUpdateWithRRQuery_0 = " select  q1.\"USER_ID\",  q1.\"CUST_LIST_NUMBER\",  q1.\"CUST_LIST_NAME\" from BH.BPCUSTLIST q1 where  ( q1.\"USER_ID\" = ?)  FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String findByUserForUpdateWithRSQuery_0 = " select  q1.\"USER_ID\",  q1.\"CUST_LIST_NUMBER\",  q1.\"CUST_LIST_NAME\" from BH.BPCUSTLIST q1 where  ( q1.\"USER_ID\" = ?)  FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyQuery_0 = " SELECT T1.USER_ID, T1.CUST_LIST_NUMBER, T1.CUST_LIST_NAME FROM BH.BPCUSTLIST  T1 WHERE T1.USER_ID = ? AND T1.CUST_LIST_NUMBER = ?";
	/**
	 * FindByPrimaryKey
	 */
	...
	private static String FindByPrimaryKeyForUpdateQuery_0 = " SELECT T1.USER_ID, T1.CUST_LIST_NUMBER, T1.CUST_LIST_NAME FROM BH.BPCUSTLIST  T1 WHERE T1.USER_ID = ? AND T1.CUST_LIST_NUMBER = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRRQuery_0 = " SELECT T1.USER_ID, T1.CUST_LIST_NUMBER, T1.CUST_LIST_NAME FROM BH.BPCUSTLIST  T1 WHERE T1.USER_ID = ? AND T1.CUST_LIST_NUMBER = ? FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRSQuery_0 = " SELECT T1.USER_ID, T1.CUST_LIST_NUMBER, T1.CUST_LIST_NAME FROM BH.BPCUSTLIST  T1 WHERE T1.USER_ID = ? AND T1.CUST_LIST_NUMBER = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 ...
	 * BPCustListBeanFunctionSet_0f59666b
	 */
	public BPCustListBeanFunctionSet_0f59666b() {
		...
		functionHash.put("FindByUser",new Integer(4));
		functionHash.put("FindByUser444Update",new Integer(5));
		functionHash.put("FindByUserForUpdateWithRR",new Integer(6));
		functionHash.put("FindByUserForUpdateWithRS",new Integer(7));
	...
	private static String ReadReadQuery_0 = " SELECT 1 FROM BH.BPCUSTLIST  T1 WHERE T1.USER_ID = ? AND T1.CUST_LIST_NUMBER = ?";
	/**
	 * ReadReadChecking
	 */
	...
	private static String ReadReadForUpdateQuery_0 = " SELECT 1 FROM BH.BPCUSTLIST  T1 WHERE T1.USER_ID = ? AND T1.CUST_LIST_NUMBER = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private void initializeUpdateTemplates() throws javax.resource.ResourceException {
		updateTemplateList = BPCustListBeanPartialUpdateQueryHelper.getUpdateTemplates();
	}
