...
/**
 * Key class for Entity Bean: VariancePrice
 */
public class VariancePriceKey implements java.io.Serializable {
	static final long serialVersionUID = 3206093459760846163L;
	/**
	 * Implementation field for persistent attribute: priceId
	 */
	public int priceId;
	/**
	...
	/**
	 * Creates an empty key for Entity Bean: VariancePrice
	 */
	public VariancePriceKey() {
	}
	/**
	 * Creates a key for Entity Bean: VariancePrice
	 */
	public VariancePriceKey(
		int priceId,
		int eeId,
	...
	public boolean equals(java.lang.Object otherKey) {
		if (otherKey
			instanceof com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.VariancePriceKey) {
			com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.VariancePriceKey o =
				(com.ibm.isc.customerfulfillment.bhoppt.persistence.swo
					.VariancePriceKey) otherKey;
			return (
				(this.priceId == o.priceId)
					&& (this.eeId == o.eeId)
					&& (this.swoId == o.swoId)
					&& (this.dmId == o.dmId)
	...
	public int hashCode() {
		return (
			(new java.lang.Integer(priceId).hashCode())
