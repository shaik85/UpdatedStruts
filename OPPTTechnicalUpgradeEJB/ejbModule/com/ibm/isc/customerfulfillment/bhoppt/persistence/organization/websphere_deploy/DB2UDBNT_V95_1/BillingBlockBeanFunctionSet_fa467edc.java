...
/**
 * BillingBlockBeanFunctionSet_fa467edc
 */
public class BillingBlockBeanFunctionSet_fa467edc extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	private java.util.HashMap functionHash;
	private static String CreateQuery_0 = "INSERT INTO BH.BILLINGBLOCK (BILLING_BLOCK, BILLING_BLOCK_DESC) VALUES (?, ?)";
	/**
	 * Create
	 */
	...
	private static String RemoveQuery_0 = "DELETE FROM BH.BILLINGBLOCK  WHERE BILLING_BLOCK = ?";
	/**
	 * Remove
	 */
	...
	private static String StoreQuery_0 = "UPDATE BH.BILLINGBLOCK  SET BILLING_BLOCK_DESC = ? WHERE BILLING_BLOCK = ?";
	/**
	 * Store
	 */
	...
	private static String StoreOCCQuery_0 = "UPDATE BH.BILLINGBLOCK  SET BILLING_BLOCK_DESC = ? WHERE BILLING_BLOCK = ?";
	/**
	 * StoreUsingOCC
	 */
	...
	private static String FindByPrimaryKeyQuery_0 = " SELECT T1.BILLING_BLOCK, T1.BILLING_BLOCK_DESC FROM BH.BILLINGBLOCK  T1 WHERE T1.BILLING_BLOCK = ?";
	/**
	 * FindByPrimaryKey
	 */
	...
	private static String FindByPrimaryKeyForUpdateQuery_0 = " SELECT T1.BILLING_BLOCK, T1.BILLING_BLOCK_DESC FROM BH.BILLINGBLOCK  T1 WHERE T1.BILLING_BLOCK = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRRQuery_0 = " SELECT T1.BILLING_BLOCK, T1.BILLING_BLOCK_DESC FROM BH.BILLINGBLOCK  T1 WHERE T1.BILLING_BLOCK = ? FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRSQuery_0 = " SELECT T1.BILLING_BLOCK, T1.BILLING_BLOCK_DESC FROM BH.BILLINGBLOCK  T1 WHERE T1.BILLING_BLOCK = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String findAllBillingBlockQuery_0 = " select  q1.\"BILLING_BLOCK\",  q1.\"BILLING_BLOCK_DESC\" from BH.BILLINGBLOCK q1";
	/**
	 * FindAllBillingBlock
	 */
	public javax.resource.cci.Record FindAllBillingBlock(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from BillingBlock o */
			pstmt = prepareStatement(connection, findAllBillingBlockQuery_0);

			result = executeQuery(connection, pstmt, findAllBillingBlockQuery_0);
	...
	private static String findAllBillingBlockForUpdateQuery_0 = " select  q1.\"BILLING_BLOCK\",  q1.\"BILLING_BLOCK_DESC\" from BH.BILLINGBLOCK q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllBillingBlock444Update
	 */
	public javax.resource.cci.Record FindAllBillingBlock444Update(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from BillingBlock o */
			pstmt = prepareStatement(connection, findAllBillingBlockForUpdateQuery_0);

			result = executeQuery(connection, pstmt, findAllBillingBlockForUpdateQuery_0);
	...
	private static String findAllBillingBlockForUpdateWithRRQuery_0 = " select  q1.\"BILLING_BLOCK\",  q1.\"BILLING_BLOCK_DESC\" from BH.BILLINGBLOCK q1 FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllBillingBlockForUpdateWithRR
	 */
	public javax.resource.cci.Record FindAllBillingBlockForUpdateWithRR(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from BillingBlock o */
			pstmt = prepareStatement(connection, findAllBillingBlockForUpdateWithRRQuery_0);

			result = executeQuery(connection, pstmt, findAllBillingBlockForUpdateWithRRQuery_0);
	...
	private static String findAllBillingBlockForUpdateWithRSQuery_0 = " select  q1.\"BILLING_BLOCK\",  q1.\"BILLING_BLOCK_DESC\" from BH.BILLINGBLOCK q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllBillingBlockForUpdateWithRS
	 */
	public javax.resource.cci.Record FindAllBillingBlockForUpdateWithRS(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from BillingBlock o */
			pstmt = prepareStatement(connection, findAllBillingBlockForUpdateWithRSQuery_0);

			result = executeQuery(connection, pstmt, findAllBillingBlockForUpdateWithRSQuery_0);
	 ...
	 * BillingBlockBeanFunctionSet_fa467edc
	 */
	public BillingBlockBeanFunctionSet_fa467edc() {
		...
		functionHash.put("FindAllBillingBlock",new Integer(8));
		functionHash.put("FindAllBillingBlock444Update",new Integer(9));
		functionHash.put("FindAllBillingBlockForUpdateWithRR",new Integer(10));
		functionHash.put("FindAllBillingBlockForUpdateWithRS",new Integer(11));
	...
	public Record execute(WSInteractionSpec interactionSpec, IndexedRecord inputRecord, Object connection) throws javax.resource.ResourceException {
		...
		case 7:
			...
			break;
		case 8:
			outputRecord=FindAllBillingBlock(inputRecord,connection,interactionSpec);
			break;
		case 9:
			outputRecord=FindAllBillingBlock444Update(inputRecord,connection,interactionSpec);
			break;
		case 10:
			outputRecord=FindAllBillingBlockForUpdateWithRR(inputRecord,connection,interactionSpec);
			break;
		case 11:
			outputRecord=FindAllBillingBlockForUpdateWithRS(inputRecord,connection,interactionSpec);
			break;
		case 12:
	...
	private static String ReadReadQuery_0 = " SELECT 1 FROM BH.BILLINGBLOCK  T1 WHERE T1.BILLING_BLOCK = ?";
	/**
	 * ReadReadChecking
	 */
	...
	private static String ReadReadForUpdateQuery_0 = " SELECT 1 FROM BH.BILLINGBLOCK  T1 WHERE T1.BILLING_BLOCK = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private void initializeUpdateTemplates() throws javax.resource.ResourceException {
		updateTemplateList = BillingBlockBeanPartialUpdateQueryHelper.getUpdateTemplates();
	}
