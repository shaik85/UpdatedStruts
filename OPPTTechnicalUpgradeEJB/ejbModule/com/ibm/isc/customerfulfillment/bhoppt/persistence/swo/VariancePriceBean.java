 ...
 */
public abstract class VariancePriceBean implements javax.ejb.EntityBean {
	 ...
	 * ejbCreate
	 */
	public com.ibm.isc.customerfulfillment.bhoppt.persistence.swo.VariancePriceKey ejbCreate(
		int priceId,
		int eeId,
		int swoId,
		int dmId,
	 ...
	 */
	public abstract java.lang.String getIndicator();
	/**
	 * Set accessor for persistent attribute: indicator
	 */
	public abstract void setIndicator(java.lang.String newIndicator);
}
