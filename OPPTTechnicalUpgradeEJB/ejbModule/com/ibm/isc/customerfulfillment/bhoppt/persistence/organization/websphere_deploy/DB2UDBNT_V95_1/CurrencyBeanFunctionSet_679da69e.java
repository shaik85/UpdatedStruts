...
/**
 * CurrencyBeanFunctionSet_679da69e
 */
public class CurrencyBeanFunctionSet_679da69e extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	private java.util.HashMap functionHash;
	private static String CreateQuery_0 = "INSERT INTO BH.CURRENCY (CURRENCY_CODE, CURRENCY_NAME, DECIMAL_ALLOWED) VALUES (?, ?, ?)";
	/**
	 * Create
	 */
	...
	private static String RemoveQuery_0 = "DELETE FROM BH.CURRENCY  WHERE CURRENCY_CODE = ?";
	/**
	 * Remove
	 */
	...
	private static String StoreQuery_0 = "UPDATE BH.CURRENCY  SET CURRENCY_NAME = ?, DECIMAL_ALLOWED = ? WHERE CURRENCY_CODE = ?";
	/**
	 * Store
	 */
	...
	private static String StoreOCCQuery_0 = "UPDATE BH.CURRENCY  SET CURRENCY_NAME = ?, DECIMAL_ALLOWED = ? WHERE CURRENCY_CODE = ?";
	/**
	 * StoreUsingOCC
	 */
	...
	private static String FindByPrimaryKeyQuery_0 = " SELECT T1.CURRENCY_CODE, T1.CURRENCY_NAME, T1.DECIMAL_ALLOWED FROM BH.CURRENCY  T1 WHERE T1.CURRENCY_CODE = ?";
	/**
	 * FindByPrimaryKey
	 */
	...
	private static String FindByPrimaryKeyForUpdateQuery_0 = " SELECT T1.CURRENCY_CODE, T1.CURRENCY_NAME, T1.DECIMAL_ALLOWED FROM BH.CURRENCY  T1 WHERE T1.CURRENCY_CODE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRRQuery_0 = " SELECT T1.CURRENCY_CODE, T1.CURRENCY_NAME, T1.DECIMAL_ALLOWED FROM BH.CURRENCY  T1 WHERE T1.CURRENCY_CODE = ? FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRSQuery_0 = " SELECT T1.CURRENCY_CODE, T1.CURRENCY_NAME, T1.DECIMAL_ALLOWED FROM BH.CURRENCY  T1 WHERE T1.CURRENCY_CODE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String findAllCurrencyQuery_0 = " select  q1.\"CURRENCY_CODE\",  q1.\"CURRENCY_NAME\",  q1.\"DECIMAL_ALLOWED\" from BH.CURRENCY q1";
	/**
	 * FindAllCurrency
	 */
	public javax.resource.cci.Record FindAllCurrency(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from Currency o */
			pstmt = prepareStatement(connection, findAllCurrencyQuery_0);

			result = executeQuery(connection, pstmt, findAllCurrencyQuery_0);
	...
	private static String findAllCurrencyForUpdateQuery_0 = " select  q1.\"CURRENCY_CODE\",  q1.\"CURRENCY_NAME\",  q1.\"DECIMAL_ALLOWED\" from BH.CURRENCY q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllCurrency444Update
	 */
	public javax.resource.cci.Record FindAllCurrency444Update(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from Currency o */
			pstmt = prepareStatement(connection, findAllCurrencyForUpdateQuery_0);

			result = executeQuery(connection, pstmt, findAllCurrencyForUpdateQuery_0);
	...
	private static String findAllCurrencyForUpdateWithRRQuery_0 = " select  q1.\"CURRENCY_CODE\",  q1.\"CURRENCY_NAME\",  q1.\"DECIMAL_ALLOWED\" from BH.CURRENCY q1 FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllCurrencyForUpdateWithRR
	 */
	public javax.resource.cci.Record FindAllCurrencyForUpdateWithRR(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from Currency o */
			pstmt = prepareStatement(connection, findAllCurrencyForUpdateWithRRQuery_0);

			result = executeQuery(connection, pstmt, findAllCurrencyForUpdateWithRRQuery_0);
	...
	private static String findAllCurrencyForUpdateWithRSQuery_0 = " select  q1.\"CURRENCY_CODE\",  q1.\"CURRENCY_NAME\",  q1.\"DECIMAL_ALLOWED\" from BH.CURRENCY q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllCurrencyForUpdateWithRS
	 */
	public javax.resource.cci.Record FindAllCurrencyForUpdateWithRS(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from Currency o */
			pstmt = prepareStatement(connection, findAllCurrencyForUpdateWithRSQuery_0);

			result = executeQuery(connection, pstmt, findAllCurrencyForUpdateWithRSQuery_0);
	 ...
	 * CurrencyBeanFunctionSet_679da69e
	 */
	public CurrencyBeanFunctionSet_679da69e() {
		...
		functionHash.put("FindAllCurrency",new Integer(8));
		functionHash.put("FindAllCurrency444Update",new Integer(9));
		functionHash.put("FindAllCurrencyForUpdateWithRR",new Integer(10));
		functionHash.put("FindAllCurrencyForUpdateWithRS",new Integer(11));
	...
	public Record execute(WSInteractionSpec interactionSpec, IndexedRecord inputRecord, Object connection) throws javax.resource.ResourceException {
		...
		case 7:
			...
			break;
		case 8:
			outputRecord=FindAllCurrency(inputRecord,connection,interactionSpec);
			break;
		case 9:
			outputRecord=FindAllCurrency444Update(inputRecord,connection,interactionSpec);
			break;
		case 10:
			outputRecord=FindAllCurrencyForUpdateWithRR(inputRecord,connection,interactionSpec);
			break;
		case 11:
			outputRecord=FindAllCurrencyForUpdateWithRS(inputRecord,connection,interactionSpec);
			break;
		case 12:
	...
	private static String ReadReadQuery_0 = " SELECT 1 FROM BH.CURRENCY  T1 WHERE T1.CURRENCY_CODE = ?";
	/**
	 * ReadReadChecking
	 */
	...
	private static String ReadReadForUpdateQuery_0 = " SELECT 1 FROM BH.CURRENCY  T1 WHERE T1.CURRENCY_CODE = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private void initializeUpdateTemplates() throws javax.resource.ResourceException {
		updateTemplateList = CurrencyBeanPartialUpdateQueryHelper.getUpdateTemplates();
	}
