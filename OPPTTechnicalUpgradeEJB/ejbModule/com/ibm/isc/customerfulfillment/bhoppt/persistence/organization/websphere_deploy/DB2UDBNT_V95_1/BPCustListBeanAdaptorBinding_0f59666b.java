...
/**
 * BPCustListBeanAdaptorBinding_0f59666b
 */
public class BPCustListBeanAdaptorBinding_0f59666b implements com.ibm.ws.ejbpersistence.beanextensions.EJBAdapterBinding {
	/**
	 * getExtractor
	 */
	public com.ibm.ws.ejbpersistence.dataaccess.EJBExtractor getExtractor() {
		// extractor for com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.BPCustListBeanExtractor_0f59666b
		com.ibm.ws.ejbpersistence.dataaccess.AbstractEJBExtractor extractor =  new com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.BPCustListBeanExtractor_0f59666b();
	...
	public com.ibm.ws.ejbpersistence.beanextensions.EJBInjector getInjector() {
		return new com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.BPCustListBeanInjectorImpl_0f59666b();
	}
	/**
	 * getAdapter
	 */
	...
	public Object[] getMetadata() {
		...
		//-------------------------------------Alias-------------------------------------
		cat[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogRDBAlias("BPCustList", "BPCustList1_Alias", "DB2NT", "BH.BPCUSTLIST", "BPCustList_BPCustList1_Table", 9, 5, 1);
		...
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("CUST_LIST_NUMBER", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 10, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, true, 0, -1, 0, false);
		fields[2] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("CUST_LIST_NAME", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 35, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		primarykey = new String[2];
		primarykey[0] = "USER_ID";
		primarykey[1] = "CUST_LIST_NUMBER";
		cat[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogType("BPCustList", "BPCustList1_Table", null, fields, primarykey);
		...
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("custListNo", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		fields[2] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("custListName", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		primarykey = new String[2];
		primarykey[0] = "userId";
		primarykey[1] = "custListNo";
		cat[2] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogType("BPCustList", "BPCustList_BO", "com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.BPCustListBean", fields, primarykey);
		...
		subhomes = null;
		cat[3] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogView("BPCustList", "BPCustList_BPCustList_BO", "BPCustList_BPCustList1_Alias", composedObjs, composedObjImpls, 
		"select t1.USER_ID,t1.CUST_LIST_NUMBER,t1.CUST_LIST_NAME from _this t1", 
		null, subhomes, 
		0, null);
	...
	public java.util.Collection createDataAccessSpecs() throws javax.resource.ResourceException {
		...
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.BPCustListBeanFunctionSet_0f59666b");
		...
		daSpec.setQueryScope(new String[]{"BPCustList"});
		result.add(daSpec);
	 ...
	 * BPCustListBeanAdaptorBinding_0f59666b
	 */
	public BPCustListBeanAdaptorBinding_0f59666b() {
