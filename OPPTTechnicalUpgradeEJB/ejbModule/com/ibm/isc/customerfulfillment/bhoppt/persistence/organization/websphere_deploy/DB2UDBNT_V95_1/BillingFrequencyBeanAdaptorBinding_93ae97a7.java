...
/**
 * BillingFrequencyBeanAdaptorBinding_93ae97a7
 */
public class BillingFrequencyBeanAdaptorBinding_93ae97a7 implements com.ibm.ws.ejbpersistence.beanextensions.EJBAdapterBinding {
	/**
	 * getExtractor
	 */
	public com.ibm.ws.ejbpersistence.dataaccess.EJBExtractor getExtractor() {
		// extractor for com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.BillingFrequencyBeanExtractor_93ae97a7
		com.ibm.ws.ejbpersistence.dataaccess.AbstractEJBExtractor extractor =  new com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.BillingFrequencyBeanExtractor_93ae97a7();
	...
	public com.ibm.ws.ejbpersistence.beanextensions.EJBInjector getInjector() {
		return new com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.BillingFrequencyBeanInjectorImpl_93ae97a7();
	}
	/**
	 * getAdapter
	 */
	...
	public Object[] getMetadata() {
		...
		//-------------------------------------Alias-------------------------------------
		cat[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogRDBAlias("BillingFrequency", "BillingFrequency1_Alias", "DB2NT", "BH.BILLINGFREQUENCY", "BillingFrequency_BillingFrequency1_Table", 9, 5, 1);


		//-----------------------------------Table Type-----------------------------------
		fields = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef[2];

		fields[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("BILLING_FREQ_CODE", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 1, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, true, 0, -1, 0, false);
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("BILLING_FREQ_DESC", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 40, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		primarykey = new String[1];
		primarykey[0] = "BILLING_FREQ_CODE";
		cat[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogType("BillingFrequency", "BillingFrequency1_Table", null, fields, primarykey);


		//-----------------------------------Bean Type-----------------------------------
		fields = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef[2];

		fields[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("billingFreqCode", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("billingFreqDescription", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		primarykey = new String[1];
		primarykey[0] = "billingFreqCode";
		cat[2] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogType("BillingFrequency", "BillingFrequency_BO", "com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.BillingFrequencyBean", fields, primarykey);
		...
		subhomes = null;
		cat[3] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogView("BillingFrequency", "BillingFrequency_BillingFrequency_BO", "BillingFrequency_BillingFrequency1_Alias", composedObjs, composedObjImpls, 
		"select t1.BILLING_FREQ_CODE,t1.BILLING_FREQ_DESC from _this t1", 
		null, subhomes, 
		0, null);
	...
	public java.util.Collection createDataAccessSpecs() throws javax.resource.ResourceException {
		...
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.BillingFrequencyBeanFunctionSet_93ae97a7");
		...
		daSpec.setQueryScope(new String[]{"BillingFrequency"});
		result.add(daSpec);
		...
		iSpec=new com.ibm.ws.rsadapter.cci.WSInteractionSpecImpl();
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.BillingFrequencyBeanFunctionSet_93ae97a7");
		iSpec.setFunctionName("FindAllBillingFreq");
		daSpec.setInteractionSpec(iSpec);
		daSpec.setSpecName("FindAllBillingFreq");
		daSpec.setInputRecordName("FindAllBillingFreq");
		daSpec.setOptimistic(false);
		...
		iSpec=new com.ibm.ws.rsadapter.cci.WSInteractionSpecImpl();
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.BillingFrequencyBeanFunctionSet_93ae97a7");
		iSpec.setFunctionName("FindAllBillingFreq444Update");
		daSpec.setInteractionSpec(iSpec);
		daSpec.setSpecName("FindAllBillingFreq");
		daSpec.setInputRecordName("FindAllBillingFreq");
		daSpec.setOptimistic(false);
		...
		iSpec=new com.ibm.ws.rsadapter.cci.WSInteractionSpecImpl();
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.BillingFrequencyBeanFunctionSet_93ae97a7");
		iSpec.setFunctionName("FindAllBillingFreqForUpdateWithRR");
		daSpec.setInteractionSpec(iSpec);
		daSpec.setSpecName("FindAllBillingFreq");
		daSpec.setInputRecordName("FindAllBillingFreq");
		daSpec.setOptimistic(false);
		...
		iSpec=new com.ibm.ws.rsadapter.cci.WSInteractionSpecImpl();
		iSpec.setFunctionSetName("com.ibm.isc.customerfulfillment.bhoppt.persistence.organization.websphere_deploy.DB2UDBNT_V95_1.BillingFrequencyBeanFunctionSet_93ae97a7");
		iSpec.setFunctionName("FindAllBillingFreqForUpdateWithRS");
		daSpec.setInteractionSpec(iSpec);
		daSpec.setSpecName("FindAllBillingFreq");
		daSpec.setInputRecordName("FindAllBillingFreq");
		daSpec.setOptimistic(false);
	 ...
	 * BillingFrequencyBeanAdaptorBinding_93ae97a7
	 */
	public BillingFrequencyBeanAdaptorBinding_93ae97a7() {
