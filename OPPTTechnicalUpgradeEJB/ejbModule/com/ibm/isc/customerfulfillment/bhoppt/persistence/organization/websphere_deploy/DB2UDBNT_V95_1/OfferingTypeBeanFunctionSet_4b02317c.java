...
/**
 * OfferingTypeBeanFunctionSet_4b02317c
 */
public class OfferingTypeBeanFunctionSet_4b02317c extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	private java.util.HashMap functionHash;
	private static String CreateQuery_0 = "INSERT INTO BH.OFFERINGTYPE (OFFERING_TYPE, OFFERING_DESC, TVM_ALLOWED, SPECIAL_RATE_IND, ANNV_CNTR_AMT_IND, DURATION) VALUES (?, ?, ?, ?, ?, ?)";
	/**
	 * Create
	 */
	...
	private static String RemoveQuery_0 = "DELETE FROM BH.OFFERINGTYPE  WHERE OFFERING_TYPE = ? AND OFFERING_DESC = ?";
	/**
	 * Remove
	 */
	...
	private static String StoreQuery_0 = "UPDATE BH.OFFERINGTYPE  SET TVM_ALLOWED = ?, SPECIAL_RATE_IND = ?, ANNV_CNTR_AMT_IND = ?, DURATION = ? WHERE OFFERING_TYPE = ? AND OFFERING_DESC = ?";
	/**
	 * Store
	 */
	...
	private static String StoreOCCQuery_0 = "UPDATE BH.OFFERINGTYPE  SET TVM_ALLOWED = ?, SPECIAL_RATE_IND = ?, ANNV_CNTR_AMT_IND = ?, DURATION = ? WHERE OFFERING_TYPE = ? AND OFFERING_DESC = ? AND DURATION = ?";
	/**
	 * StoreUsingOCC
	 */
	...
	private static String FindByPrimaryKeyQuery_0 = " SELECT T1.OFFERING_TYPE, T1.OFFERING_DESC, T1.TVM_ALLOWED, T1.SPECIAL_RATE_IND, T1.ANNV_CNTR_AMT_IND, T1.DURATION FROM BH.OFFERINGTYPE  T1 WHERE T1.OFFERING_TYPE = ? AND T1.OFFERING_DESC = ?";
	/**
	 * FindByPrimaryKey
	 */
	...
	private static String FindByPrimaryKeyForUpdateQuery_0 = " SELECT T1.OFFERING_TYPE, T1.OFFERING_DESC, T1.TVM_ALLOWED, T1.SPECIAL_RATE_IND, T1.ANNV_CNTR_AMT_IND, T1.DURATION FROM BH.OFFERINGTYPE  T1 WHERE T1.OFFERING_TYPE = ? AND T1.OFFERING_DESC = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRRQuery_0 = " SELECT T1.OFFERING_TYPE, T1.OFFERING_DESC, T1.TVM_ALLOWED, T1.SPECIAL_RATE_IND, T1.ANNV_CNTR_AMT_IND, T1.DURATION FROM BH.OFFERINGTYPE  T1 WHERE T1.OFFERING_TYPE = ? AND T1.OFFERING_DESC = ? FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String FindByPrimaryKeyForUpdateWithRSQuery_0 = " SELECT T1.OFFERING_TYPE, T1.OFFERING_DESC, T1.TVM_ALLOWED, T1.SPECIAL_RATE_IND, T1.ANNV_CNTR_AMT_IND, T1.DURATION FROM BH.OFFERINGTYPE  T1 WHERE T1.OFFERING_TYPE = ? AND T1.OFFERING_DESC = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private static String findAllOfferingTypeQuery_0 = " select  q1.\"OFFERING_TYPE\",  q1.\"OFFERING_DESC\",  q1.\"TVM_ALLOWED\",  q1.\"SPECIAL_RATE_IND\",  q1.\"ANNV_CNTR_AMT_IND\",  q1.\"DURATION\" from BH.OFFERINGTYPE q1";
	/**
	 * FindAllOfferingType
	 */
	public javax.resource.cci.Record FindAllOfferingType(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from OfferingType o */
			pstmt = prepareStatement(connection, findAllOfferingTypeQuery_0);

			result = executeQuery(connection, pstmt, findAllOfferingTypeQuery_0);
	...
	private static String findAllOfferingTypeForUpdateQuery_0 = " select  q1.\"OFFERING_TYPE\",  q1.\"OFFERING_DESC\",  q1.\"TVM_ALLOWED\",  q1.\"SPECIAL_RATE_IND\",  q1.\"ANNV_CNTR_AMT_IND\",  q1.\"DURATION\" from BH.OFFERINGTYPE q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllOfferingType444Update
	 */
	public javax.resource.cci.Record FindAllOfferingType444Update(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from OfferingType o */
			pstmt = prepareStatement(connection, findAllOfferingTypeForUpdateQuery_0);

			result = executeQuery(connection, pstmt, findAllOfferingTypeForUpdateQuery_0);
	...
	private static String findAllOfferingTypeForUpdateWithRRQuery_0 = " select  q1.\"OFFERING_TYPE\",  q1.\"OFFERING_DESC\",  q1.\"TVM_ALLOWED\",  q1.\"SPECIAL_RATE_IND\",  q1.\"ANNV_CNTR_AMT_IND\",  q1.\"DURATION\" from BH.OFFERINGTYPE q1 FOR READ ONLY WITH RR USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllOfferingTypeForUpdateWithRR
	 */
	public javax.resource.cci.Record FindAllOfferingTypeForUpdateWithRR(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from OfferingType o */
			pstmt = prepareStatement(connection, findAllOfferingTypeForUpdateWithRRQuery_0);

			result = executeQuery(connection, pstmt, findAllOfferingTypeForUpdateWithRRQuery_0);
	...
	private static String findAllOfferingTypeForUpdateWithRSQuery_0 = " select  q1.\"OFFERING_TYPE\",  q1.\"OFFERING_DESC\",  q1.\"TVM_ALLOWED\",  q1.\"SPECIAL_RATE_IND\",  q1.\"ANNV_CNTR_AMT_IND\",  q1.\"DURATION\" from BH.OFFERINGTYPE q1 FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	 * FindAllOfferingTypeForUpdateWithRS
	 */
	public javax.resource.cci.Record FindAllOfferingTypeForUpdateWithRS(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from OfferingType o */
			pstmt = prepareStatement(connection, findAllOfferingTypeForUpdateWithRSQuery_0);

			result = executeQuery(connection, pstmt, findAllOfferingTypeForUpdateWithRSQuery_0);
	 ...
	 * OfferingTypeBeanFunctionSet_4b02317c
	 */
	public OfferingTypeBeanFunctionSet_4b02317c() {
		...
		functionHash.put("FindAllOfferingType",new Integer(8));
		functionHash.put("FindAllOfferingType444Update",new Integer(9));
		functionHash.put("FindAllOfferingTypeForUpdateWithRR",new Integer(10));
		functionHash.put("FindAllOfferingTypeForUpdateWithRS",new Integer(11));
	...
	public Record execute(WSInteractionSpec interactionSpec, IndexedRecord inputRecord, Object connection) throws javax.resource.ResourceException {
		...
		case 7:
			...
			break;
		case 8:
			outputRecord=FindAllOfferingType(inputRecord,connection,interactionSpec);
			break;
		case 9:
			outputRecord=FindAllOfferingType444Update(inputRecord,connection,interactionSpec);
			break;
		case 10:
			outputRecord=FindAllOfferingTypeForUpdateWithRR(inputRecord,connection,interactionSpec);
			break;
		case 11:
			outputRecord=FindAllOfferingTypeForUpdateWithRS(inputRecord,connection,interactionSpec);
			break;
		case 12:
	...
	private static String ReadReadQuery_0 = " SELECT 1 FROM BH.OFFERINGTYPE  T1 WHERE T1.OFFERING_TYPE = ? AND T1.OFFERING_DESC = ? AND T1.DURATION = ?";
	/**
	 * ReadReadChecking
	 */
	...
	private static String ReadReadForUpdateQuery_0 = " SELECT 1 FROM BH.OFFERINGTYPE  T1 WHERE T1.OFFERING_TYPE = ? AND T1.OFFERING_DESC = ? AND T1.DURATION = ? FOR READ ONLY WITH RS USE AND KEEP UPDATE LOCKS";
	/**
	...
	private void initializeUpdateTemplates() throws javax.resource.ResourceException {
		updateTemplateList = OfferingTypeBeanPartialUpdateQueryHelper.getUpdateTemplates();
	}
