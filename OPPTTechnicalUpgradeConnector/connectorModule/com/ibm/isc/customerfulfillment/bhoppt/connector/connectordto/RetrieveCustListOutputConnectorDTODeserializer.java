 ...
 * @version 5.1A 
 */
public class RetrieveCustListOutputConnectorDTODeserializer implements OutputConnectorDTODeserializerInterface
{
	/** 
	 * Constructor
	 *  
	 ...
	 *  
	 */
	public RetrieveCustListOutputConnectorDTODeserializer()
	{
	}
		...
		if (tokenizer.hasMoreTokens())
		{
			...
			if (ConnectorConstants.RFC_SUCCESS_CODE.equals(returnCode))
			{
				OutputConnectorDTODeserializerInterface outputConnectorDeserializer =
					ConnectorUtility.getOutputConnectorDeserializer(CustomerListConnectorDTO.class.getName());
