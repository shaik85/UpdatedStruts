...
public class StatusCheckOutputConnectorDTODeserializer implements OutputConnectorDTODeserializerInterface
{
	/** 
	 * Constructor
	 *  
	 ...
	 *  
	 */
	public StatusCheckOutputConnectorDTODeserializer()
	{
	}
	...
	public ConnectorDTOInterface parseMsgString(StringParser tokenizer, ConnectorDTOInterface connectorDTO)
		throws Exception
	{
		StatusCheckOutputConnectorDTO dto = new StatusCheckOutputConnectorDTO();
		connectorDTO = dto;
		...
		if (tokenizer.hasMoreTokens())
		{
			...
			if (ConnectorConstants.RFC_SUCCESS_CODE.equals(returnCode))
			{
				if (tokenizer.hasMoreTokens())
				{
					...
					dto.setReturnCodeSAP(tokenizer.nextToken());

					OutputConnectorDTODeserializerInterface outputConnectorDeserializer =
						ConnectorUtility.getOutputConnectorDeserializer(MessageConnectorDTO.class.getName());
