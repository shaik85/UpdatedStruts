 ...
 */
public class UpdateModificationOutputConnectorDTODeserializer implements OutputConnectorDTODeserializerInterface
{
	/** 
	 * Constructor
	 *  
	 ...
	 *  
	 */
	public UpdateModificationOutputConnectorDTODeserializer()
	{
	}
	...
	public ConnectorDTOInterface parseMsgString(StringParser tokenizer, ConnectorDTOInterface connectorDTO)
		throws Exception
	{
		UpdateModificationOutputConnectorDTO updateModificationOutputConnectorDTO = new UpdateModificationOutputConnectorDTO();
		connectorDTO = updateModificationOutputConnectorDTO;
		
		if (tokenizer.hasMoreTokens())
		{
			String returnCode = OPPTHelper.trimString(tokenizer.nextToken());
			
			updateModificationOutputConnectorDTO.setReturnCode(returnCode);
		}
