...
public class ValidateInvenConfigOutputConnectorDTODeserializer implements OutputConnectorDTODeserializerInterface
{
	/** 
	 * Constructor
	 *  
	 ...
	 *  
	 */
	public ValidateInvenConfigOutputConnectorDTODeserializer()
	{
	}
	...
	public ConnectorDTOInterface parseMsgString(StringParser tokenizer, ConnectorDTOInterface connectorDTO)
		throws Exception
	{
		ValidateInvenConfigOutputConnectorDTO dto = new ValidateInvenConfigOutputConnectorDTO();
		connectorDTO = dto;
		...
		if (tokenizer.hasMoreTokens())
		{
			...
			if (ConnectorConstants.RFC_SUCCESS_CODE.equals(returnCode) && tokenizer.hasMoreTokens())
			{
				OutputConnectorDTODeserializerInterface deserializer =
					ConnectorUtility.getOutputConnectorDeserializer(
						ValidateInvenConfigConnectorDTO.class.getName());
