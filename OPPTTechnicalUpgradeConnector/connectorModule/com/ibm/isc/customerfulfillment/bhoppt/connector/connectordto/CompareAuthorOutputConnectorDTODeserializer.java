 ...
 * @version 5.1A 
 */
public class CompareAuthorOutputConnectorDTODeserializer implements OutputConnectorDTODeserializerInterface
{
	/** 
	 * Constructor
	 *  
	 ...
	 *  
	 */
	public CompareAuthorOutputConnectorDTODeserializer()
	{
	}
		...
		throws Exception
	{
		...
		connectorDTO = compareAuthorOutputConnectorDTO;
		if (tokenizer.hasMoreTokens())
		{
			String returnCode = OPPTHelper.trimString(tokenizer.nextToken());
			compareAuthorOutputConnectorDTO.setReturnCode(returnCode);
		}
		return connectorDTO;
	}
}
