...
public class RetrieveCustListInputConnectorDTOSerializer implements InputConnectorDTOSerializerInterface
{
	/** 
	 * Constructor
	 *  
	 ...
	 *  
	 */	
	public RetrieveCustListInputConnectorDTOSerializer()
	{
	}
	...
	{
		RetrieveCustListInputConnectorDTO dto = (RetrieveCustListInputConnectorDTO)connectorDTO;
		...
		ConnectorUtility.buildMessage(dto.getCustomerListName(), buffer);
		ConnectorUtility.buildMessage(dto.getCustomerListNumber(), buffer);
