 ...
 * @version 5.1A 
 */
public class RefreshVarianceOutputConnectorDTODeserializer implements OutputConnectorDTODeserializerInterface
{
	/** 
	 * Constructor
	 *  
	 ...
	 *  
	 */
	public RefreshVarianceOutputConnectorDTODeserializer()
	{
	}
	...
	public ConnectorDTOInterface parseMsgString(StringParser tokenizer, ConnectorDTOInterface connectorDTO)
		throws Exception
	{
		RefreshVarianceOutputConnectorDTO refreshVarianceOutputConnectorDTO =
			new RefreshVarianceOutputConnectorDTO();
		connectorDTO = refreshVarianceOutputConnectorDTO;
		
		if (tokenizer.hasMoreTokens())
		{
			String returnCode = OPPTHelper.trimString(tokenizer.nextToken());
			
			refreshVarianceOutputConnectorDTO.setReturnCode(returnCode);
		}
