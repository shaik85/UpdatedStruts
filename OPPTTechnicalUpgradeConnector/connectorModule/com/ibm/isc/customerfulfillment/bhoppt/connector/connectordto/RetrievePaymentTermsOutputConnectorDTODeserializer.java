...
public class RetrievePaymentTermsOutputConnectorDTODeserializer implements OutputConnectorDTODeserializerInterface
{
	/** 
	 * Constructor
	 *  
	 ...
	 *  
	 */	
	public RetrievePaymentTermsOutputConnectorDTODeserializer()
	{
	}
	...
	{
		RetrievePaymentTermsOutputConnectorDTO outputConnectorDTO = new RetrievePaymentTermsOutputConnectorDTO();
		...
		{			
			...
			{
				OutputConnectorDTODeserializerInterface outputConnectorDeserializer = ConnectorUtility.getOutputConnectorDeserializer(PaymentTermConnectorDTO.class.getName());
