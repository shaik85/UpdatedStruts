 ...
 */
public class CreateBaseAgreementOutputConnectorDTODeserializer implements OutputConnectorDTODeserializerInterface
{
	/** 
	 * Constructor
	 *  
	 ...
	 *  
	 */
	public CreateBaseAgreementOutputConnectorDTODeserializer()
	{
	}
	...
	public ConnectorDTOInterface parseMsgString(StringParser tokenizer, ConnectorDTOInterface connectorDTO)
		throws Exception
	{
		CreateBaseAgreementOutputConnectorDTO createBaseAgreementOutputConnectorDTO = new CreateBaseAgreementOutputConnectorDTO();
		connectorDTO = createBaseAgreementOutputConnectorDTO;
		
		if (tokenizer.hasMoreTokens())
		{
			String returnCode = OPPTHelper.trimString(tokenizer.nextToken());
			
			createBaseAgreementOutputConnectorDTO.setReturnCode(returnCode);
		}
