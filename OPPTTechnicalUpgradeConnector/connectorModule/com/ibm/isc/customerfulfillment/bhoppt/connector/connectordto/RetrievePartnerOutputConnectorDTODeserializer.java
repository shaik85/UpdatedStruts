...
public class RetrievePartnerOutputConnectorDTODeserializer implements OutputConnectorDTODeserializerInterface
{
	/** 
	 * Constructor
	 *  
	 ...
	 *  
	 */
	public RetrievePartnerOutputConnectorDTODeserializer()
	{
	}
	...
	public ConnectorDTOInterface parseMsgString(StringParser tokenizer, ConnectorDTOInterface connectorDTO)
		throws Exception
	{
		RetrievePartnerOutputConnectorDTO dto = new RetrievePartnerOutputConnectorDTO();
				...
				while (tokenizer.hasMoreTokens())
				{
					...
					outputDeserializer =
						ConnectorUtility.getOutputConnectorDeserializer(
							RetrievePartnerConnectorDTO.class.getName());

					connectorDTO = outputDeserializer.parseMsgString(tokenizer, connectorDTO);
				}
			}
		}
