...
public class ValidateUserAccessOutputConnectorDTODeserializer implements OutputConnectorDTODeserializerInterface
{
	/** 
	 * Constructor
	 *  
	 ...
	 *  
	 */	
	public ValidateUserAccessOutputConnectorDTODeserializer()
	{
	}
	...
	{
		ValidateUserAccessOutputConnectorDTO dto = new ValidateUserAccessOutputConnectorDTO();
		
		if (tokenizer.hasMoreTokens())
		{
			dto.setReturnCode(OPPTHelper.trimString(tokenizer.nextToken()));
		}
