...
public class RetrieveCustomerOutputConnectorDTODeserializer implements OutputConnectorDTODeserializerInterface
{
	/** 
	 * Constructor
	 *  
	 ...
	 *  
	 */
	public RetrieveCustomerOutputConnectorDTODeserializer()
	{
	}
	...
	public ConnectorDTOInterface parseMsgString(StringParser tokenizer, ConnectorDTOInterface connectorDTO)
		throws Exception
	{
		RetrieveCustOutputConnectorDTO returnConnectorDTO = (RetrieveCustOutputConnectorDTO) connectorDTO;

		if (tokenizer.hasMoreTokens())
		{
			String returnCode = OPPTHelper.trimString(tokenizer.nextToken());
			returnConnectorDTO.setReturnCode(returnCode);
				...
				if (tokenizer.hasMoreTokens())
				{
					OutputConnectorDTODeserializerInterface outputConnectorDeserializer =
						(OutputConnectorDTODeserializerInterface) ConnectorUtility.getOutputConnectorDeserializer(
							RetrieveCustOutputConnectorDTO.class.getName());
