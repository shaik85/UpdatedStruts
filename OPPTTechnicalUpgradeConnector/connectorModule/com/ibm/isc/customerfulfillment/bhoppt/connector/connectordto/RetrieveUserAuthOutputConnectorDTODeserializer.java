...
public class RetrieveUserAuthOutputConnectorDTODeserializer implements OutputConnectorDTODeserializerInterface
{
	/** 
	 * Constructor
	 *  
	 ...
	 *  
	 */
	public RetrieveUserAuthOutputConnectorDTODeserializer()
	{
		...
		throws Exception
	{
		RetrieveUserAuthOutputConnectorDTO retrieveUserAuthOutputConnectorDTO =
			new RetrieveUserAuthOutputConnectorDTO();
		connectorDTO = retrieveUserAuthOutputConnectorDTO;

		if (tokenizer.hasMoreTokens())
		{
			String returnCode = OPPTHelper.trimString(tokenizer.nextToken());
			retrieveUserAuthOutputConnectorDTO.setReturnCode(returnCode);
			...
			if (ConnectorConstants.RFC_SUCCESS_CODE.equals(returnCode))
			{
				if (tokenizer.hasMoreTokens())
				{
					OutputConnectorDTODeserializerInterface outputConnectorDeserializer =
						(OutputConnectorDTODeserializerInterface) ConnectorUtility.getOutputConnectorDeserializer(
							RetrieveUserAuthConnectorDTO.class.getName());
