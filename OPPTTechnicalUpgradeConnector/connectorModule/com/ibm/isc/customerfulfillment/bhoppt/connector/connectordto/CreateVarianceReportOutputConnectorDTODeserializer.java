 ...
 * @version 5.1A 
 */
public class CreateVarianceReportOutputConnectorDTODeserializer implements OutputConnectorDTODeserializerInterface
{
	/** 
	 * Constructor
	 *  
	 ...
	 *  
	 */
	public CreateVarianceReportOutputConnectorDTODeserializer()
	{
	}
	...
	public ConnectorDTOInterface parseMsgString(StringParser tokenizer, ConnectorDTOInterface connectorDTO)
		throws Exception
	{
		CreateVarianceReportOutputConnectorDTO createVarianceReportOutputConnectorDTO =
			new CreateVarianceReportOutputConnectorDTO();
		connectorDTO = createVarianceReportOutputConnectorDTO;
		
		if (tokenizer.hasMoreTokens())
		{
			String returnCode = OPPTHelper.trimString(tokenizer.nextToken());
			
			createVarianceReportOutputConnectorDTO.setReturnCode(returnCode);
		}
