...
public class RetrieveDateRulesOutputConnectorDTODeserializer implements OutputConnectorDTODeserializerInterface
{
	/** 
	 * Constructor
	 *  
	 ...
	 *  
	 */
	public RetrieveDateRulesOutputConnectorDTODeserializer()
	{
	}
	...
	public ConnectorDTOInterface parseMsgString(StringParser tokenizer, ConnectorDTOInterface connectorDTO)
		throws Exception
	{
		RetrieveDateRulesOutputConnectorDTO outputConnectorDTO = new RetrieveDateRulesOutputConnectorDTO();
		...
		if (tokenizer.hasMoreTokens())
		{
			...
			if (ConnectorConstants.RFC_SUCCESS_CODE.equals(returnCode))
			{
				OutputConnectorDTODeserializerInterface outputConnectorDeserializer =
					ConnectorUtility.getOutputConnectorDeserializer(BillingTypeConnectorDTO.class.getName());
