...
public class RefreshCurrencyOutputConnectorDTODeserializer implements OutputConnectorDTODeserializerInterface
{
	/** 
	 * Constructor
	 *  
	 ...
	 *  
	 */
	public RefreshCurrencyOutputConnectorDTODeserializer()
	{
	}
	...
	public ConnectorDTOInterface parseMsgString(StringParser tokenizer, ConnectorDTOInterface connectorDTO)
		throws Exception
	{
		RefreshCurrencyOutputConnectorDTO outputConnectorDTO = new RefreshCurrencyOutputConnectorDTO();
		...
		if (tokenizer.hasMoreTokens())
		{
			...
			if (ConnectorConstants.RFC_SUCCESS_CODE.equals(returnCode))
			{
				OutputConnectorDTODeserializerInterface outputConnectorDeserializer =
					ConnectorUtility.getOutputConnectorDeserializer(CurrencyConnectorDTO.class.getName());
