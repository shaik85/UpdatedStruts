...
public class RetrieveDeltaInventoryOutputConnectorDTODeserializer
	implements OutputConnectorDTODeserializerInterface
{
	 ...
	 *  
	 */
	public RetrieveDeltaInventoryOutputConnectorDTODeserializer()
	{
	}
	...
	public ConnectorDTOInterface parseMsgString(StringParser tokenizer, ConnectorDTOInterface connectorDTO)
		throws Exception
	{
		RetrieveDeltaInventoryOutputConnectorDTO dto = new RetrieveDeltaInventoryOutputConnectorDTO();
		connectorDTO = dto;
