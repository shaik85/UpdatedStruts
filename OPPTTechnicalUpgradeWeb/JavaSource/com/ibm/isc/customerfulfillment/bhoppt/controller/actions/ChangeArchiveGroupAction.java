 ...
 * @author thirumalai
 */
public class ChangeArchiveGroupAction extends OPPTLongAction 
{
	...
	protected String getActionName() {
		return "ChangeArchiveGroupAction";  //$NON-NLS-1$
	}
	...
	private UserContractsCustomDTO getUserContract(OPPTSession session){
		...
		if(null != session){
			customDTO = (UserContractsCustomDTO)session.getObjectFromSession(SessionConstants.USER_ARCHIVE);
