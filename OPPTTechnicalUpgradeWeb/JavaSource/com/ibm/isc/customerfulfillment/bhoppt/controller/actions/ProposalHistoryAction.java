 ...
 * @author thirumalai
 */
public class ProposalHistoryAction extends OPPTLongAction 
{
	/** 
				...
				if(selectedIds.length == 1)
				{
					...
					if(null != selectedProposal)
					{
						...
						try{
							...
							viewBean = new ProposalHistoryViewBean(customDTO);
	...
	protected String getActionName() {
		return ActionNameConstants.PROPOSAL_HISTORY;
	}
	...
	private void setForwardName(int role){
		switch(role){
			case Constants.PROPOSAL_CREATE_APPROVER: 
								setForwardName(ForwardNameConstants.PAGE_CREATE_APPROVE_PROPOSAL_HISTORY);
								break;

			case Constants.PROPOSAL_ADMINISTRATOR:
			default:
								setForwardName(ForwardNameConstants.PAGE_PROPOSAL_HISTORY);
								break;
		}
	}
