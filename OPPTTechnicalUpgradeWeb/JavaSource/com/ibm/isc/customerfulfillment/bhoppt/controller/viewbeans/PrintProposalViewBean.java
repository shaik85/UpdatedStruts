 ...
 * @author thirumalai
 */
public class PrintProposalViewBean extends OPPTViewBean
{
	...
	private PricingInformationDataBean pricingInformationData = null;
	...
	public PartnerInformationViewBean getPartnerInformation() {
		if(null == partnerInformation){
			partnerInformation = new PartnerInformationViewBean();
		}
	...
	public PricingInformationDataBean getPricingInformationData() {
		if(null == pricingInformationData){
			pricingInformationData = new PricingInformationDataBean();
		}
		return pricingInformationData;
	}
	 ...
	 * @param bean 
	 */
	public void setBasicProposalData(BasicProposalDataBean bean) {
		basicProposalData = bean;
	}
	 ...
	 * @param map 
	 */
	public void setCustomers(Map map) {
		customers = map;
	}
	 ...
	 * @param bean 
	 */
	public void setPricingInformationData(PricingInformationDataBean bean) {
		pricingInformationData = bean;
	}
	 ...
	 * @param bean 
	 */
	public void setSecondaryProposalData(SecondaryProposalDataBean bean) {
		secondaryProposalData = bean;
	}
	 ...
	 * @param bean 
	 */
	public void setVarianceData(VarianceDataBean bean) {
		varianceData = bean;
	}
	 ...
	 */
	public void addCustomer(CustomerViewBean customer){
		if(null != customer){
			if(null == customers){
     ...
     * @author thirumalai
     */
    public void setData(PrintProposalCustomDTO customDTO)
	{
		if(null != customDTO){
			...
			if(null != customers){
				...
				while(iterator.hasNext()){
					addCustomer(new CustomerViewBean((ProposalCustomerCustomDTO)iterator.next()));
				}
			}
		}
	}
