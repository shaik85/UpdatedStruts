 ...
 * @version 5.1A
 */
public class SubmitCreateUserAction extends OPPTLongAction 
{
	/** 
	...
	protected OPPTViewBean executeAction(ActionForm form, OPPTSession session)
		...
		try {
			...
			setInSession(customDto,session);
...
//				}
	...
	protected String getActionName() {
		return ActionNameConstants.SUBMIT_CREATE_USER;
	}
	...
	private void setInSession(CreateUserCustomDTO customDto, OPPTSession session){
		if(null != session){
