...
public class SimulateVarianceActionForm extends OPPTActionForm {
	private DateDataBean varianceDate;
	 ...
	 * @param string 
	 */
	public void setIncludeQuotes(boolean b) {
		includeQuotes = b;
	}
	 ...
	 * @param bean 
	 */
	public void setVarianceDate(DateDataBean bean) {
		varianceDate = bean;
	}
	...
	public ErrorReport validate() {
		...
		if(isDateEmpty(getVarianceDate())){
