...
public class ReportsActionForm extends OPPTActionForm {
	...
	public ErrorReport validate() {
		...
		if(isSelectEmpty(getProposalName())){
			errorReport.put(new ErrorKey(ErrorCodeConstants.PAF76, OPPTMessageCatalog.TYPE_PRESENTATION),null);
		}
		if(isFieldEmpty(getReportType())){
