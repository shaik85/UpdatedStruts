 ...
 * @version 5.1A
 */
public class ContractMaintenanceInfoViewBean extends OPPTViewBean {
	private String proposalName = "";  //$NON-NLS-1$
	private String proposalType = "";  //$NON-NLS-1$
	private String contractNumber = "";  //$NON-NLS-1$
	private String status = "";  //$NON-NLS-1$
	private String lockedBy = "";  //$NON-NLS-1$
     ...
     * @param status 
     */
	public void setData(String proposalName, String proposalType, String contractNumber, String status,
		String lockedBy) {
