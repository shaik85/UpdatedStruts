 ...
 * @author thirumalai
 */
public class PriceProposalAction extends OPPTLongAction 
{
	/** 
	...
	protected OPPTViewBean executeAction(ActionForm form, OPPTSession session) throws Exception {
		...
		if(null != currentProposal){
			...
			try{
				currentProposal = getProposalManager().priceProposal(currentProposal);
				ErrorReport messageReport = currentProposal.getMessageReport();
	...
	protected String getActionName() {
		return ActionNameConstants.PRICE;
	}
