...
public class DeleteAddedModificationAction extends OPPTLongAction {
    ...
    protected OPPTViewBean executeAction(ActionForm form, OPPTSession session)
		...
		BaseAgreementDetailsCustomDTO baseAgreementDetailsCustomDTO = (BaseAgreementDetailsCustomDTO)session.getObjectFromSession(SessionConstants.SESSION_BASE_AGREEMENT_DETAILS);
			...
			displayModificationViewBean.getSelectedModifications().remove(actionForm.getModificationTypeCode());
	...
	protected String getActionName() {
		return ActionNameConstants.DELETE_ADD_MODIFICATION;
	}
