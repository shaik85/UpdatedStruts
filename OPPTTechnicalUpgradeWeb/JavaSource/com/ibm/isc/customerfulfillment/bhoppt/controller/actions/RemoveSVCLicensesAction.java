 ...
 * @author thirumalai
 */
public class RemoveSVCLicensesAction extends OPPTLongAction 
{
 	/** 
	...
	protected OPPTViewBean executeAction(ActionForm form, OPPTSession session) throws Exception {
		...
		viewBean = new ConfirmationViewBean(ConfirmationConstants.REMOVE_SVC_LICENSES);
	...
	protected String getActionName() {
		return ActionNameConstants.REMOVE_SVC_LICENSES;
	}
