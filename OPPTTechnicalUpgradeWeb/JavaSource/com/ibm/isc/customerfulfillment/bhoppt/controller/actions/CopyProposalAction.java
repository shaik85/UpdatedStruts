 ...
 * @author thirumalai
 */
public class CopyProposalAction extends OPPTLongAction {
	/** 
	...
	protected OPPTViewBean executeAction(ActionForm form, OPPTSession session) throws Exception {
		...
		if(null != actionForm)
		{
			...
			if(null != selectedIds)
			{
				...
				{
					ProposalCustomDTO customDTO = getProposalToBeCopied(session, selectedIds[0]);
					if(null != customDTO)
					{
						...
						try{
							...
							setProposalToBeCopied(session, customDTO);
	...
	private ProposalCustomDTO getProposalToBeCopied(OPPTSession session, String id) 
	{
	...
	private void setProposalToBeCopied(OPPTSession session, ProposalCustomDTO proposalToBeCopied) {
