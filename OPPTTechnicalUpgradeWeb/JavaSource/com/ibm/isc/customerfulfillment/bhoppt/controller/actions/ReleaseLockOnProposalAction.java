...
public class ReleaseLockOnProposalAction extends OPPTLongAction 
{
	...
	protected OPPTViewBean executeAction(ActionForm form, OPPTSession session)
		...
		viewBean = new ReleaseProposalViewBean();
		setForwardName("releaseproposal");  //$NON-NLS-1$
		return viewBean;
	}
	...
	protected String getActionName() {
		return ActionNameConstants.RELEASE_LOCK_ON_PROPOSAL;
	}
