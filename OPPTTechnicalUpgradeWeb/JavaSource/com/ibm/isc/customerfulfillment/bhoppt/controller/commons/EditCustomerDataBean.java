 ...
 * @author thirumalai
 */
public class EditCustomerDataBean extends OPPTDataBean {
	 ...
	 * @param string 
	 */
	public void setBillToPartyNumber(String string) {
	 ...
	 * @param string 
	 */
	public void setPayerNumber(String string) {
		payerNumber = string;
	}
    ...
    public String toString(){
		...
		buffer.append("[EditCustomerDataBean] - [toString] - ");  //$NON-NLS-1$
		buffer.append("[Bill to party number: "+billToPartyNumber+"] - ");  //$NON-NLS-1$  //$NON-NLS-2$
		buffer.append("[Bill to party name: "+billToPartyName+"] - ");  //$NON-NLS-1$  //$NON-NLS-2$
		buffer.append("[Payer number: "+payerNumber+"] - ");  //$NON-NLS-1$  //$NON-NLS-2$
		buffer.append("[Payer name: "+payerName+"] - ");  //$NON-NLS-1$  //$NON-NLS-2$
