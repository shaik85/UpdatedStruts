...
/**
 * Generate Base Agreement Reports Action
 * @author Administrator
 *
 * TODO To change the template for this generated type comment go to
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class GenerateBaseAgreementReportsAction extends OPPTLongAction {
	 /** 
    ...
    protected OPPTViewBean executeAction(ActionForm form, OPPTSession session)
		...
		setTransactionInformation(baseAgreementReportsCustomDTO, session);
	  ...
	  if(errorReport.size() != 0){
			...
			session.setFirstActionForwardName(ForwardNameConstants.PAGE_BASEAGREEMENT_REPORTS_ALL);
		}else{
		try{
			
				baseAgreementReportsCustomDTO = getReportManager().getAllBAReports(baseAgreementReportCustomDTO);
	...
	protected String getActionName() {
		return ActionNameConstants.GENERATE_REPORTS_BASEAGREEMENTS;
	}
	/**
     * getUserManager
     * 
    ...
    protected boolean validateCurrentViewContent(OPPTSession session) {
		...
		String actualForward = ForwardNameConstants.PAGE_BASEAGREEMENT_REPORTS_ALL;
