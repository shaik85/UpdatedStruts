...
public class UpdateCurrencyAction extends OPPTLongAction 
{
	...
	protected OPPTViewBean executeAction(ActionForm form, OPPTSession session)
		...
		dataManagerHome = (ProposalDataManagerHome)ServiceLocator.getEJBHomeFactory().getRemoteHome("ProposalDataManagerHome");
		dataManager = dataManagerHome.create();
		
		try {
			customDto = dataManager.updateCurrency(customDto);
	...
	protected String getActionName() {
		return ActionNameConstants.UPDATE_CURRENCY_AREA;
	}
