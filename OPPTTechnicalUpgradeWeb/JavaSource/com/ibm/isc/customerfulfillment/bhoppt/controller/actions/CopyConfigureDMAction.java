 ...
 * @author thirumalai
 */
public class CopyConfigureDMAction extends OPPTLongAction 
{
	/** 
	...
	protected String getActionName() {
		return ActionNameConstants.COPY_CONFIGURE_DM;
	}
	...
	private ConfigureDMCustomDTO getCopyConfigureDM(OPPTSession session){
		ConfigureDMCustomDTO customDTO = null;
