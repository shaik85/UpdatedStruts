 ...
 * @author thirumalai
 */
public class PrintProposalAction extends OPPTAction 
{
	/** 
	...
	protected OPPTViewBean executeAction(ActionForm form, OPPTSession session) throws Exception {
		...
		boolean printProposal = false;
		
		ProposalCustomDTO currentProposal = getCurrentProposal(session);
		if(null != currentProposal){
			printProposal = true;
			session.storeObjectToSession(SessionConstants.REPORT_REPORT_TYPE, ReportTypeConstants.VIEW_PROPOSAL);			
	...
	protected String getActionName() {
		return ActionNameConstants.PRINT_PROPOSAL;
	}
