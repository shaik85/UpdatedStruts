 ...
 * @version 5.1A 
 */
public class CancelAction extends OPPTForwardAction 
{
	/**
	...
	public ActionForward execute(ActionMapping mapping, ActionForm actionForm, HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		String firstActionForward = opptSession.getFirstActionForwardName();
		if(null == firstActionForward){
			firstActionForward = ForwardNameConstants.PAGE_ERROR;
			opptSession.setCurrentMessageViewBean(new ErrorViewBean(getErrorReport(ErrorCodeConstants.PA45)));
		}
		
		return mapping.findForward(firstActionForward);
	}
}
