...
public class UpdateBillingBlockAction extends OPPTLongAction 
{
	...
	protected OPPTViewBean executeAction(ActionForm form, OPPTSession session)
		...
		try {
			customDto = dataManager.updateBillingBlock(customDto);
	...
	protected String getActionName() {
		return ActionNameConstants.UPDATE_BILLING_BLOCK;
	}
