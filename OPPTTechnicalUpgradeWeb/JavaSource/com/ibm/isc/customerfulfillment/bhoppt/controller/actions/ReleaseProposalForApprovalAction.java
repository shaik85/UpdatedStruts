 ...
 * @author thirumalai
 */
public class ReleaseProposalForApprovalAction extends OPPTLongAction 
{
	/** 
			...
			if(null != selectedIds)
			{
				if(selectedIds.length == 1)
				{
					...
					if(null != selectedProposal)
					{
						...
						try
						{
							getProposalManager().releaseProposal(selectedProposal);
	...
	protected String getActionName() {
		return ActionNameConstants.RELEASE_PROPOSAL_FOR_APPROVAL;
	}
