...
/**
 * Holds information required for the contract extension view  
 * 
 ...
 * @version 5.1A
 */
public class ContractExtensionViewBean extends ContractInfoViewBean {
	private Date contractExtensionDate = null;
	private TreeMap approver=null;
	...
	/**
     * ContractExtensionViewBean
     * 
     * @author thirumalai
     */
    public ContractExtensionViewBean(){
	}
     ...
     * @author thirumalai
     */
    public ContractExtensionViewBean(ExtendContractCustomDTO customDto){
		populateBean(customDto);
	}

	/**
	 * Returns contract extension date 
	 * 
	 * <br><b>Known Bugs</b><br> 
	 * 
	 * <br><PRE> 
	 ...
	 * </PRE><br> 
	 * 
	 * @param newContractExtensionDate Date 
	 */
	public void setContractExtensionDate(Date newContractExtensionDate) {
		contractExtensionDate = newContractExtensionDate;
	}
...
/** 
	 ...
	 * @param map 
	 */
	public void setApprover(TreeMap map) {
		approver = map;
	}
	 ...
	 * @param string 
	 */
	public void setBillingFrequency(String string) {
	 ...
	 * @param string 
	 */
	public void setSelectedApprover(String string) {
	 ...
	 * @param contractExtensionDate Date
	 */
	public void setData(String proposalName, String proposalType, String contractType, String contractNumber,
		...
		setContractExtensionDate(contractExtensionDate);
	}
	
	
	private void populateBean(ExtendContractCustomDTO customDto){
		setData(customDto.getProposalName(),customDto.getProposalType(), customDto.getContractType(),
				...
				customDto.getContractPeriodEndDate(),customDto.getExtensionDate());
	}
}
