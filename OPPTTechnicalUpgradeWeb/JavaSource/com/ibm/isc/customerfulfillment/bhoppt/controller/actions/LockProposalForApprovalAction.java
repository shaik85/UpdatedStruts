 ...
 * @author thirumalai
 */
public class LockProposalForApprovalAction extends OPPTLongAction 
{
	/** 
			...
			if(null != selectedIds)
			{
				if(selectedIds.length == 1)
				{
					...
					if(null != selectedProposal)
					{
						...
						try
						{
							getProposalManager().lockProposal(selectedProposal);
	...
	protected String getActionName() {
		return ActionNameConstants.LOCK_PROPOSAL;
	}
