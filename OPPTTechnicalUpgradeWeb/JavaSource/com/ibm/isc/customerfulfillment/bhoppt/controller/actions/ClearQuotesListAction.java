 ...
 * @version 5.1A 
 */
public class ClearQuotesListAction extends OPPTForwardAction 
{
	/**
	...
	public ActionForward execute(ActionMapping mapping, ActionForm actionForm, HttpServletRequest request, HttpServletResponse response) throws Exception 
	{
		...
		if(null != actionForm && actionForm instanceof QuotesListActionForm){
		((QuotesListActionForm)actionForm).reset();
		}
