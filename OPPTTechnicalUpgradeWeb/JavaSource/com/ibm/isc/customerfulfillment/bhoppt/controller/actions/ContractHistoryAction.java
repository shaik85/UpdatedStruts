 ...
 * @author thirumalai
 */
public class ContractHistoryAction extends OPPTLongAction 
{
	/** 
				...
				if(selectedIds.length == 1)
				{
					...
					if(null != selectedContract)
					{
						...
						try{
							...
							viewBean = new ProposalHistoryViewBean(customDTO, true);
	...
	protected String getActionName() {
		return ActionNameConstants.CONTRACT_HISTORY;
	}
	...
	private void setForwardName(int role){
		switch(role){
			case Constants.PROPOSAL_CREATE_APPROVER: 
								setForwardName(ForwardNameConstants.PAGE_CREATE_APPROVE_CONTRACT_HISTORY);
								break;

			case Constants.PROPOSAL_ADMINISTRATOR:
			default:
								setForwardName(ForwardNameConstants.PAGE_CONTRACT_HISTORY);
								break;
		}
	}
