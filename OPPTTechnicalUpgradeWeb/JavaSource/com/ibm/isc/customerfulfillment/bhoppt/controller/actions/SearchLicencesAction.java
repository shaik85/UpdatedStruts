...
import com.ibm.isc.customerfulfillment.bhoppt.controller.actionforms.SearchLicencesActionForm;
 ...
 * @author thirumalai
 */
public class SearchLicencesAction extends OPPTLongAction
{
	/** 
	...
	protected OPPTViewBean executeAction(ActionForm form, OPPTSession session) throws Exception {
		...
		SearchLicencesActionForm actionForm = (SearchLicencesActionForm)form;
		if(null != actionForm)
		{
			String searchString = actionForm.getSearchCriteria();
			if(null != searchString)
			{
				...
				if(null != currentProposal)
				{
					...
					customDTO.setSearchString(searchString);
					...
					try 
					{
						...
						if(null == messageReport)
						{
							...
							updateInProposalDetails(session, customDTO.getTotalNoOfPages(), customDTO.getPageIndex(), customDTO.getMLCTotalNoOfPages(), customDTO.getMLCExcess(), true, customDTO.getSearchString());
	...
	protected String getActionName() {
		return ActionNameConstants.SEARCH_LICENSES;
	}
