			...
			<table role="presentation" width="600">
				...
				<tr>
					<td>
						...
						input. Press Cancel button to go back to user maintenance page.</p>
...
&nbsp;<br />
<table summary="CreateUser" cellpadding="0" cellspacing="0" border="0" width="600">
	<tr valign="top">
		<td>
			<html:form action="/protect/CreateUserMultipleAction.wss">
						...
						<td align="left">
							<table role="presentation" cellspacing="1" cellpadding="1" border="0" width="600">
								...
								<tr>
									...
									<td><oppt:select name="userDataBean.primarySalesOrganization" reverse="true" selectedOption="<%=salesOrg%>" id="sales" style="iform" options="<%=salesArea%>" title= "Select primary sales org" /></td>
								</tr>
							</table>
							&nbsp;<br />
