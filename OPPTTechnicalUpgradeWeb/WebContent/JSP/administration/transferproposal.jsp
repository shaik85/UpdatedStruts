...
<p ><em><br>Transfer proposals</em></p>		
		</div>
	</div>	
	...
	<tr valign="top">
		<td>
			...
			<table role="presentation">
				<tr>
					<td><label for="salesArea">Sales org:</label></td>
					...
					&nbsp;<span class="button-blue"><input class="ibm-btn-arrow-sec" type="submit" value="Go" /></span>&nbsp;&nbsp;&nbsp;</td>
				</tr>
			</table>
			</html:form>
            &nbsp;<br />							
			<html:form action="protect/SubmitTransferMultipleAction.wss">
			<table role="presentation" align="left" width="600" border="0" cellspacing="1" cellpadding="1">
				<tr>
					<td colspan="2">
