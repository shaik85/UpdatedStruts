...
<p ><em><br>Proposal details - Contract registration</em></p>		
		</div>
	</div>	
...
<html:form action="/protect/RegistrationMultipleAction.wss">
	...
	<table cellspacing="0" cellpadding="0" width="600" border="0" summary="Contract registration">
		...
		<tr>
			<td>&nbsp;</td>
			<td height="20">Billing frequency:</td>
			<td><oppt:label label="<%=view.getBillingFrequency()%>" /></td>
		</tr>
		<tr>
			<td></td>
	...
	<table align="right" border="0" cellspacing="0" cellpadding="0" role="presentation">
		<tr>
			<td><oppt:button id="sendForApproval" name="multipleButtonManager.sendForApproval" alt="Send for approval"  primary="true" value="Send for approval" buttonFlags="<%=buttonFlags %>" /></td>
			<td><oppt:button value="Clear all" name="multipleButtonManager.clearAll" alt="Clear all" primary="true" id="clearAll" /></td>
			<td><oppt:button value="Cancel" name="multipleButtonManager.cancel" alt="Cancel" primary="true" id="cancel" /></td>
		</tr>
	</table>
	&nbsp;<br />
</html:form>
