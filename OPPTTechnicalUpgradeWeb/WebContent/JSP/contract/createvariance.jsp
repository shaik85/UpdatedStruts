			...
			<table role="presentation" width="600">
				...
				<tr>
					<td>
						...
						<p>Use this form to check  an ESSO contract for the actual variance 
						on a specific date.   The variance date needs to be greater than the 
						contract period start date and less or equal to the current date.   
						When you have filled the date field,  click the Create button. Press 
						the Clear all button to discard your input. Press the Cancel button to 
						go back to contract maintenance page.</p>
...
&nbsp;<br />
<table summary="CreateVariance" cellpadding="0" cellspacing="0" border="0" width="600">
	<tr valign="top">
		<td>
			<html:form action="protect/CreateVarianceMultipleAction.wss">
			<table role="presentation" cellspacing="0" cellpadding="0" border="0">
				...
				<tr>
					<td></td>
					<td height="30"><label ><span class="ibm-required">*</span>Variance date:</label></td>
					<td height="30"><oppt:dateOptions name="varianceDate" years="<%=yearList%>" date="<%=viewBean.getVarianceDate()%>" alt="Varience date" mandatory="true"/></td>
				</tr>
			</table>
			&nbsp;<br />
			<table role="presentation" align="right" cellspacing="0" cellpadding="0" border="0">
				<tr>
					<td><oppt:button id="create" name="multipleButtonManager.create" alt="Create" primary="true" value="Create" buttonFlags="<%=buttonFlags %>" /></td>
