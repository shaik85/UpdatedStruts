	...
	<tr valign="top">
		<td width="450">
			<table width="450" role="presentation">
				...
				<tr>
				    <td> 
                      <p class="ibm-alternate"><em>Report of all registered modifications</p>
				</td>
			</tr>
			<tr>
				...
				<tr>
					<td height="30"> 
                      <p>Select the sales org, base agreement status and then press 
                        the Generate report button. Press Cancel button to go back 
                        to Reports page.<br>
                      </p>
	
                    	<p>Required fields are marked with an asterisk (<strong>*</strong>) 
                        and must be filled in to complete the form.</p>
						<html:form method="post" action="/protect/ModificationReportMultipleAction.wss">
                        <table summary="Sales Organisation" width="600">
                        <tr>
                         ...
                         <table width="600" role="presentation" align="right">
                          <tr> 
                            <td valign="top" width="386"><div align="right"><span class="button-blue"> 
                             <oppt:button id="report" name="multipleButtonManager.report" alt="Register" value="Generate report" primary="true" />
